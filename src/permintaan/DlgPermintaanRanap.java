...
public class DlgPermintaanRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(878, 196));
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-09-2023" }));
        ...
        Diagnosa.setBounds(80, 130, 213, 23);
        ...
        HargaKamar.setBounds(490, 100, 103, 23);
        ...
        jLabel14.setBounds(330, 130, 60, 23);
        ...
        PanelInput.add(FormInput, java.awt.BorderLayout.LINE_START);
        ...
        BtnSPRIUmum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnSPRIUmum.setText("SPRI");
        BtnSPRIUmum.setFocusPainted(false);
        BtnSPRIUmum.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSPRIUmum.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnSPRIUmum.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSPRIUmum.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnSPRIUmum.setName("BtnSPRIUmum"); // NOI18N
        BtnSPRIUmum.setPreferredSize(new java.awt.Dimension(160, 23));
        BtnSPRIUmum.setRoundRect(false);
        BtnSPRIUmum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSPRIUmumActionPerformed(evt);
            }
        });
        FormMenu.add(BtnSPRIUmum);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnSPRIUmumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSPRIUmumActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnSPRIUmumActionPerformed
    ...
    */
    ...
    private widget.Button BtnSPRIUmum;
