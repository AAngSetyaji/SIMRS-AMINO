 ...
 * @author dosen
 */
public final class DlgPeresepanPulangDokter extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeresepanPulangDokter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Peresepan Obat Pulang Oleh Dokter ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-11-2023" }));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                sukses=true;
                if(ubah==false){
                    if(Sequel.menyimpantf2("resep_obat_pulang","?,?,?,?,?,?,?,?,?,?","Nomer Resep",10,new String[]{
                        NoResep.getText(),null,null,TNoRw.getText(),KdDokter.getText(),Valid.SetTgl(DTPBeri.getSelectedItem()+""),
                        cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),status,null,null
                        })==true){
                            simpandata();
                    }else{
                        emptTeksobat();
                    ...
                    Sequel.meghapus("resep_dokter_pulang","no_resep",NoResep.getText());
                    Sequel.meghapus("resep_dokter_pulang_racikan","no_resep",NoResep.getText());
                    Sequel.meghapus("resep_dokter_pulang_racikan_detail","no_resep",NoResep.getText());
                    ubah=false;
                    simpandata();
                }                                                      
                            ...
                            try {
                                ...
                                if(rs2.next()){
                                    ...
                                    psresep=koneksi.prepareStatement(
                                           "select databarang.nama_brng,resep_dokter_pulang.jml,resep_dokter_pulang.aturan_pakai from databarang inner join resep_dokter_pulang on databarang.kode_brng=resep_dokter_pulang.kode_brng where resep_dokter_pulang.no_resep=?");
                                    try {
                                    ...
                                    psresep=koneksi.prepareStatement(
                                            "select resep_dokter_pulang_racikan.no_racik,resep_dokter_pulang_racikan.nama_racik,metode_racik.nm_racik as metode,resep_dokter_pulang_racikan.jml_dr,resep_dokter_pulang_racikan.aturan_pakai "+
                                            "from resep_dokter_pulang_racikan inner join metode_racik on resep_dokter_pulang_racikan.kd_racik=metode_racik.kd_racik where resep_dokter_pulang_racikan.no_resep=?");
                                    try {
                                        psresep.setString(1,NoResep.getText());
                                        rsobat=psresep.executeQuery();
                                        while(rsobat.next()){
                                            ...
                                            pscarikapasitas=koneksi.prepareStatement(
                                                    "select databarang.nama_brng,resep_dokter_pulang_racikan_detail.jml from resep_dokter_pulang_racikan_detail inner join databarang "+
                                                    "on resep_dokter_pulang_racikan_detail.kode_brng=databarang.kode_brng where resep_dokter_pulang_racikan_detail.no_resep=? and "+
                                                    "resep_dokter_pulang_racikan_detail.no_racik=?");
                                            try {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeresepanPulangDokter dialog = new DlgPeresepanPulangDokter(new javax.swing.JFrame(), true);
    ...
    public void emptTeksobat() {
        if(ChkRM.isSelected()==true){
            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(resep_obat_pulang.no_resep,4),signed)),0) from resep_obat_pulang where resep_obat_pulang.tgl_peresepan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' or resep_obat_pulang.tgl_perawatan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ",
        ...
        try {
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,resep_dokter_pulang.jml, resep_dokter_pulang.aturan_pakai "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join resep_dokter_pulang on resep_dokter_pulang.kode_brng=databarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and "+
                        " resep_dokter_pulang.no_resep=? group by gudangbarang.kode_brng order by databarang.nama_brng");
                }else{
                    qrystokkosong="";
                    if(STOKKOSONGRESEP.equals("no")){
                        qrystokkosong=" and gudangbarang.stok>0 ";
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,resep_dokter_pulang.jml, resep_dokter_pulang.aturan_pakai "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join resep_dokter_pulang on resep_dokter_pulang.kode_brng=databarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and "+
                        " resep_dokter_pulang.no_resep=? order by databarang.nama_brng");
                }
                try{
                    psresepasuransi.setDouble(1,kenaikan);
                    psresepasuransi.setString(2,bangsal);
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresep=koneksi.prepareStatement(
                        ...
                        " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                        " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                        " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,resep_dokter_pulang.jml, resep_dokter_pulang.aturan_pakai "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join resep_dokter_pulang on resep_dokter_pulang.kode_brng=databarang.kode_brng "+
                    ...
                    psresep=koneksi.prepareStatement(
                        ...
                        " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                        " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                        " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,resep_dokter_pulang.jml, resep_dokter_pulang.aturan_pakai "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join resep_dokter_pulang on resep_dokter_pulang.kode_brng=databarang.kode_brng "+
                    ...
                    if(kenaikan>0){
                        if(aktifkanbatch.equals("yes")){
                            ...
                            ps2=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                                " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,databarang.kapasitas,resep_dokter_pulang_racikan_detail.p1,"+
                                " resep_dokter_pulang_racikan_detail.p2,resep_dokter_pulang_racikan_detail.kandungan,resep_dokter_pulang_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_pulang_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_pulang_racikan_detail.kode_brng=databarang.kode_brng "+
                                " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and "+
                                " resep_dokter_pulang_racikan_detail.no_resep=? and resep_dokter_pulang_racikan_detail.no_racik=? group by gudangbarang.kode_brng order by databarang.nama_brng");
                        }else{
                            qrystokkosong="";
                            if(STOKKOSONGRESEP.equals("no")){
                                qrystokkosong=" and gudangbarang.stok>0 ";
                            ...
                            ps2=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                                " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,databarang.kapasitas,resep_dokter_pulang_racikan_detail.p1,"+
                                " resep_dokter_pulang_racikan_detail.p2,resep_dokter_pulang_racikan_detail.kandungan,resep_dokter_pulang_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_pulang_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_pulang_racikan_detail.kode_brng=databarang.kode_brng "+
                                " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and "+
                                " resep_dokter_pulang_racikan_detail.no_resep=? and resep_dokter_pulang_racikan_detail.no_racik=? order by databarang.nama_brng");
                        }
                        try{ 
                        ...
                        if(aktifkanbatch.equals("yes")){
                            ...
                            ps2=koneksi.prepareStatement(
                                ...
                                " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                                " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                                " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,databarang.kapasitas,resep_dokter_pulang_racikan_detail.p1,"+
                                " resep_dokter_pulang_racikan_detail.p2,resep_dokter_pulang_racikan_detail.kandungan,resep_dokter_pulang_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_pulang_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_pulang_racikan_detail.kode_brng=databarang.kode_brng "+
                            ...
                            ps2=koneksi.prepareStatement(
                                ...
                                " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                                " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                                " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,databarang.kapasitas,resep_dokter_pulang_racikan_detail.p1,"+
                                " resep_dokter_pulang_racikan_detail.p2,resep_dokter_pulang_racikan_detail.kandungan,resep_dokter_pulang_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_pulang_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_pulang_racikan_detail.kode_brng=databarang.kode_brng "+
        ...
        try {
                    ...
                    if(tbResep.getValueAt(i,0).toString().equals("true")){
                        ...
                        try {
                            ...
                            if(carikapasitas.next()){ 
                                if(Sequel.menyimpantf2("resep_dokter_pulang","?,?,?,?","data",4,new String[]{
            ...
            for(i=0;i<tbObatResepRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbObatResepRacikan.getValueAt(i,4).toString())>0){ 
                    if(Sequel.menyimpantf2("resep_dokter_pulang_racikan","?,?,?,?,?,?,?","resep obat racikan",7,new String[]{
            ...
            for(i=0;i<tbDetailResepObatRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbDetailResepObatRacikan.getValueAt(i,13).toString())>0){
                    if(Sequel.menyimpantf2("resep_dokter_pulang_racikan_detail","?,?,?,?,?,?,?","resep dokter racikan detail",7,new String[]{
