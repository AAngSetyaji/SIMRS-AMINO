...
import surat.SuratPersetujuanTerapiRehabilitasi;
...
//        });
    ...
    private void initComponents() {
        ...
        MnJadwalECT = new javax.swing.JMenuItem();
        ...
        BtnSimpanSKRI = new widget.Button();
        ...
        MnJadwalECT.setBackground(new java.awt.Color(255, 255, 254));
        MnJadwalECT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnJadwalECT.setForeground(new java.awt.Color(50, 50, 50));
        MnJadwalECT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnJadwalECT.setText("Jadwal ECT");
        MnJadwalECT.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnJadwalECT.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnJadwalECT.setName("MnJadwalECT"); // NOI18N
        MnJadwalECT.setPreferredSize(new java.awt.Dimension(170, 26));
        MnJadwalECT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnJadwalECTActionPerformed(evt);
            }
        });
        MnPermintaan.add(MnJadwalECT);
        ...
        MnReqECT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnReqECT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnReqECT.setText("Tindakan ECT");
        ...
        MnPersetujuanTerapiRehabilitasi.setBackground(new java.awt.Color(255, 255, 254));
        MnPersetujuanTerapiRehabilitasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPersetujuanTerapiRehabilitasi.setForeground(new java.awt.Color(50, 50, 50));
        MnPersetujuanTerapiRehabilitasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPersetujuanTerapiRehabilitasi.setText("Persetujuan Terapi Rehabilitasi");
        MnPersetujuanTerapiRehabilitasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPersetujuanTerapiRehabilitasi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPersetujuanTerapiRehabilitasi.setName("MnPersetujuanTerapiRehabilitasi"); // NOI18N
        MnPersetujuanTerapiRehabilitasi.setPreferredSize(new java.awt.Dimension(230, 26));
        MnPersetujuanTerapiRehabilitasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPersetujuanTerapiRehabilitasiActionPerformed(evt);
            }
        });
        ...
        catat_psiko.setFont(new java.awt.Font("sansserif", 0, 11)); // NOI18N
        catat_psiko.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        catat_psiko.setText("Catatan Psikoterapi");
        catat_psiko.setName("catat_psiko"); // NOI18N
        catat_psiko.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                catat_psikoActionPerformed(evt);
            }
        });
        ...
        BtnSimpanSKRI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/save-16x16.png"))); // NOI18N
        BtnSimpanSKRI.setMnemonic('T');
        BtnSimpanSKRI.setText("Simpan");
        BtnSimpanSKRI.setToolTipText("Alt+T");
        BtnSimpanSKRI.setName("BtnSimpanSKRI"); // NOI18N
        BtnSimpanSKRI.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnSimpanSKRI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSimpanSKRIActionPerformed(evt);
            }
        });
        panelBiasa4.add(BtnSimpanSKRI);
        BtnSimpanSKRI.setBounds(20, 80, 100, 30);
        ...
        BtnPrint5.setBounds(130, 80, 100, 30);
        ...
        internalFrame8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ganti Diagnosa Awal Sementara ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ganti Diagnosa Akhir Sementara ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Daftar Pasien Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnAll.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/viewrefresh_104298 (1).png"))); // NOI18N
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-11-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-11-2023" }));
                    ...
                    switch (TSttsKamar.getText().trim()) {
                        ...
                        case "KOSONG":
                            if(Sequel.menyimpantf("kamar_inap","'"+norawat.getText()+"','"+
                                    ...
                                    cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"',NULL,NULL,'"+TJmlHari.getText()+"','"+
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(Sequel.cariRegistrasi(norawat.getText())>0){
                    ...
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and kd_kamar='"+kdkamar.getText()+"' and tgl_masuk='"+TIn.getText()+"' and jam_masuk='"+JamMasuk.getText()+"'","stts_pulang='-',tgl_keluar=NULL,jam_keluar=NULL");
                    if(tabMode.getRowCount()>1){
                        try {
                            if(tbKamIn.getValueAt(tbKamIn.getSelectedRow()+1,0).toString().equals("")){
                                tabMode.removeRow(tbKamIn.getSelectedRow()+1);
...
//                                    returjual.setPasien(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString(),rs2.getString("no_rawat2"));
    ...
    private void surkon_dewasa(){
        ...
        ps=koneksi.prepareStatement("select skdp_bpjs.tahun,skdp_bpjs.no_rkm_medis,pasien.nm_pasien,skdp_bpjs.diagnosa,skdp_bpjs.terapi,skdp_bpjs.alasan1,skdp_bpjs.alasan2," +
            "skdp_bpjs.rtl1,skdp_bpjs.rtl2,skdp_bpjs.tanggal_datang,skdp_bpjs.tanggal_rujukan,skdp_bpjs.no_antrian,skdp_bpjs.kd_dokter,"
            + "dokter.nm_dokter,skdp_bpjs.status,databarang.nama_brng,aturan_pakai.aturan" +
                ...
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        rs2=psanak.executeQuery();
                            ...
                            form.setLocationRelativeTo(internalFrame1);
                            form.emptTeks();
                            form.setNoRm(TNoRwCari.getText(),TPasienCari.getText(),TNoRMCari.getText());
                            form.setVisible(true);
                        } catch(Exception ex){
                              System.out.println("Notifikasi : "+ex);
                        }finally{
...
//                              }
    ...
    private void BtnSimpanSKRIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanSKRIActionPerformed
        if(NomorSurat.getText().trim().equals("")){
...
//        } 
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()!= -1){
                    ...
                    int sr = tbKamIn.getSelectedRow();
                    DlgECT form = new DlgECT (null,false);
                    form.isCek();
                    form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                    form.setLocationRelativeTo(internalFrame1);
                    form.setNoRm(TNoRwCari.getText(),TNoRMCari.getText(),TPasienCari.getText(),tbKamIn.getValueAt(sr, 0).toString()); 
                    form.setVisible(true);
                    //form.emptTeks();
...
//        JOptionPane.showMessageDialog(null, "Show");
    ...
    private void MnPersetujuanTerapiRehabilitasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPersetujuanTerapiRehabilitasiActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
                ...
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        try {
                              ...
                              if(rs2.next()){
                                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                    SuratPersetujuanTerapiRehabilitasi resume=new SuratPersetujuanTerapiRehabilitasi(null,false);
                                    resume.isCek();
                                    resume.emptTeks();
                                    resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                                    resume.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_MnPersetujuanTerapiRehabilitasiActionPerformed

    private void MnJadwalECTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnJadwalECTActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
                ...
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        try {
                              ...
                              rs2=psanak.executeQuery();
                              if(rs2.next()){
                                    DlgBookingECT form=new DlgBookingECT(null,false);
                                    form.isCek();
                                    form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                                    form.setLocationRelativeTo(internalFrame1);
                                    form.setNoRm(rs2.getString("no_rawat2"),rs2.getString("no_rkm_medis"),rs2.getString("nm_pasien"),tbKamIn.getValueAt(tbKamIn.getSelectedRow(),7).toString(),"Ranap");
...
//        form.setVisible(true);
    ...
    */
    ...
    private javax.swing.JMenuItem MnJadwalECT;
    ...
    private javax.swing.JMenuItem MnPersetujuanTerapiRehabilitasi;
...
//            key= kmr+"and (kamar_inap.no_rawat like '%"+CrPtg.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+CrPtg.getText().trim()+"%' or pasien.nm_pasien like '%"+CrPtg.getText().trim()+"%' or "+
//               "concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) like '%"+CrPtg.getText().trim()+"%' or kamar_inap.kd_kamar like '%"+CrPtg.getText().trim()+"%' or "+
//               "bangsal.nm_bangsal like '%"+CrPtg.getText().trim()+"%' or kamar_inap.diagnosa_awal like '%"+CrPtg.getText().trim()+"%' or kamar_inap.diagnosa_akhir like '%"+CrPtg.getText().trim()+"%' or "+
//               "kamar_inap.tgl_masuk like '%"+CrPtg.getText().trim()+"%' or dokter.nm_dokter like '%"+CrPtg.getText().trim()+"%' or kamar_inap.stts_pulang like '%"+CrPtg.getText().trim()+"%' or "+
//               "kamar_inap.tgl_keluar like '%"+CrPtg.getText().trim()+"%' or penjab.png_jawab like '%"+CrPtg.getText().trim()+"%' or pasien.agama like '%"+CrPtg.getText().trim()+"%') ";
//        }
        ...
        try{
            ps=koneksi.prepareStatement(
               ...
               "kamar_inap.ttl_biaya,kamar_inap.stts_pulang,kamar_inap.lama,kamar_inap.kd_kamar,reg_periksa.kd_pj,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,reg_periksa.status_bayar, "+ 
            	"pasien.agama, dokter.nm_dokter "+
					"from kamar_inap "+ 
