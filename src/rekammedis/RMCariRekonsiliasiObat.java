...
public class RMCariRekonsiliasiObat extends javax.swing.JDialog {
    ...
    public RMCariRekonsiliasiObat(java.awt.Frame parent, boolean modal) {
        ...
        DlgValidasiObatRekonsiliasi.setSize(572,165);
    ...
    private void initComponents() {
        ...
        DlgValidasiObatRekonsiliasi = new javax.swing.JDialog();
        internalFrame5 = new widget.InternalFrame();
        panelBiasa3 = new widget.PanelBiasa();
        BtnKeluarRekon1 = new widget.Button();
        BtnSimpanRekon1 = new widget.Button();
        NoRekonsiliasi1 = new widget.TextBox();
        jLabel104 = new widget.Label();
        jLabel105 = new widget.Label();
        DivalidasiDokter = new widget.Tanggal();
        ...
        BtnKonfirmasi1 = new widget.Button();
        ...
        DiterimaFarmasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2023 15:07:26" }));
        ...
        DikonfirmasiApoteker.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2023 15:07:26" }));
        ...
        DiserahkanPasien.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2023 15:07:26" }));
        ...
        DlgValidasiObatRekonsiliasi.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        DlgValidasiObatRekonsiliasi.setName("DlgValidasiObatRekonsiliasi"); // NOI18N
        DlgValidasiObatRekonsiliasi.setUndecorated(true);
        DlgValidasiObatRekonsiliasi.setResizable(false);

        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Validasi Rekonsiliasi Obat Oleh DPJP ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        BtnKeluarRekon1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cross.png"))); // NOI18N
        BtnKeluarRekon1.setMnemonic('U');
        BtnKeluarRekon1.setText("Tutup");
        BtnKeluarRekon1.setToolTipText("Alt+U");
        BtnKeluarRekon1.setName("BtnKeluarRekon1"); // NOI18N
        BtnKeluarRekon1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnKeluarRekon1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKeluarRekon1ActionPerformed(evt);
            }
        });
        panelBiasa3.add(BtnKeluarRekon1);
        BtnKeluarRekon1.setBounds(450, 100, 100, 30);

        BtnSimpanRekon1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/save-16x16.png"))); // NOI18N
        BtnSimpanRekon1.setMnemonic('S');
        BtnSimpanRekon1.setText("Simpan");
        BtnSimpanRekon1.setToolTipText("Alt+S");
        BtnSimpanRekon1.setName("BtnSimpanRekon1"); // NOI18N
        BtnSimpanRekon1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSimpanRekon1ActionPerformed(evt);
            }
        });
        BtnSimpanRekon1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnSimpanRekon1KeyPressed(evt);
            }
        });
        panelBiasa3.add(BtnSimpanRekon1);
        BtnSimpanRekon1.setBounds(350, 100, 100, 30);

        NoRekonsiliasi1.setHighlighter(null);
        NoRekonsiliasi1.setName("NoRekonsiliasi1"); // NOI18N
        NoRekonsiliasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoRekonsiliasi1KeyPressed(evt);
            }
        });
        panelBiasa3.add(NoRekonsiliasi1);
        NoRekonsiliasi1.setBounds(134, 10, 140, 23);

        jLabel104.setText("Nomor Rekonsiliasi :");
        jLabel104.setName("jLabel104"); // NOI18N
        panelBiasa3.add(jLabel104);
        jLabel104.setBounds(0, 10, 130, 23);

        jLabel105.setText("Divalidasi Dokter :");
        jLabel105.setName("jLabel105"); // NOI18N
        panelBiasa3.add(jLabel105);
        jLabel105.setBounds(0, 40, 130, 23);

        DivalidasiDokter.setForeground(new java.awt.Color(50, 70, 50));
        DivalidasiDokter.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-08-2023 15:11:51" }));
        DivalidasiDokter.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        DivalidasiDokter.setName("DivalidasiDokter"); // NOI18N
        DivalidasiDokter.setOpaque(false);
        DivalidasiDokter.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DivalidasiDokterKeyPressed(evt);
            }
        });
        panelBiasa3.add(DivalidasiDokter);
        DivalidasiDokter.setBounds(134, 40, 130, 23);

        jLabel10.setText("DPJP :");
        jLabel10.setName("jLabel10"); // NOI18N
        panelBiasa3.add(jLabel10);
        jLabel10.setBounds(0, 70, 130, 23);

        KodeDokter.setEditable(false);
        KodeDokter.setName("KodeDokter"); // NOI18N
        panelBiasa3.add(KodeDokter);
        KodeDokter.setBounds(134, 70, 128, 23);

        NamaDokter.setEditable(false);
        NamaDokter.setHighlighter(null);
        NamaDokter.setName("NamaDokter"); // NOI18N
        panelBiasa3.add(NamaDokter);
        NamaDokter.setBounds(264, 70, 255, 23);
        ...
        panelBiasa3.add(BtnDokter);
        BtnDokter.setBounds(522, 70, 28, 23);

        internalFrame5.add(panelBiasa3, java.awt.BorderLayout.CENTER);

        DlgValidasiObatRekonsiliasi.getContentPane().add(internalFrame5, java.awt.BorderLayout.CENTER);
        ...
        BtnKonfirmasi.setText("Konfirm Apoteker");
        BtnKonfirmasi.setToolTipText("Alt+K");
        BtnKonfirmasi.setName("BtnKonfirmasi"); // NOI18N
        BtnKonfirmasi.setPreferredSize(new java.awt.Dimension(150, 30));
        ...
        BtnKonfirmasi1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept_page.png"))); // NOI18N
        BtnKonfirmasi1.setMnemonic('K');
        BtnKonfirmasi1.setText("Validasi Dokter");
        BtnKonfirmasi1.setToolTipText("Alt+K");
        BtnKonfirmasi1.setName("BtnKonfirmasi1"); // NOI18N
        BtnKonfirmasi1.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnKonfirmasi1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKonfirmasi1ActionPerformed(evt);
            }
        });
        BtnKonfirmasi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnKonfirmasi1KeyPressed(evt);
            }
        });
        panelisi1.add(BtnKonfirmasi1);
...
private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
    ...
    private void BtnKonfirmasi1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonfirmasi1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().equals("")){
                NoRekonsiliasi1.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());
                DlgValidasiObatRekonsiliasi.setLocationRelativeTo(internalFrame1);
                DlgValidasiObatRekonsiliasi.setVisible(true);
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilih data..!!");
            }     
        }
    ...
    private void BtnKonfirmasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKonfirmasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKonfirmasi1KeyPressed

    private void BtnKeluarRekon1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarRekon1ActionPerformed
        // TODO add your handling code here:
        DlgValidasiObatRekonsiliasi.dispose();
    }//GEN-LAST:event_BtnKeluarRekon1ActionPerformed

    private void BtnSimpanRekon1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanRekon1ActionPerformed
        // TODO add your handling code here:
        if(NoRekonsiliasi1.getText().trim().equals("")){
            Valid.textKosong(NoRekonsiliasi1,"Nomor Rekonsiliasi");
        }else if(KodeDokter.getText().trim().equals("")||NamaDokter.getText().trim().equals("")){
            Valid.textKosong(BtnDokter,"Dokter");
        }else{
            Sequel.meghapus("rekonsiliasi_obat_konfirmasi_dpjp","no_rekonsiliasi",NoRekonsiliasi.getText());
            if(Sequel.menyimpantf("rekonsiliasi_obat_konfirmasi_dpjp","?,?,?","Nomor Rekonsiliasi",3,new String[]{
                NoRekonsiliasi1.getText(),
                Valid.SetTgl(DivalidasiDokter.getSelectedItem()+"")+" "+DivalidasiDokter.getSelectedItem().toString().substring(11,19),
                KodeDokter.getText()
            })==true){
                tampil();
                NoRekonsiliasi1.setText("");
                DlgValidasiObatRekonsiliasi.dispose();
                dokter.dispose();
            }
        }
    }//GEN-LAST:event_BtnSimpanRekon1ActionPerformed

    private void BtnSimpanRekon1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanRekon1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSimpanRekon1KeyPressed

    private void NoRekonsiliasi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoRekonsiliasi1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoRekonsiliasi1KeyPressed

    private void DivalidasiDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DivalidasiDokterKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DivalidasiDokterKeyPressed
    ...
    */
    ...
    private widget.TextBox NoRekonsiliasi1;
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps4=koneksi.prepareStatement(
                            "select rekonsiliasi_obat_konfirmasi_dpjp.kd_dokter, rekonsiliasi_obat_konfirmasi_dpjp.dikonfirmasi_dpjp, dokter.nm_dokter from rekonsiliasi_obat_konfirmasi_dpjp inner join dokter on rekonsiliasi_obat_konfirmasi_dpjp.kd_dokter=dokter.kd_dokter "+
                            "where rekonsiliasi_obat_konfirmasi_dpjp.no_rekonsiliasi=?");
                    try {
                        ps4.setString(1,rs.getString("no_rekonsiliasi"));
                        rs4=ps4.executeQuery();
                        if(rs4.next()){
                            tabMode.addRow(new String[]{
                                "","Divalidasi Dokter : "+rs4.getString("dikonfirmasi_dpjp"),"","","","","",""
                            });
                            tabMode.addRow(new String[]{
                                "","DPJP : "+rs4.getString("kd_dokter")+" "+rs4.getString("nm_dokter"),"","","","","",""
                            });
                        }
                    } catch (Exception e) {
                        System.out.println("Notif 3 : "+e);
