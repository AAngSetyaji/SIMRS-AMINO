 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalKeperawatanRanapPsikiatriDewasa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalKeperawatanRanapPsikiatriDewasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        KetRPOPenggunaan.setDocument(new batasInput((int)100).getKata(KetRPOPenggunaan));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Keperawatan Rawat Inap Psikiatri Dewasa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-09-2023 10:01:59" }));
...
//        Ekonomi Finansial
        ...
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ranap_psikiatri_dewasa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",143,new String[]{
            ...
            try{
                if(TCari.getText().equals("")){
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.informasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.keluhan_utama,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_sakit_sejak,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_keluhan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_berobat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_hasil_pengobatan,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_masalah_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_masalah_fisik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_masalah_fisik,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_masalah_psikososial,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_masalah_psikososial,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.resiko_bunuh_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_ide,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_ide,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_alat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_alat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_percobaan,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_percobaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_efek_samping,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rpo_efek_samping,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_napza,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rpo_napza,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_lama_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_cara_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_latar_belakang_pemakaian,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_alasan_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_alergi_obat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_alergi_obat,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_merokok,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_merokok,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.td,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nadi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.gcs,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rr,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.suhu,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pf_keluhan_fisik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_keluhan_fisik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.skala_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.durasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nyeri,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.provokes,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_provokes,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.quality,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_quality,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.lokasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.menyebar,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pada_dokter,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_dokter,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nyeri_hilang,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.bb,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tb,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.bmi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.lapor_status_nutrisi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_lapor_status_nutrisi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sg1,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilai1,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sg2,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilai2,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.total_hasil,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.resikojatuh,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.bjm,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.msa,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hasil,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.lapor,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_lapor,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_mandi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_berpakaian,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_makan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_bak,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_bab,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_sosialisasi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_adl_sosialisasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_penampilan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_alam_perasaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_pembicaraan,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_afek,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_aktifitas_motorik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_gangguan_ringan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_proses_pikir,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_orientasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_tingkat_kesadaran_orientasi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_memori,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_interaksi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_konsentrasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_isi_pikir,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_daya_tilik_diri," + 
                            
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.komunikasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pengasuh,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pengasuh_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.polaketerlibatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_orangdekat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_orangdekat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_peranserta,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_hambatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.gambaran_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ideal_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.peran_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.identitas,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.identitas_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hargadiri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilaikeyakinan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilaikeyakinan_ya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilai_ya_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ekonomi,"+
                                    
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_pembelajaran,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_pembelajaran,"+       
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_pembelajaran_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_penerjamah,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_penerjamah_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_bahasa_isyarat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_kebutuhan_edukasi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rencana,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nip,petugas.nama "+
                            "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join penilaian_awal_keperawatan_ranap_psikiatri_dewasa on reg_periksa.no_rawat=penilaian_awal_keperawatan_ranap_psikiatri_dewasa.no_rawat "+
                            "inner join petugas on penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nip=petugas.nip "+
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal between ? and ? order by penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.informasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.keluhan_utama,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_sakit_sejak,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_keluhan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_berobat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_hasil_pengobatan,"+
                            ...
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal between ? and ? and "+
                            "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nip like ? or petugas.nama like ?) "+
                            "order by penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal");
                }
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
       if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalKeperawatanRalanPsikiatri.jasper","report","::[ Laporan Penilaian Awal Keperawatan Ralan Psikiatri ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tanggal,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.informasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.keluhan_utama,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_sakit_sejak,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_keluhan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_berobat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_jenis_berobat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rkd_hasil_pengobatan,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_masalah_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_masalah_fisik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_masalah_fisik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.fp_masalah_psikososial,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_masalah_psikososial,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.resiko_bunuh_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_ide,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_ide,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_alat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_alat,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_percobaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_percobaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_efek_samping,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rpo_efek_samping,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_napza,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_rpo_napza,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_lama_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_cara_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_latar_belakang_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_alasan_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_alergi_obat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_alergi_obat,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_merokok,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_merokok,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rpo_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.td,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nadi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.gcs,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rr,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.suhu,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pf_keluhan_fisik,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_keluhan_fisik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.skala_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.durasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nyeri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.provokes,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_provokes,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.quality,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_quality,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.lokasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.menyebar,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pada_dokter,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_dokter,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nyeri_hilang,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.bb,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.tb,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.bmi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.lapor_status_nutrisi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_lapor_status_nutrisi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sg1,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilai1,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sg2,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilai2,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.total_hasil,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.resikojatuh,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.bjm,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.msa,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hasil,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.lapor,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_lapor,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_mandi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_berpakaian,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_makan,"+       
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_bak,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_bab,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_sosialisasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_adl_sosialisasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_penampilan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_alam_perasaan,"+      
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_pembicaraan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_afek,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_aktifitas_motorik,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_gangguan_ringan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_proses_pikir,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_orientasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_tingkat_kesadaran_orientasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_memori,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_interaksi,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_konsentrasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_isi_pikir,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_pembelajaran,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_pembelajaran,"+       
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_pembelajaran_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_penerjamah,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_penerjamah_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_bahasa_isyarat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rencana,"+                  
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nip,petugas.nama "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_awal_keperawatan_ranap_psikiatri_dewasa on reg_periksa.no_rawat=penilaian_awal_keperawatan_ranap_psikiatri_dewasa.no_rawat "+
                        "inner join petugas on penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nip=petugas.nip "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanRanapPsikiatriDewasa dialog = new RMPenilaianAwalKeperawatanRanapPsikiatriDewasa(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_sk_daya_tilik_diri,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.komunikasi, penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pengasuh, penilaian_awal_keperawatan_ranap_psikiatri_dewasa.pengasuh_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.polaketerlibatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_orangdekat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_orangdekat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_peranserta,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hubsos_hambatan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.gambaran_diri,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ideal_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.peran_diri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.identitas,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.identitas_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.hargadiri,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilaikeyakinan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilaikeyakinan_ya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nilai_ya_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kebutuhan_pelayanan,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kebutuhan_pelayanan_ya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ekonomi," +      
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_pembelajaran,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_pembelajaran,"+       
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_pembelajaran_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_penerjamah,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_penerjamah_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_bahasa_isyarat,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.kk_kebutuhan_edukasi,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_dewasa.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.rencana,penilaian_awal_keperawatan_ranap_psikiatri_dewasa.nip,petugas.nama "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
        ...
        if(tbObat.getSelectedRow()!= -1){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_etiologi_psikiatri on penilaian_awal_keperawatan_ranap_etiologi_psikiatri.kode_etiologi=master_etiologi_keperawatan.kode_etiologi "+
                        "where penilaian_awal_keperawatan_ranap_etiologi_psikiatri.no_rawat=? order by penilaian_awal_keperawatan_ranap_etiologi_psikiatri.kode_etiologi");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_luaran_psikiatri on penilaian_awal_keperawatan_ranap_luaran_psikiatri.kode_luaran=master_luaran_keperawatan.kode_luaran "+
                        "where penilaian_awal_keperawatan_ranap_luaran_psikiatri.no_rawat=? order by penilaian_awal_keperawatan_ranap_luaran_psikiatri.kode_luaran");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_dewasa());
        BtnHapus.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_dewasa());
        BtnEdit.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_dewasa());
        BtnEdit.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_dewasa());
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_keperawatan_ranap_psikiatri_dewasa where no_rawat=?",1,new String[]{
            ...
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_etiologi_psikiatri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_luaran_psikiatri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Valid.tabelKosong(tabModeDetailMasalah);
            Valid.tabelKosong(tabModeDetailRencana);
