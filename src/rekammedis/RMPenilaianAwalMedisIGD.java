...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Mata","Gigi & Mulut","Leher","Thoraks","Abdomen","Genital & Anus","Ekstremitas","Ket.Pemeriksaan Fisik","Ket.Status Lokalis",
            "Keadaan Umum","Kesadaran Jiwa","Orientasi Umum","Sikap","Tingkah Laku","Bentuk Pikir","Arus Pikir","Isi Pikir","Keterangan Isi Pikir","Mood","Afek","Halusinasi","Ilusi","Keterangan Halu",
            "Daya Konsentrasi","Orientasi","Daya Ingat","Pikiran Abstrak","Perhatian","Pengendalian Impuls","Daya Nilai","Tilikan","Taraf dapat dipercaya","Skor Penilaian PANSS-EC",
            "EKG","Radiologi","Laborat","Diagnosis/Asesmen","Tatalaksana"
        }){
        ...
        KetIsipikir.setDocument(new batasInput((int)3000).getKata(KetIsipikir));
        KetHalu.setDocument(new batasInput((int)3000).getKata(KetHalu));
        Skor.setDocument(new batasInput((int)10).getKata(Skor));
    ...
    private void initComponents() {
        ...
        KesadaranJiwa = new widget.ComboBox();
        OrientasiUmum = new widget.ComboBox();
        jLabel52 = new widget.Label();
        jLabel53 = new widget.Label();
        Sikap = new widget.ComboBox();
        jLabel54 = new widget.Label();
        Tingkahlaku = new widget.ComboBox();
        Bentukpikir = new widget.ComboBox();
        jLabel55 = new widget.Label();
        jLabel56 = new widget.Label();
        Aruspikir = new widget.ComboBox();
        jLabel57 = new widget.Label();
        Isipikir = new widget.ComboBox();
        jLabel105 = new widget.Label();
        jLabel106 = new widget.Label();
        Mood = new widget.ComboBox();
        jLabel58 = new widget.Label();
        jLabel59 = new widget.Label();
        Afek = new widget.ComboBox();
        jLabel107 = new widget.Label();
        Halusinasi = new widget.ComboBox();
        jLabel61 = new widget.Label();
        jLabel62 = new widget.Label();
        Ilusi = new widget.ComboBox();
        jLabel108 = new widget.Label();
        Dayakonsen = new widget.ComboBox();
        jLabel63 = new widget.Label();
        jLabel64 = new widget.Label();
        OrientasiIntelek = new widget.ComboBox();
        Dayaingat = new widget.ComboBox();
        jLabel65 = new widget.Label();
        jLabel66 = new widget.Label();
        Pikiranabstrak = new widget.ComboBox();
        Perhatian = new widget.ComboBox();
        jLabel67 = new widget.Label();
        Pengendalianimpuls = new widget.ComboBox();
        jLabel69 = new widget.Label();
        Dayanilai = new widget.ComboBox();
        jLabel70 = new widget.Label();
        jLabel71 = new widget.Label();
        Tilikan = new widget.ComboBox();
        Taraf = new widget.ComboBox();
        jLabel72 = new widget.Label();
        jLabel109 = new widget.Label();
        Skor = new widget.TextBox2();
        KetHalu = new widget.TextArea();
        KetIsipikir = new widget.TextArea();
        ...
        jSeparator14.setBounds(0, 1450, 880, 1);
        ...
        scrollPane9.setBounds(50, 1490, 260, 63);
        ...
        jLabel101.setBounds(10, 1450, 190, 23);
        ...
        scrollPane12.setBounds(50, 1580, 810, 43);
        ...
        jLabel102.setBounds(10, 1560, 190, 23);
        ...
        scrollPane13.setBounds(50, 1650, 810, 140);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-09-2023 10:10:49" }));
        ...
        jLabel80.setBounds(50, 1470, 150, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(320, 1470, 150, 23);
        ...
        scrollPane10.setBounds(320, 1490, 260, 63);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("Laborat :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(600, 1470, 150, 23);
        ...
        scrollPane11.setBounds(600, 1490, 260, 63);
        ...
        jSeparator17.setBounds(0, 870, 880, 1);

        jLabel104.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel104.setText("b. Gangguan berfikir");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(50, 1040, 190, 23);
        ...
        KeadaanUmum.setBounds(150, 890, 128, 23);

        jLabel47.setText(" a. Keadaan Umum :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(20, 890, 120, 23);

        jLabel48.setText("Kesadaran :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(40, 920, 100, 23);

        KesadaranJiwa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Jernih", "Berkabut" }));
        ...
        FormInput.add(KesadaranJiwa);
        KesadaranJiwa.setBounds(150, 920, 128, 23);

        OrientasiUmum.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Disorientasi" }));
        OrientasiUmum.setName("OrientasiUmum"); // NOI18N
        OrientasiUmum.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                OrientasiUmumKeyPressed(evt);
            }
        });
        FormInput.add(OrientasiUmum);
        OrientasiUmum.setBounds(150, 950, 128, 23);

        jLabel52.setText("Orientasi :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(40, 950, 100, 23);

        jLabel53.setText("Sikap :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(40, 980, 100, 23);

        Sikap.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kooperatif", "Tidak Kooperatif" }));
        ...
        FormInput.add(Sikap);
        Sikap.setBounds(150, 980, 128, 23);

        jLabel54.setText("Tingkah laku :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(40, 1010, 100, 23);

        Tingkahlaku.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normoaktif", "Hiperaktif", "Agresif", "Negativistik" }));
        ...
        Tingkahlaku.setBounds(150, 1010, 128, 23);

        Bentukpikir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Realistik", "Non realistik" }));
        Bentukpikir.setName("Bentukpikir"); // NOI18N
        Bentukpikir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BentukpikirActionPerformed(evt);
            }
        });
        Bentukpikir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BentukpikirKeyPressed(evt);
            }
        });
        FormInput.add(Bentukpikir);
        Bentukpikir.setBounds(150, 1060, 128, 23);

        jLabel55.setText("Bentuk pikir :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(40, 1060, 100, 23);

        jLabel56.setText("Arus Pikir :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(40, 1090, 100, 23);

        Aruspikir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lancar", "Tidak lancar" }));
        Aruspikir.setName("Aruspikir"); // NOI18N
        Aruspikir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AruspikirKeyPressed(evt);
            }
        });
        FormInput.add(Aruspikir);
        Aruspikir.setBounds(150, 1090, 128, 23);

        jLabel57.setText("Isi Pikir :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(40, 1120, 100, 23);

        Isipikir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Gangguan" }));
        Isipikir.setName("Isipikir"); // NOI18N
        Isipikir.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                IsipikirItemStateChanged(evt);
            }
        });
        Isipikir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                IsipikirActionPerformed(evt);
            }
        });
        Isipikir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IsipikirKeyPressed(evt);
            }
        });
        FormInput.add(Isipikir);
        Isipikir.setBounds(150, 1120, 128, 23);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("IV.STATUS PSIKIATRI");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(10, 870, 190, 23);

        jLabel106.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel106.setText("INSTRUMEN PENILAIAN PANSS-EC, SKOR:");
        ...
        FormInput.add(Mood);
        Mood.setBounds(150, 1270, 128, 23);

        jLabel58.setText("Mood :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(40, 1270, 100, 23);

        jLabel59.setText("Afek :");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(40, 1300, 100, 23);

        Afek.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Serasi", "Tidak serasi" }));
        ...
        FormInput.add(Afek);
        Afek.setBounds(150, 1300, 128, 23);

        jLabel107.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel107.setText("d. Persepsi");
        jLabel107.setName("jLabel107"); // NOI18N
        FormInput.add(jLabel107);
        jLabel107.setBounds(500, 890, 190, 23);

        Halusinasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak ada" }));
        Halusinasi.setName("Halusinasi"); // NOI18N
        Halusinasi.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                HalusinasiItemStateChanged(evt);
            }
        });
        Halusinasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HalusinasiActionPerformed(evt);
            }
        });
        ...
        Halusinasi.setBounds(600, 910, 128, 23);

        jLabel61.setText("Halusinasi :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(490, 910, 100, 23);

        jLabel62.setText("Ilusi :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(490, 940, 100, 23);

        Ilusi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada", "Tidak ada" }));
        Ilusi.setName("Ilusi"); // NOI18N
        Ilusi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IlusiKeyPressed(evt);
            }
        });
        FormInput.add(Ilusi);
        Ilusi.setBounds(600, 940, 128, 23);

        jLabel108.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel108.setText("e. Fungsi intelektual");
        jLabel108.setName("jLabel108"); // NOI18N
        FormInput.add(jLabel108);
        jLabel108.setBounds(510, 1070, 190, 23);

        Dayakonsen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        Dayakonsen.setName("Dayakonsen"); // NOI18N
        Dayakonsen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DayakonsenActionPerformed(evt);
            }
        });
        Dayakonsen.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DayakonsenKeyPressed(evt);
            }
        });
        FormInput.add(Dayakonsen);
        Dayakonsen.setBounds(610, 1090, 128, 23);

        jLabel63.setText("Daya konsentrasi :");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(500, 1090, 100, 23);

        jLabel64.setText("Orientasi :");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(500, 1120, 100, 23);

        OrientasiIntelek.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        OrientasiIntelek.setName("OrientasiIntelek"); // NOI18N
        OrientasiIntelek.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OrientasiIntelekActionPerformed(evt);
            }
        });
        OrientasiIntelek.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                OrientasiIntelekKeyPressed(evt);
            }
        });
        FormInput.add(OrientasiIntelek);
        OrientasiIntelek.setBounds(610, 1120, 128, 23);

        Dayaingat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        Dayaingat.setName("Dayaingat"); // NOI18N
        Dayaingat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DayaingatActionPerformed(evt);
            }
        });
        ...
        Dayaingat.setBounds(610, 1150, 128, 23);

        jLabel65.setText("Daya ingat :");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(500, 1150, 100, 23);

        jLabel66.setText("Pikiran abstrak :");
        jLabel66.setName("jLabel66"); // NOI18N
        FormInput.add(jLabel66);
        jLabel66.setBounds(500, 1180, 100, 23);

        Pikiranabstrak.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        Pikiranabstrak.setName("Pikiranabstrak"); // NOI18N
        Pikiranabstrak.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PikiranabstrakKeyPressed(evt);
            }
        });
        FormInput.add(Pikiranabstrak);
        Pikiranabstrak.setBounds(610, 1180, 128, 23);

        Perhatian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normo Vigiltas", "Hyper Vigiltas", "Hypo Vigiltas", "Distraktibilitas" }));
        Perhatian.setName("Perhatian"); // NOI18N
        Perhatian.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PerhatianActionPerformed(evt);
            }
        });
        Perhatian.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PerhatianKeyPressed(evt);
            }
        });
        FormInput.add(Perhatian);
        Perhatian.setBounds(610, 1210, 128, 23);

        jLabel67.setText("Perhatian :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(500, 1210, 100, 23);

        Pengendalianimpuls.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        Pengendalianimpuls.setName("Pengendalianimpuls"); // NOI18N
        Pengendalianimpuls.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PengendalianimpulsActionPerformed(evt);
            }
        });
        ...
        FormInput.add(Pengendalianimpuls);
        Pengendalianimpuls.setBounds(610, 1250, 128, 23);

        jLabel69.setText("f. Pengendalian impuls :");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(480, 1250, 120, 23);

        Dayanilai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        Dayanilai.setName("Dayanilai"); // NOI18N
        Dayanilai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DayanilaiActionPerformed(evt);
            }
        });
        ...
        FormInput.add(Dayanilai);
        Dayanilai.setBounds(610, 1290, 128, 23);

        jLabel70.setText("g. Daya nilai :");
        jLabel70.setName("jLabel70"); // NOI18N
        FormInput.add(jLabel70);
        jLabel70.setBounds(500, 1290, 100, 23);

        jLabel71.setText("h. Tilikan :");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(500, 1330, 100, 23);

        Tilikan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Baik", "Tidak baik" }));
        ...
        FormInput.add(Tilikan);
        Tilikan.setBounds(610, 1330, 128, 23);

        Taraf.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Dapat dipercaya", "Tidak dapat dipercaya" }));
        Taraf.setName("Taraf"); // NOI18N
        Taraf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TarafActionPerformed(evt);
            }
        });
        Taraf.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TarafKeyPressed(evt);
            }
        });
        FormInput.add(Taraf);
        Taraf.setBounds(610, 1370, 128, 23);

        jLabel72.setText("i. Taraf dapat dipercaya :");
        jLabel72.setName("jLabel72"); // NOI18N
        FormInput.add(jLabel72);
        jLabel72.setBounds(470, 1370, 130, 23);

        jLabel109.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel109.setText("c. Alam perasaan");
        jLabel109.setName("jLabel109"); // NOI18N
        FormInput.add(jLabel109);
        jLabel109.setBounds(50, 1250, 190, 23);

        Skor.setName("Skor"); // NOI18N
        FormInput.add(Skor);
        Skor.setBounds(260, 1410, 80, 20);

        KetHalu.setBorder(javax.swing.BorderFactory.createTitledBorder("Keterangan Halusinasi"));
        KetHalu.setColumns(20);
        KetHalu.setRows(5);
        KetHalu.setName("KetHalu"); // NOI18N
        FormInput.add(KetHalu);
        KetHalu.setBounds(600, 970, 240, 93);
        KetHalu.getAccessibleContext().setAccessibleName("Diisi bila \"Halusinasi\" ada");

        KetIsipikir.setBorder(javax.swing.BorderFactory.createTitledBorder("Keterangan Isi Pikir"));
        KetIsipikir.setColumns(20);
        KetIsipikir.setRows(5);
        KetIsipikir.setEnabled(false);
        KetIsipikir.setName("KetIsipikir"); // NOI18N
        FormInput.add(KetIsipikir);
        KetIsipikir.setBounds(150, 1150, 170, 93);
        KetIsipikir.getAccessibleContext().setAccessibleName("Diisi bila \"Isi Pikir\" gangguan");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",60,new String[]{
                    ...
                    Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Genital.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),KetFisik.getText(),
                   
                    KetLokalis.getText(),
                    
                    KeadaanUmum.getSelectedItem().toString(),KesadaranJiwa.getSelectedItem().toString(),OrientasiUmum.getSelectedItem().toString(),Sikap.getSelectedItem().toString(),Tingkahlaku.getSelectedItem().toString(),
                    Bentukpikir.getSelectedItem().toString(),Aruspikir.getSelectedItem().toString(),Isipikir.getSelectedItem().toString(),KetIsipikir.getText().toString(),Mood.getSelectedItem().toString(),Afek.getSelectedItem().toString(),Halusinasi.getSelectedItem().toString(),Ilusi.getSelectedItem().toString(),
                    KetHalu.getText(),Dayakonsen.getSelectedItem().toString(),OrientasiIntelek.getSelectedItem().toString(),Dayaingat.getSelectedItem().toString(),Pikiranabstrak.getSelectedItem().toString(),
                    Perhatian.getSelectedItem().toString(),Pengendalianimpuls.getSelectedItem().toString(),Dayanilai.getSelectedItem().toString(),Tilikan.getSelectedItem().toString(),Taraf.getSelectedItem().toString(),Skor.getText(),
                    
                    EKG.getText(),Radiologi.getText(),Laborat.getText(),Diagnosis.getText(),Tatalaksana.getText()
                })==true){
                    emptTeks();
            }
        }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisIGD.jasper","report","::[ Laporan Penilaian Awal Medis IGD ]::",
                ...
                "penilaian_medis_igd.keadaanumum,penilaian_medis_igd.kesadaran_jiwa,penilaian_medis_igd.orientasi_jiwa,penilaian_medis_igd.sikap,penilaian_medis_igd.tingkah_laku,penilaian_medis_igd.bentuk_pikir,penilaian_medis_igd.arus_pikir,penilaian_medis_igd.isi_pikir,"+
                "penilaian_medis_igd.ket_isipikir,penilaian_medis_igd.mood,penilaian_medis_igd.afek,penilaian_medis_igd.halusinasi," +
                "penilaian_medis_igd.ilusi,penilaian_medis_igd.ket_halu,penilaian_medis_igd.orien_intelek,penilaian_medis_igd.daya_konsen,penilaian_medis_igd.daya_ingat," +
                "penilaian_medis_igd.pikir_abstrak,penilaian_medis_igd.perhatian,penilaian_medis_igd.impuls,penilaian_medis_igd.daya_nilai,penilaian_medis_igd.tilikan,penilaian_medis_igd.dpt_dipercaya,penilaian_medis_igd.skor_panss,"+
    ...
    private void OrientasiUmumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_OrientasiUmumKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_OrientasiUmumKeyPressed
    ...
    private void BentukpikirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BentukpikirActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BentukpikirActionPerformed

    private void BentukpikirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BentukpikirKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BentukpikirKeyPressed

    private void AruspikirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AruspikirKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_AruspikirKeyPressed

    private void IsipikirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IsipikirKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_IsipikirKeyPressed
    ...
    private void HalusinasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HalusinasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_HalusinasiActionPerformed
    ...
    private void IlusiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IlusiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_IlusiKeyPressed

    private void DayakonsenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DayakonsenActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DayakonsenActionPerformed

    private void DayakonsenKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DayakonsenKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DayakonsenKeyPressed

    private void OrientasiIntelekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrientasiIntelekActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_OrientasiIntelekActionPerformed

    private void OrientasiIntelekKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_OrientasiIntelekKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_OrientasiIntelekKeyPressed

    private void DayaingatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DayaingatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DayaingatActionPerformed
    ...
    private void PikiranabstrakKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PikiranabstrakKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PikiranabstrakKeyPressed

    private void PerhatianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PerhatianActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PerhatianActionPerformed

    private void PerhatianKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PerhatianKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PerhatianKeyPressed

    private void PengendalianimpulsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PengendalianimpulsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PengendalianimpulsActionPerformed
    ...
    private void DayanilaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DayanilaiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DayanilaiActionPerformed
    ...
    private void TarafActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TarafActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TarafActionPerformed

    private void TarafKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TarafKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TarafKeyPressed

    private void HalusinasiItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_HalusinasiItemStateChanged
        if (Halusinasi.getSelectedIndex()==0){
            KetHalu.setEnabled(true);
        }else {
            KetHalu.setEnabled(false);
        }
    }//GEN-LAST:event_HalusinasiItemStateChanged

    private void IsipikirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IsipikirActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_IsipikirActionPerformed

    private void IsipikirItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_IsipikirItemStateChanged
        if (Isipikir.getSelectedIndex()==0){
            KetIsipikir.setEnabled(false);
        }else {
            KetIsipikir.setEnabled(true);
        }
    }//GEN-LAST:event_IsipikirItemStateChanged
    ...
    */
    ...
    private widget.ComboBox Aruspikir;
    private widget.TextBox BB;
    private widget.ComboBox Bentukpikir;
    ...
    private widget.ComboBox Dayaingat;
    private widget.ComboBox Dayakonsen;
    private widget.ComboBox Dayanilai;
    ...
    private widget.ComboBox Halusinasi;
    private widget.TextBox Hubungan;
    private widget.ComboBox Ilusi;
    private widget.ComboBox Isipikir;
    ...
    private widget.ComboBox KesadaranJiwa;
    private widget.TextArea KetFisik;
    private widget.TextArea KetHalu;
    private widget.TextArea KetIsipikir;
    ...
    private widget.ComboBox Mood;
    private widget.TextBox Nadi;
    private widget.TextBox NmDokter;
    private widget.ComboBox OrientasiIntelek;
    private widget.ComboBox OrientasiUmum;
    private usu.widget.glass.PanelGlass PanelWall;
    private widget.ComboBox Pengendalianimpuls;
    private widget.ComboBox Perhatian;
    private widget.ComboBox Pikiranabstrak;
    ...
    private widget.ComboBox Taraf;
    private widget.TextArea Tatalaksana;
    private widget.Tanggal TglAsuhan;
    private widget.TextBox TglLahir;
    private widget.ComboBox Thoraks;
    private widget.ComboBox Tilikan;
    private widget.ComboBox Tingkahlaku;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "penilaian_medis_igd.ekg,penilaian_medis_igd.rad,penilaian_medis_igd.lab,penilaian_medis_igd.diagnosis,penilaian_medis_igd.tata,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_igd on reg_periksa.no_rawat=penilaian_medis_igd.no_rawat "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("keadaanumum"),rs.getString("kesadaran_jiwa"),rs.getString("orientasi_jiwa"),rs.getString("sikap"),rs.getString("tingkah_laku"),rs.getString("bentuk_pikir"),rs.getString("arus_pikir"),rs.getString("isi_pikir"),
                        rs.getString("ket_isipikir"),rs.getString("mood"),rs.getString("afek"),rs.getString("halusinasi"),rs.getString("ilusi"),rs.getString("ket_halu"),rs.getString("daya_konsen"),rs.getString("orien_intelek"),
                        rs.getString("daya_ingat"),rs.getString("pikir_abstrak"),rs.getString("perhatian"),rs.getString("impuls"),rs.getString("daya_nilai"),rs.getString("tilikan"),rs.getString("dpt_dipercaya"),rs.getString("skor_panss"),
                       
                        rs.getString("ekg"),rs.getString("rad"),rs.getString("lab"),rs.getString("diagnosis"),rs.getString("tata")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        KesadaranJiwa.setSelectedIndex(0);
        OrientasiUmum.setSelectedIndex(0);
        Sikap.setSelectedIndex(0);
        Tingkahlaku.setSelectedIndex(0);
        Bentukpikir.setSelectedIndex(0);
        Aruspikir.setSelectedIndex(0);
        Isipikir.setSelectedIndex(0);
        KetIsipikir.setText("");
        Mood.setSelectedIndex(0);
        Afek.setSelectedIndex(0);
        Halusinasi.setSelectedIndex(0);
        Ilusi.setSelectedIndex(0);
        KetHalu.setText("");
        Dayakonsen.setSelectedIndex(0);
        OrientasiIntelek.setSelectedIndex(0);
        Pikiranabstrak.setSelectedIndex(0);
        Perhatian.setSelectedIndex(0);
        Pengendalianimpuls.setSelectedIndex(0);
        Dayanilai.setSelectedIndex(0);
        Tilikan.setSelectedIndex(0);
        Taraf.setSelectedIndex(0);
        Skor.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            KeadaanUmum.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            KesadaranJiwa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString());
            OrientasiUmum.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
            Sikap.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString());
            Tingkahlaku.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            Bentukpikir.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
            Aruspikir.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());
            Isipikir.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
            KetIsipikir.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());
            Mood.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());
            Afek.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());
            Halusinasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString());
            Ilusi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());
            KetHalu.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
            Dayakonsen.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString());
            OrientasiIntelek.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),51).toString());
            Dayaingat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString());
            Pikiranabstrak.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),53).toString());
            Perhatian.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());
            Pengendalianimpuls.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),55).toString());
            Dayanilai.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),56).toString());
            Tilikan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),57).toString());
            Taraf.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),58).toString());
            Skor.setText(tbObat.getValueAt(tbObat.getSelectedRow(),59).toString());
            
            EKG.setText(tbObat.getValueAt(tbObat.getSelectedRow(),60).toString());
            Radiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),61).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),62).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),63).toString());
            Tatalaksana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),64).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_igd","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpk=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,leher=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,ket_fisik=?,ket_lokalis=?,"+
                "keadaanumum=?,kesadaran_jiwa=?,orientasi_jiwa=?,sikap=?,tingkah_laku=?,bentuk_pikir=?,arus_pikir=?,isi_pikir=?,ket_isipikir=?,mood=?,afek=?,halusinasi=?,ilusi=?,ket_halu=?,daya_konsen=?,orien_intelek=?,daya_ingat=?,pikir_abstrak=?,perhatian=?,impuls=?,daya_nilai=?,tilikan=?,dpt_dipercaya=?,skor_panss=?,ekg=?,rad=?,lab=?,diagnosis=?,tata=?",61,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    ...
                    KeadaanUmum.getSelectedItem().toString(),KesadaranJiwa.getSelectedItem().toString(),OrientasiUmum.getSelectedItem().toString(),Sikap.getSelectedItem().toString(),Tingkahlaku.getSelectedItem().toString(),Bentukpikir.getSelectedItem().toString(),
                    Aruspikir.getSelectedItem().toString(),Isipikir.getSelectedItem().toString(),KetIsipikir.getText(),Mood.getSelectedItem().toString(),Afek.getSelectedItem().toString(),Halusinasi.getSelectedItem().toString(),Ilusi.getSelectedItem().toString(),KetHalu.getText(),
                    Dayakonsen.getSelectedItem().toString(),OrientasiIntelek.getSelectedItem().toString(),Dayaingat.getSelectedItem().toString(),Pikiranabstrak.getSelectedItem().toString(),Perhatian.getSelectedItem().toString(),Pengendalianimpuls.getSelectedItem().toString(),
                    Dayanilai.getSelectedItem().toString(),Tilikan.getSelectedItem().toString(),Taraf.getSelectedItem().toString(),Skor.getText(),
