...
public class DlgPermintaanResepPulang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-11-2023" }));
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(ttl>0){
                    ...
                    if (reply == JOptionPane.YES_OPTION) { 
                        ...
                        if(ubah==false){
                            if(Sequel.menyimpantf2("permintaan_resep_pulang","?,?,?,?,?,?,NULL,NULL","Nomer Permintaan",6,new String[]{
