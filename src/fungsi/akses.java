...
public final class akses {
    ...
    public static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            penilaian_kep_ralan_psikiatri_dewasa=false,penilaian_kep_ralan_psikiatri_geriatri=false,
            ...
            NonPas=false,satu_klik_klaim=false,readmision_ranap=false,batal_pindah=false;
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.penilaian_medis_ralan_psikiatri_anak=true;
                        akses.penilaian_kep_ralan_psikiatri_anak=true;
                        akses.penilaian_kep_ralan_psikiatri_dewasa=true;
                        akses.penilaian_kep_ralan_psikiatri_geriatri=true;
                        akses.panss_ec=true;
                        akses.penilaian_medis_ranap_psikiatri_anak=true;
                        akses.penilaian_kep_ranap_psikiatri_anak=true;
                        akses.penilaian_kep_ranap_psikiatri_dewasa=true;
                        akses.penilaian_kep_ranap_psikiatri_geriatri=true;
                        akses.penilaian_medis_ralan_psikiatri_geriatri=true;
                        akses.penilaian_medis_ranap_psikiatri_geriatri=true;
                        akses.penilaian_medis_ralan_psikiatri_dewasa=true;
                        akses.penilaian_medis_ranap_psikiatri_dewasa=true;
                        ...
                        akses.penilaian_aktivitas_kelompok=true;
                        akses.persetujuan_terapi_rehab=true;
                        ...
                        akses.NonPas=true;
                        akses.satu_klik_klaim=true;
                        akses.readmision_ranap=false;
                        akses.batal_pindah=true;
                        ...
                        akses.penilaian_medis_ralan_psikiatri_anak=rs2.getBoolean("penilaian_medis_ralan_psikiatri_anak");
                        akses.penilaian_kep_ralan_psikiatri_anak=rs2.getBoolean("penilaian_kep_ralan_psikiatri_anak");
                        akses.penilaian_kep_ralan_psikiatri_dewasa=rs2.getBoolean("penilaian_kep_ralan_psikiatri_dewasa");
                        akses.penilaian_kep_ralan_psikiatri_geriatri=rs2.getBoolean("penilaian_kep_ralan_psikiatri_geriatri");
                        akses.panss_ec=rs2.getBoolean("panss_ec");
                        akses.penilaian_medis_ranap_psikiatri_anak=rs2.getBoolean("penilaian_medis_ranap_psikiatri_anak");
                        akses.penilaian_kep_ranap_psikiatri_anak=rs2.getBoolean("penilaian_kep_ranap_psikiatri_anak");
                        akses.penilaian_kep_ranap_psikiatri_dewasa=rs2.getBoolean("penilaian_kep_ranap_psikiatri_dewasa");
                        akses.penilaian_kep_ranap_psikiatri_geriatri=rs2.getBoolean("penilaian_kep_ranap_psikiatri_geriatri");
                        akses.penilaian_medis_ralan_psikiatri_geriatri=rs2.getBoolean("penilaian_medis_ralan_psikiatri_geriatri");
                        ...
                        akses.penilaian_aktivitas_kelompok=rs2.getBoolean("penilaian_aktivitas_kelompok");
                        akses.persetujuan_terapi_rehab=rs2.getBoolean("persetujuan_terapi_rehab");
                        ...
                        akses.satu_klik_klaim=rs2.getBoolean("satu_klik_klaim");
                        akses.readmision_ranap=rs2.getBoolean("readmision_ranap");
                        akses.batal_pindah=rs2.getBoolean("batal_pindah");
                        ...
                        akses.penilaian_medis_ralan_psikiatri_anak=false;
                        akses.penilaian_kep_ralan_psikiatri_anak=false;
                        akses.penilaian_kep_ralan_psikiatri_dewasa=false;
                        akses.penilaian_kep_ralan_psikiatri_geriatri=false;
                        akses.panss_ec=false;
                        akses.penilaian_medis_ranap_psikiatri_anak=false;
                        akses.penilaian_kep_ranap_psikiatri_anak=false;
                        akses.penilaian_kep_ranap_psikiatri_dewasa=false;
                        akses.penilaian_kep_ranap_psikiatri_geriatri=false;
                        akses.penilaian_medis_ralan_psikiatri_geriatri=false;
                        akses.penilaian_medis_ranap_psikiatri_geriatri=false;
                        akses.penilaian_medis_ralan_psikiatri_dewasa=false;
                        akses.penilaian_medis_ranap_psikiatri_dewasa=false;
                        ...
                        akses.penilaian_aktivitas_kelompok=false;
                        akses.persetujuan_terapi_rehab=false;
                        ...
                        akses.NonPas=false;
                        akses.satu_klik_klaim=false;
                        akses.readmision_ranap=false;
                        akses.batal_pindah=false;
                    }
                } catch (Exception e) {
    ...
    public static boolean getpenilaian_medis_ralan_psikiatri_anak(){return akses.penilaian_medis_ralan_psikiatri_anak;}
    public static boolean getpenilaian_kep_ralan_psikiatri_anak(){return akses.penilaian_kep_ralan_psikiatri_anak;}
    public static boolean getpenilaian_kep_ralan_psikiatri_dewasa(){return akses.penilaian_kep_ralan_psikiatri_dewasa;}
    public static boolean getpenilaian_kep_ralan_psikiatri_geriatri(){return akses.penilaian_kep_ralan_psikiatri_geriatri;}
    public static boolean getpanss_ec(){return akses.panss_ec;}
    public static boolean getpenilaian_medis_ranap_psikiatri_anak(){return akses.penilaian_medis_ranap_psikiatri_anak;}
    public static boolean getpenilaian_kep_ranap_psikiatri_anak(){return akses.penilaian_kep_ranap_psikiatri_anak;}
    public static boolean getpenilaian_kep_ranap_psikiatri_dewasa(){return akses.penilaian_kep_ranap_psikiatri_dewasa;}
    public static boolean getpenilaian_kep_ranap_psikiatri_geriatri(){return akses.penilaian_kep_ranap_psikiatri_geriatri;}
    public static boolean getpenilaian_medis_ralan_psikiatri_geriatri(){return akses.penilaian_medis_ralan_psikiatri_geriatri;}
    public static boolean getpenilaian_medis_ranap_psikiatri_geriatri(){return akses.penilaian_medis_ranap_psikiatri_geriatri;}
    public static boolean getpenilaian_medis_ralan_psikiatri_dewasa(){return akses.penilaian_medis_ralan_psikiatri_dewasa;}
    public static boolean getpenilaian_medis_ranap_psikiatri_dewasa(){return akses.penilaian_medis_ranap_psikiatri_dewasa;}
    ...
    public static boolean getsatu_klik_klaim(){return akses.satu_klik_klaim;}
    public static boolean getreadmision_ranap(){return akses.readmision_ranap;}
    public static boolean getbatal_pindah(){return akses.batal_pindah;}
    }   
