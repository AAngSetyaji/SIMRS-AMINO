...
public class DlgFrekuensiPenyakitRalan2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgFrekuensiPenyakitRalan2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"Kode","Nama Penyakit","Lk2(Hidup)","Pr(Hidup)","Lk2(Mati)","Pr(Mati)","Jumlah"};
        ...
        if(tbDokter.getRowCount()==0){
            ...
            for(int r=0;r<row;r++){  
                Sequel.menyimpan("temporary","'"+r+"','"+
                                ...
                                tbDokter.getValueAt(r,2).toString()+"','"+
            ...
            Valid.panggilUrl("billing/LaporanPenyakitRalan2.php?tanggal1="+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"&tanggal2="+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"&alamatip="+akses.getalamatip()+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB());                       
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgFrekuensiPenyakitRalan2 dialog = new DlgFrekuensiPenyakitRalan2(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps3=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from penyakit inner join diagnosa_pasien inner join reg_periksa inner join pasien_mati "+
                        ...
                        "where penyakit.kd_penyakit NOT LIKE '%Z%' and reg_periksa.status_lanjut='Ralan' and diagnosa_pasien.status='Ralan' and pasien.jk='L' and reg_periksa.tgl_registrasi between ? and ? "+
                    ...
                    ps4=koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah from penyakit inner join diagnosa_pasien inner join reg_periksa inner join pasien_mati "+
                        ...
                        "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli and "+
                        "pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "+
                        "where penyakit.kd_penyakit NOT LIKE '%Z%' and reg_periksa.status_lanjut='Ralan' and diagnosa_pasien.status='Ralan' and pasien.jk='P' and reg_periksa.tgl_registrasi between ? and ? "+
                        "and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? "+
                        "and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat"); 
                    try {
