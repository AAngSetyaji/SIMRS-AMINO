...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgCariGolonganBPKAD golonganBPKAD = new DlgCariGolonganBPKAD(null, false);
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,new Object[]{
            ...
            "Kode Golongan","Golongan","Nama BPKAD","Kode BPKAD"
        }) {
            @Override
        ...
        golonganBPKAD.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (golonganBPKAD.getTable().getSelectedRow() != -1) {
                        kdBPKAD.setText(golonganBPKAD.getTable().getValueAt(golonganBPKAD.getTable().getSelectedRow(), 0).toString());
                        nmBPKAD.setText(golonganBPKAD.getTable().getValueAt(golonganBPKAD.getTable().getSelectedRow(), 1).toString());
                    }
                }
                BtnGolonganBPKAD.requestFocus();
            }
    ...
    private void initComponents() {
        ...
        kdBPKAD = new widget.TextBox();
        nmBPKAD = new widget.TextBox();
        BtnGolonganBPKAD = new widget.Button();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(660, 360));
        ...
        label25.setText("Golongan BPKAD:");
        label25.setName("label25"); // NOI18N
        label25.setPreferredSize(new java.awt.Dimension(65, 23));
        FormInput.add(label25);
        label25.setBounds(0, 310, 88, 23);

        kdBPKAD.setEditable(false);
        kdBPKAD.setName("kdBPKAD"); // NOI18N
        kdBPKAD.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(kdBPKAD);
        kdBPKAD.setBounds(90, 310, 100, 23);

        nmBPKAD.setEditable(false);
        nmBPKAD.setName("nmBPKAD"); // NOI18N
        nmBPKAD.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(nmBPKAD);
        nmBPKAD.setBounds(190, 310, 268, 23);

        BtnGolonganBPKAD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnGolonganBPKAD.setMnemonic('2');
        BtnGolonganBPKAD.setToolTipText("Alt+2");
        BtnGolonganBPKAD.setName("BtnGolonganBPKAD"); // NOI18N
        BtnGolonganBPKAD.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnGolonganBPKAD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGolonganBPKADActionPerformed(evt);
            }
        });
        BtnGolonganBPKAD.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnGolonganBPKADKeyPressed(evt);
            }
        });
        FormInput.add(BtnGolonganBPKAD);
        BtnGolonganBPKAD.setBounds(460, 310, 25, 23);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            if(Valid.editTabletf(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    ...
                    + "karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?,kode_satbesar=?,dasar=?,isi=?,kd_ObjectRsSub=?,ObjectRsSub=?", 28, new String[]{
                        ...
                        kdkategori.getText(),kdgolongan.getText(),kdsatBesar.getText(),dasar.getText(),Isi.getText(),kdBPKAD.getText(),nmBPKAD.getText(),
                ...
                tbObat.setValueAt(nmBPKAD.getText(),tbObat.getSelectedRow(),32);
                tbObat.setValueAt(kdBPKAD.getText(),tbObat.getSelectedRow(),33);
                emptTeks();
            }
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            Valid.textKosong(kdgolongan, "Golongan");
        } else if (kdBPKAD.getText().trim().equals("") || nmBPKAD.getText().trim().equals("")) {
            Valid.textKosong(kdBPKAD, "Golongan BPKAD");
        } else if (stok_minimal.getText().trim().equals("")) {
            Valid.textKosong(stok_minimal, "Stok Minimal");
        } else if (Valid.SetAngka(Kapasitas.getText().trim())<=0) {
            Valid.textKosong(Kapasitas, "Kapasitas");
            ...
            if(Sequel.menyimpantf("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 28, new String[]{
                    ...
                    KdIF.getText(),kdkategori.getText(),kdgolongan.getText(),nmBPKAD.getText(),kdBPKAD.getText()
                })==true){
                tabMode.addRow(new Object[]{
                    ...
                    tanggal,KdIF.getText(),NmIF.getText(),kdkategori.getText(),nmkategori.getText(),kdgolongan.getText(),nmgolongan.getText(),nmBPKAD.getText(),kdBPKAD.getText()
                });
                LCount.setText("" + tabMode.getRowCount());
                emptTeks();
            }
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void BtnGolonganBPKADActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGolonganBPKADActionPerformed
        // TODO add your handling code here:
        akses.setform("DlgBarang");
//        golonganBPKAD.isCek();
        golonganBPKAD.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        golonganBPKAD.setLocationRelativeTo(internalFrame1);
        golonganBPKAD.setAlwaysOnTop(false);
        golonganBPKAD.setVisible(true);
    }//GEN-LAST:event_BtnGolonganBPKADActionPerformed

    private void BtnGolonganBPKADKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnGolonganBPKADKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnGolonganBPKADKeyPressed
    ...
    private widget.Button BtnGolonganBPKAD;
    ...
    private widget.TextBox kdBPKAD;
    ...
    private widget.TextBox nmBPKAD;
            ...
            try {
                if(TCari.getText().trim().equals("")){
                    ps = koneksi.prepareStatement(
                            ...
                            + " databarang.karyawan,databarang.stokminimal, databarang.kdjns,"
                            + " jenis.nama,kapasitas,databarang.expire,databarang.kode_industri,industrifarmasi.nama_industri, "
                            + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,databarang.ObjectRsSub,databarang.kd_ObjectRsSub "
                            + " from databarang inner join kodesatuan on databarang.kode_sat=kodesatuan.kode_sat "
                            + " inner join kodesatuan as satuanbesar on databarang.kode_satbesar=satuanbesar.kode_sat "
                            + " inner join jenis on databarang.kdjns=jenis.kdjns "
                            + " inner join industrifarmasi on databarang.kode_industri=industrifarmasi.kode_industri "
...
//                        rs = ps.executeQuery();
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[]{
                            ...
                            rs.getString("ObjectRsSub"),
                            rs.getString("kd_ObjectRsSub")
                        });
                    }
                    LCount.setText("" + tabMode.getRowCount());
                } catch (Exception e) {
    ...
    public void tampil3() {
        ...
        try {
            ...
            if(TCari.getText().trim().equals("")){
//                CallableStatement sp = koneksi.prepareCall("{}");
                ps = koneksi.prepareStatement(
                        "select databarang.kode_brng, databarang.nama_brng,databarang.kode_satbesar,satuanbesar.satuan as satuanbesar, "
                        + " databarang.isi,databarang.kode_sat,kodesatuan.satuan,databarang.letak_barang,databarang.dasar,databarang.h_beli,"
                        + " databarang.ralan,databarang.kelas1,databarang.kelas2,databarang.kelas3,"
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            nmBPKAD.setText(tbObat.getValueAt(row, 32).toString());
            kdBPKAD.setText(tbObat.getValueAt(row, 33).toString());
