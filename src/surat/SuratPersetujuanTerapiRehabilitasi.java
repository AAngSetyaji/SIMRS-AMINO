 ...
 */
public final class SuratPersetujuanTerapiRehabilitasi extends javax.swing.JDialog {
    ...
    public SuratPersetujuanTerapiRehabilitasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            "Nama Penanggung Jawab","Umur P.J.","Nomor KTP P.J.","J.K. P.J.","Nomor Telp/HP","Bertindak Untuk","NIP","Nama Petugas"
            "No.Persetujuan","No.Rawat","No.R.M.","Nama Pasien","Umur","J.K.","Tgl.Lahir","Tanggal",
//            "Pengobatan Kepada","Nilai Kepercayaan","Yang Mengizinkan","Izin Menengok",
            "Nama Penanggung Jawab","Umur P.J.","Nomor KTP P.J.","J.K. P.J.","Nomor Telp/HP","Bertindak Untuk","NIP","Nama Petugas"
        }){
...
//            }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Persetujuan Rehabilitasi Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BertindakAtas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Suami", "Istri", "Anak", "Ayah", "Ibu", "Saudara", "Keponakan" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_persetujuan_terapi_rehabilitasi","?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",14,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataPersetujuanUmum.jasper","report","::[ Data Persetujuan Umum ]::",
                    "select surat_persetujuan_terapi_rehabilitasi.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_persetujuan_terapi_rehabilitasi.tanggal,surat_persetujuan_terapi_rehabilitasi.nama_pj,surat_persetujuan_terapi_rehabilitasi.umur_pj,surat_persetujuan_terapi_rehabilitasi.no_ktppj,"+
                    "surat_persetujuan_terapi_rehabilitasi.jkpj,surat_persetujuan_terapi_rehabilitasi.bertindak_atas,surat_persetujuan_terapi_rehabilitasi.no_telp,surat_persetujuan_terapi_rehabilitasi.nip,"+
                    "petugas.nama from surat_persetujuan_terapi_rehabilitasi inner join reg_periksa on surat_persetujuan_terapi_rehabilitasi.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_persetujuan_terapi_rehabilitasi.nip=petugas.nip where "+
                    "surat_persetujuan_terapi_rehabilitasi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by surat_persetujuan_terapi_rehabilitasi.tanggal",param);
            }else{
                Valid.MyReportqry("rptDataPersetujuanUmum.jasper","report","::[ Data Persetujuan Umum ]::",
                    "select surat_persetujuan_terapi_rehabilitasi.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_persetujuan_terapi_rehabilitasi.tanggal,surat_persetujuan_terapi_rehabilitasi.nama_pj,surat_persetujuan_terapi_rehabilitasi.umur_pj,surat_persetujuan_terapi_rehabilitasi.no_ktppj,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_persetujuan_terapi_rehabilitasi.nip=petugas.nip where "+
                    "surat_persetujuan_terapi_rehabilitasi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    ...
                    "surat_persetujuan_terapi_rehabilitasi.no_telp like '%"+TCari.getText().trim()+"%' or surat_persetujuan_terapi_rehabilitasi.nama_pj like '%"+TCari.getText().trim()+"%' or "+
                    "surat_persetujuan_terapi_rehabilitasi.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by surat_persetujuan_terapi_rehabilitasi.tanggal",param);
            }  
        }
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()>-1){
                ...
                Sequel.queryu("delete from surat_persetujuan_terapi_rehabilitasi_pembuat_pernyataan where no_surat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'");
            }else{
                JOptionPane.showMessageDialog(rootPane,"Silahkan anda pilih No.Pernyataan terlebih dahulu..!!");
            }Valid.panggilUrl("persetujuanterapirehabilitasi/index.php?act=Kamera");
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPersetujuanTerapiRehabilitasi dialog = new SuratPersetujuanTerapiRehabilitasi(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_persetujuan_terapi_rehabilitasi.nip=petugas.nip where "+
                    "surat_persetujuan_terapi_rehabilitasi.tanggal between ? and ? order by surat_persetujuan_terapi_rehabilitasi.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select surat_persetujuan_terapi_rehabilitasi.no_surat,reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,"+
                    "reg_periksa.sttsumur,pasien.jk,pasien.tgl_lahir,surat_persetujuan_terapi_rehabilitasi.tanggal,surat_persetujuan_terapi_rehabilitasi.nama_pj,surat_persetujuan_terapi_rehabilitasi.umur_pj,surat_persetujuan_terapi_rehabilitasi.no_ktppj,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on surat_persetujuan_terapi_rehabilitasi.nip=petugas.nip where "+
                    "surat_persetujuan_terapi_rehabilitasi.tanggal between ? and ? and "+
                    "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                    "surat_persetujuan_terapi_rehabilitasi.no_telp like ? or surat_persetujuan_terapi_rehabilitasi.nama_pj like ? or "+
                    "surat_persetujuan_terapi_rehabilitasi.nip like ? or petugas.nama like ?) "+
                    "order by surat_persetujuan_terapi_rehabilitasi.tanggal");
            }
...
//                        rs.getString("pengobatan_kepada"),rs.getString("nilai_kepercayaan"),rs.getString("orang_menengok"),rs.getString("izin_menengok"),
    ...
    public void emptTeks() {
        ...
        NoTelp.setText("");
        NoKTP.setText("");
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_persetujuan_terapi_rehabilitasi.no_surat,3),signed)),0) from surat_persetujuan_terapi_rehabilitasi where surat_persetujuan_terapi_rehabilitasi.tanggal='"+Valid.SetTgl(Tanggal.getSelectedItem()+"")+"' ",
    ...
    private void getData() {
         if(tbObat.getSelectedRow()!= -1){
            ...
            NamaPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString()); 
            UmurPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());  
            NoKTP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString()); 
            JKPJ.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString().replaceAll("L","Laki-laki").replaceAll("P","Perempuan")); 
            NoTelp.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString()); 
            BertindakAtas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());  
    ...
    private void ganti() {
        if(Sequel.mengedittf("surat_persetujuan_terapi_rehabilitasi","no_surat=?","no_surat=?,no_rawat=?,tanggal=?,nama_pj=?,umur_pj=?,no_ktppj=?,jkpj=?,bertindak_atas=?,no_telp=?,nip=?",11,new String[]{
            NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),NamaPJ.getText(),UmurPJ.getText(),NoKTP.getText(),
            JKPJ.getSelectedItem().toString().substring(0,1),BertindakAtas.getSelectedItem().toString(),NoTelp.getText(),NIP.getText(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from surat_persetujuan_terapi_rehabilitasi where no_surat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            try {
                ps=koneksi.prepareStatement("select surat_persetujuan_terapi_rehabilitasi_pembuat_pernyataan.photo from surat_persetujuan_terapi_rehabilitasi_pembuat_pernyataan where surat_persetujuan_terapi_rehabilitasi_pembuat_pernyataan.no_surat=?");
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("photo").equals("")||rs.getString("photo").equals("-")){
                            ...
                            LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/persetujuanterapirehabilitasi/"+rs.getString("photo")+"' alt='photo' width='500' height='500'/></center></body></html>");
                        }  
                    }else{
                        LoadHTML2.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
                    }
