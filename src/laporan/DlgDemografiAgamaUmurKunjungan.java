...
public class DlgDemografiAgamaUmurKunjungan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDemografiAgamaUmurKunjungan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Demografi Agama Umur Kunjungan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label22.setBounds(470, 10, 87, 20);
                        ...
                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi2'>"+
                                "<td valign='top' align='center'>"+
                                    ...
                                    "<font size='2' face='Tahoma'>DATA DEMOGRAFI AGAMA KUNJUNGAN<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                "</td>"+
                           "</tr>"+
                        "</table>")
            );
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDemografiAgamaUmurKunjungan dialog = new DlgDemografiAgamaUmurKunjungan(new javax.swing.JFrame(), true);
...
//            querytambahan=querydokter+querypoli+querycarabayar+querylokasi;
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='15%' rowspan='3'>Agama</td>"+
                ...
                ps=koneksi.prepareStatement("SELECT pasien.agama as nama FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
                          "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                          "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' GROUP BY pasien.agama");
                try {
                    rs=ps.executeQuery();
                    i=1;
                    ttlhr07l=0;ttlhr07p=0;ttlthk1l=0;ttlthk1p=0;ttlth14l=0;ttlth14p=0;ttlth59l=0;ttlth59p=0;ttlth1014l=0;ttlth1014p=0;
                    ...
                    while(rs.next()){
                        ...
                        hr07l=Sequel.cariInteger(
                             "select count(pasien.agama)as jumlah from reg_periksa "+
                             ...
                             "and pasien.agama='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by pasien.agama");
                        hr07p=Sequel.cariInteger(
                             ...
                             "and sttsumur='Hr' and umurdaftar between '0' and '7' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and pasien.agama='"+rs.getString("nama")+"' "+
                             "and pasien.jk='P' group by pasien.agama");
                        ...
                        registrasibaru=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and pasien.agama='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.stts_daftar='Baru' group by pasien.agama");
                        registrasilama=Sequel.cariInteger(
                             ...
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and pasien.agama='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.stts_daftar='Lama' group by pasien.agama");
                        polibaru=Sequel.cariInteger(
                             ...
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and pasien.agama='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.status_poli='Baru' group by pasien.agama");
                        polilama=Sequel.cariInteger(
                             ...
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and pasien.agama='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.status_poli='Lama' group by pasien.agama");
