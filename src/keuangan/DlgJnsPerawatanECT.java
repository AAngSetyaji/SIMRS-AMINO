 ...
 * @author dosen
 */
public final class DlgJnsPerawatanECT extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgJnsPerawatanECT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"P","Kode Paket","Nama","Kategori","Operator 1","Operator 2","Operator 3",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Paket Tindakan ECT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
//        Valid.pindah(evt,TKd,Kategori);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("paket_ect","'"+TKd.getText()+"', '"+TNm.getText()+"','ECT','"+TOperator1.getText()+
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbJnsPerawatan.getRowCount();i++){ 
            if(tbJnsPerawatan.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("paket_ect","kode_paket='"+tbJnsPerawatan.getValueAt(i,1).toString()+"'","status='0'");
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()!= -1){
                Sequel.mengedit("paket_ect","kode_paket='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1) +"'",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptPaketOperasi.jasper","report","::[ Data Paket Operasi ]::",
                   "select paket_ect.kode_paket, paket_ect.nm_perawatan,(paket_ect.operator1+paket_ect.operator2+paket_ect.operator3+"+
                       "paket_ect.asisten_operator1+paket_ect.asisten_operator2+paket_ect.asisten_operator3+paket_ect.instrumen+"+
                       "paket_ect.dokter_anak+paket_ect.perawaat_resusitas+"+
                       "paket_ect.alat+paket_ect.dokter_anestesi+paket_ect.asisten_anestesi+paket_ect.asisten_anestesi2+"+
                       "paket_ect.bidan+paket_ect.bidan2+paket_ect.bidan3+paket_ect.perawat_luar+"+
                       "paket_ect.sewa_ok+paket_ect.akomodasi+paket_ect.bagian_rs+"+
                       "paket_ect.omloop+paket_ect.omloop2+paket_ect.omloop3+paket_ect.omloop4+paket_ect.omloop5+"+
                       "paket_ect.sarpras+paket_ect.dokter_pjanak+paket_ect.dokter_umum) as jumlah "+
                   "from paket_ect inner join penjab on penjab.kd_pj=paket_ect.kd_pj "+
                   "where paket_ect.status='1' and paket_ect.kode_paket like '%"+TCari.getText()+"%' or "+
                   "paket_ect.status='1' and paket_ect.nm_perawatan like '%"+TCari.getText()+"%' or "+
                   "paket_ect.status='1' and paket_ect.kelas like '%"+TCari.getText()+"%' or "+
                   "paket_ect.status='1' and penjab.png_jawab like '%"+TCari.getText()+"%' order by paket_ect.kode_paket ",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanECT dialog = new DlgJnsPerawatanECT(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{    
            pstampil=koneksi.prepareStatement(
                       "select paket_ect.kode_paket, paket_ect.nm_perawatan,paket_ect.kategori,"+
                       "paket_ect.operator1, paket_ect.operator2, paket_ect.operator3, "+
                       "paket_ect.asisten_operator1, paket_ect.asisten_operator2,paket_ect.asisten_operator3,"+
                       "paket_ect.instrumen, paket_ect.dokter_anestesi,paket_ect.asisten_anestesi,paket_ect.asisten_anestesi2,"+
                       "paket_ect.dokter_anak,paket_ect.perawaat_resusitas, paket_ect.bidan, "+
                       "paket_ect.bidan2, paket_ect.bidan3, paket_ect.perawat_luar, paket_ect.alat,"+
                       "paket_ect.sewa_ok,paket_ect.akomodasi,paket_ect.bagian_rs,"+
                       "paket_ect.omloop,paket_ect.omloop2,paket_ect.omloop3,paket_ect.omloop4,paket_ect.omloop5,"+
                       "paket_ect.sarpras,paket_ect.dokter_pjanak,paket_ect.dokter_umum, "+
                       "(paket_ect.operator1+paket_ect.operator2+paket_ect.operator3+"+
                       "paket_ect.asisten_operator1+paket_ect.asisten_operator2+paket_ect.asisten_operator3+paket_ect.instrumen+"+
                       "paket_ect.dokter_anak+paket_ect.perawaat_resusitas+"+
                       "paket_ect.alat+paket_ect.dokter_anestesi+paket_ect.asisten_anestesi+paket_ect.asisten_anestesi2+"+
                       ...
                       "paket_ect.omloop+paket_ect.omloop2+paket_ect.omloop3+paket_ect.omloop4+paket_ect.omloop5+"+
                       "paket_ect.sarpras+paket_ect.dokter_pjanak+paket_ect.dokter_umum) as jumlah, "+
                       "penjab.png_jawab,paket_ect.kelas from paket_ect inner join penjab on penjab.kd_pj=paket_ect.kd_pj "+
                       "where paket_ect.status='1' and paket_ect.kode_paket like ? or "+
                       "paket_ect.status='1' and paket_ect.nm_perawatan like ? or "+
                       "paket_ect.status='1' and paket_ect.kelas like ? or "+
                       "paket_ect.status='1' and penjab.png_jawab like ? order by paket_ect.kode_paket ");
            try{
...
//        Kategori.setSelectedIndex(0);
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(kode_paket,5),signed)),0) from paket_ect  ","PK",6,TKd);
        TKd.requestFocus();
    }
...
//            Kategori.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
            ...
            Sequel.cariIsi("select kd_pj from paket_ect where kode_paket=?", kdpnj,tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1).toString());
