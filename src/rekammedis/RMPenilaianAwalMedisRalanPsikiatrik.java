...
//        Tatalaksana.setDocument(new batasInput((int)1000).getKata(Tatalaksana));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Jalan Psikiatri Dewasa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-08-2023 10:46:40" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_psikiatri_dewasa","?,?,?,?,?,?,?,?,?,?," +
"?,?,?,?,?,?,?,?,?,?," +
"?,?,?,?,?,?,?,?,?,?," +
"?,?,?,?,?,?,?,?,?,?," +
"?,?,?,?,?,?,?,?,?,?," +
...
"  penilaian_medis_ralan_psikiatri_dewasa.permasalahan, dokter.nm_dokter "+
                            ...
                            "inner join dokter on penilaian_medis_ralan_psikiatri_dewasa.kd_dokter=dokter.kd_dokter where "+
                            "penilaian_medis_ralan_psikiatri_dewasa.tanggal between ? and ? order by penilaian_medis_ralan_psikiatri_dewasa.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_psikiatri_dewasa.tanggal,"+
                            "  penilaian_medis_ralan_psikiatri_dewasa.kd_dokter," +
...
"  penilaian_medis_ralan_psikiatri_dewasa.permasalahan, dokter.nm_dokter "+
                            ...
                            "inner join penilaian_medis_ralan_psikiatri_dewasa on reg_periksa.no_rawat=penilaian_medis_ralan_psikiatri_dewasa.no_rawat "+
                            "inner join dokter on penilaian_medis_ralan_psikiatri_dewasa.kd_dokter=dokter.kd_dokter where "+
                            "penilaian_medis_ralan_psikiatri_dewasa.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "penilaian_medis_ralan_psikiatri_dewasa.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ralan_psikiatri_dewasa.tanggal");
                }
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,"
                                + "penilaian_medis_ralan_psikiatri_dewasa.tanggal," +
"  penilaian_medis_ralan_psikiatri_dewasa.kd_dokter," +
"  penilaian_medis_ralan_psikiatri_dewasa.anamnesis," +
"  penilaian_medis_ralan_psikiatri_dewasa.hubungan," +
"  penilaian_medis_ralan_psikiatri_dewasa.keluhan_utama," +
...
// 64            
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_medis_ralan_psikiatri_dewasa());
        BtnHapus.setEnabled(akses.getpenilaian_medis_ralan_psikiatri_dewasa());
        BtnEdit.setEnabled(akses.getpenilaian_medis_ralan_psikiatri_dewasa());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_psikiatri_dewasa where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_psikiatri_dewasa","no_rawat=?",
