...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Riwayat Penyakit Sekarang","Riwayat Penyakit Dahulu","Riwayat Penggunaan obat","Status Hamil","Gravida","Para","Abortus","HPHT","Tekanan Intrakranial","Pupil",
            "Neurosensorik/Muskuloskeletal","Integumen","Turgor Kulit","Edema","Mukosa Mulut","Perdarahan","Jml Perdarahan (cc)","Warna Perdarahan","Intoksikasi","Frekuensi BAB",
            "x/","Konsistensi BAB","Warna BAB","Frekuensi BAK","x/","Warna BAK","Lain-lain BAK","Kondisi Psikologis","Gangguan Jiwa Di Masa Lalu","Adakah Perilaku",
            "Dilaporkan Ke","Sebutkan","Hubungan Pasien Dengan Anggota Keluarga","Status Pernikahan","Tinggal Dengan","Ket. Tinggal Dengan","Pekerjaan","Pembayaran","Nilai-nilai Kebudayaan","Ket. Nilai-nilai Kebudayaan",
            "Pendidikan Pasien","Pendidikan PJ","Ket. Pendidikan PJ","Edukasi Diberikan Kepada","Ket. Edukasi Diberikan Kepada","Kemampuan Aktifitas Sehari-hari","Aktifitas","Alat bantu","Ket. Alat bantu","Berat Badan",
            "Tinggi Badan","Riwayat Kelahiran","Keterangan Riwayat Kelahiran","Riwayat Imunisasi","Keterangan Riwayat Imunisasi","Keterangan Riwayat Imunisasi1","Tingkat Nyeri","Provokes","Ket. Provokes","Kualitas",
            "Ket. Kualitas","Lokasi","Menyebar","Skala Nyeri","Durasi","Nyeri Hilang","Ket. Hilang Nyeri","Lapor Ke Dokter","Jam Lapor","Cara Berjalan A",
            "Cara Berjalan B","Cara Berjalan C","Hasil Penilaian Resiko Jatuh","Lapor Dokter","Ket. Lapor","Rencana","NIP","Nama Petugas"
        }){
    ...
    private void initComponents() {
        ...
        ket_riwayati1 = new widget.TextBox();
        jLabel73 = new widget.Label();
        spontan = new javax.swing.JRadioButton();
        tindakan = new javax.swing.JRadioButton();
        ket_riwayatk = new widget.TextBox();
        tb = new widget.TextBox();
        ket_riwayati = new widget.TextBox();
        lengkap = new javax.swing.JRadioButton();
        tdklengkap = new javax.swing.JRadioButton();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Keperawatan IGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel52.setText("V. RIWAYAT KESEHATAN ANAK ");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(10, 690, 380, 23);
        ...
        FormInput.add(Lapor);
        Lapor.setBounds(580, 1230, 80, 23);
        ...
        FormInput.add(BJM);
        BJM.setBounds(780, 1170, 80, 23);

        jLabel67.setText("Menyebar :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(700, 1030, 79, 23);
        ...
        FormInput.add(Hasil);
        Hasil.setBounds(80, 1230, 293, 23);

        jLabel68.setText("Hasil :");
        jLabel68.setName("jLabel68"); // NOI18N
        FormInput.add(jLabel68);
        jLabel68.setBounds(10, 1230, 72, 23);
        ...
        KetLapor.setBounds(780, 1230, 80, 23);
        ...
        jLabel70.setBounds(10, 1200, 571, 23);

        jLabel72.setText("a. Cara Berjalan :");
        jLabel72.setName("jLabel72"); // NOI18N
        FormInput.add(jLabel72);
        jLabel72.setBounds(10, 1150, 126, 23);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(380, 950, 130, 23);
        ...
        Provokes.setBounds(580, 950, 130, 23);
        ...
        KetProvokes.setBounds(720, 950, 146, 23);

        jLabel80.setText("Penyebab :");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(520, 950, 60, 23);
        ...
        Quality.setBounds(440, 980, 140, 23);
        ...
        KetQuality.setBounds(580, 980, 281, 23);

        jLabel81.setText("Kualitas :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(380, 980, 55, 23);

        jLabel82.setText("Wilayah :");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(380, 1010, 55, 23);
        ...
        Lokasi.setBounds(470, 1030, 220, 23);

        jLabel83.setText("Lokasi :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(400, 1030, 60, 23);
        ...
        Menyebar.setBounds(780, 1030, 80, 23);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("Menit");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(820, 1060, 35, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel85.setText("Skala Nyeri");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(440, 1060, 60, 23);
        ...
        SkalaNyeri.setBounds(500, 1060, 70, 23);

        jLabel86.setText("Diberitahukan pada dokter ?");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(490, 1100, 150, 23);
        ...
        Durasi.setBounds(730, 1060, 90, 23);

        jLabel87.setText("Waktu / Durasi :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(640, 1060, 90, 23);

        jLabel88.setText("Severity :");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(380, 1060, 55, 23);
        ...
        NyeriHilang.setBounds(140, 1100, 130, 23);
        ...
        KetNyeri.setBounds(280, 1100, 150, 23);

        jLabel89.setText("Nyeri hilang bila :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(10, 1100, 130, 23);
        ...
        PadaDokter.setBounds(640, 1100, 80, 23);
        ...
        KetDokter.setBounds(780, 1100, 80, 23);

        TglAsuhan.setForeground(new java.awt.Color(50, 70, 50));
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-11-2023 19:18:08" }));
        ...
        jLabel97.setBounds(390, 1230, 190, 23);

        jLabel63.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel63.setText("VII. PENILAIAN RESIKO JATUH (GET UP AND GO)");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(20, 1130, 380, 23);
        ...
        jSeparator6.setBounds(10, 1130, 880, 1);
        ...
        PanelWall.setBounds(50, 950, 320, 130);
        ...
        jSeparator9.setBounds(370, 950, 1, 140);

        jLabel71.setText("Jam dilaporkan :");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(690, 1230, 90, 23);
        ...
        jSeparator10.setBounds(10, 1260, 880, 1);
        ...
        Scroll8.setBounds(20, 1270, 400, 143);
        ...
        BtnTambahMasalah.setBounds(370, 1420, 28, 23);
        ...
        BtnAllMasalah.setBounds(340, 1420, 28, 23);
        ...
        BtnCariMasalah.setBounds(310, 1420, 28, 23);
        ...
        TCariMasalah.setBounds(90, 1420, 215, 23);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(20, 1420, 60, 23);
        ...
        TabRencanaKeperawatan.setBounds(440, 1270, 420, 143);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(450, 1420, 60, 23);
        ...
        TCariRencana.setBounds(510, 1420, 235, 23);
        ...
        BtnCariRencana.setBounds(750, 1420, 28, 23);
        ...
        BtnAllRencana.setBounds(780, 1420, 28, 23);
        ...
        BtnTambahRencana.setBounds(810, 1420, 28, 23);

        jLabel53.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel53.setText("VI. SKALA NYERI");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(20, 930, 380, 23);

        jLabel54.setText("Kg");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(180, 720, 20, 23);

        bb.setFocusTraversalPolicyProvider(true);
        bb.setName("bb"); // NOI18N
        FormInput.add(bb);
        bb.setBounds(130, 720, 50, 23);

        jLabel59.setText("1. BERAT BADAN :");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(20, 720, 100, 23);

        jLabel61.setText("Cm");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(180, 750, 20, 23);

        jLabel62.setText("4. Riwayat Imunisasi ");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(20, 830, 110, 23);

        jLabel69.setText("2. TINGGI BADAN :");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(20, 750, 100, 23);
        ...
        jSeparator13.setBounds(0, 920, 880, 1);

        ket_riwayati1.setFocusTraversalPolicyProvider(true);
        ket_riwayati1.setName("ket_riwayati1"); // NOI18N
        FormInput.add(ket_riwayati1);
        ket_riwayati1.setBounds(170, 890, 270, 23);

        jLabel73.setText("3. Riwayat Kelahiran ");
        jLabel73.setName("jLabel73"); // NOI18N
        FormInput.add(jLabel73);
        jLabel73.setBounds(20, 780, 110, 23);

        spontan.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(spontan);
        spontan.setForeground(new java.awt.Color(51, 51, 51));
        spontan.setText("Spontan");
        spontan.setName("spontan"); // NOI18N
        FormInput.add(spontan);
        spontan.setBounds(40, 800, 80, 30);

        tindakan.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(tindakan);
        tindakan.setForeground(new java.awt.Color(51, 51, 51));
        tindakan.setText("Tindakan, Sebutkan");
        tindakan.setName("tindakan"); // NOI18N
        FormInput.add(tindakan);
        tindakan.setBounds(120, 800, 150, 30);

        ket_riwayatk.setFocusTraversalPolicyProvider(true);
        ket_riwayatk.setName("ket_riwayatk"); // NOI18N
        ket_riwayatk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ket_riwayatkActionPerformed(evt);
            }
        });
        FormInput.add(ket_riwayatk);
        ket_riwayatk.setBounds(270, 800, 280, 30);

        tb.setFocusTraversalPolicyProvider(true);
        tb.setName("tb"); // NOI18N
        FormInput.add(tb);
        tb.setBounds(130, 750, 50, 23);

        ket_riwayati.setFocusTraversalPolicyProvider(true);
        ket_riwayati.setName("ket_riwayati"); // NOI18N
        FormInput.add(ket_riwayati);
        ket_riwayati.setBounds(170, 860, 270, 23);

        lengkap.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(lengkap);
        lengkap.setText("Lengkap");
        lengkap.setName("lengkap"); // NOI18N
        FormInput.add(lengkap);
        lengkap.setBounds(20, 860, 110, 20);

        tdklengkap.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(tdklengkap);
        tdklengkap.setText("Tidak Lengkap");
        tdklengkap.setName("tdklengkap"); // NOI18N
        FormInput.add(tdklengkap);
        tdklengkap.setBounds(20, 890, 140, 20);
    ...
    private void ket_riwayatkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ket_riwayatkActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ket_riwayatkActionPerformed
    ...
    */
    ...
    private widget.TextBox ket_riwayati;
    private widget.TextBox ket_riwayati1;
    private widget.TextBox ket_riwayatk;
    ...
    private javax.swing.JRadioButton spontan;
    ...
    private javax.swing.JRadioButton tdklengkap;
    private javax.swing.JRadioButton tindakan;
    ...
    private void ganti() {
        ...
        if(Sequel.mengedittf("penilaian_awal_keperawatan_igd","no_rawat=?","no_rawat=?,tanggal=?,keluhan_utama=?,rpd=?,rpo=?,status_kehamilan=?,gravida=?,"+
            ...
            riwayatk , ket_riwayatk.getText(),riwayati, ket_riwayati.getText(),ket_riwayati1.getText(),
