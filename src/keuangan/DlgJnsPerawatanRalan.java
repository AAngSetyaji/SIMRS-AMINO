...
public final class DlgJnsPerawatanRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbJnsPerawatan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
...
private void BtnPenjabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenjabActionPerformed
    ...
    */
    ...
    private void tampilSemua() {
        Valid.tabelKosong(tabMode);
        try{    
            ps=koneksi.prepareStatement("Select kd_jenis_prw, nm_perawatan, material, bhp, tarif_tindakandr, tarif_tindakanpr,"
                    + "kso,menejemen,total_byrdr,total_byrpr,total_byrdrpr, kd_kategori, kd_pj, kd_poli from jns_perawatan where status='1'");
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        false,rs.getString(1), //1 KD PRWT
                        rs.getString(2), //2 NM PRWT
                        rs.getString(12), //3 KAT
                        rs.getDouble(3), //4 JS RS
                        rs.getDouble(4), //5 BHP
                        rs.getDouble(5), //6 JS DR
                        rs.getDouble(6), //7 JS PR
                        rs.getDouble(7), //8 KSO
                        rs.getDouble(8), //9 MENEJEMEN
                        rs.getDouble(9), //10 TTl DR
                        rs.getDouble(10), //11 TTl PR
                        rs.getDouble(11), // 12 TTl DR PR
                        rs.getString(13), // 13 JNS BYR
                        rs.getString(14) // 14 Unit Poli
                    });
                }
            } catch (Exception e) {
                System.out.println(e);
