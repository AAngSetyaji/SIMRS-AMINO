...
public final class SuratPersetujuanUmum extends javax.swing.JDialog {
    ...
    public SuratPersetujuanUmum(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Persetujuan","No.Rawat","No.R.M.","Nama Pasien","J.K.","Tgl.Lahir","Tanggal","Pengobatan Kepada","Nilai Kepercayaan","Yang Mengizinkan","Izin Menengok",
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(420, 150, 160, 23);
        ...
        BertindakAtas.setBounds(580, 150, 150, 23);
        ...
        FormInput.add(NIP);
        NIP.setBounds(80, 70, 140, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        FormInput.add(NamaPetugas);
        NamaPetugas.setBounds(230, 70, 290, 23);
        ...
        jLabel44.setBounds(380, 150, 20, 23);
        ...
        UmurPJ.setBounds(330, 150, 40, 23);

        Tanggal.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-01-2024" }));
        ...
        jLabel45.setText("Umur PJ  :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(270, 150, 50, 23);
    ...
    private void MnCetakPersetujuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakPersetujuanActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCtkPersetujuanUmumBaru.jasper","report","::[ Persetujuan Umum ]::",
                    "SELECT reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,CASE WHEN pasien.jk = 'L' THEN 'LAKI-LAKI' ELSE 'PEREMPUAN' END AS jk,"+
                    ...
                    "pasien.no_tlp,penjab.png_jawab,surat_persetujuan_umum.no_surat,DATE_FORMAT(surat_persetujuan_umum.tanggal, '%d-%m-%Y') AS tanggal,"+
                    "surat_persetujuan_umum.nama_pj,surat_persetujuan_umum.umur_pj,surat_persetujuan_umum.no_ktppj,CASE WHEN surat_persetujuan_umum.jkpj = 'L' THEN 'LAKI-LAKI' ELSE 'PEREMPUAN' END AS jkpj,"+
                    "surat_persetujuan_umum.bertindak_atas,surat_persetujuan_umum.pengobatan_kepada,surat_persetujuan_umum.orang_menengok,surat_persetujuan_umum.izin_menengok,surat_persetujuan_umum.no_telp,"+
                    "surat_persetujuan_umum.nilai_kepercayaan,surat_persetujuan_umum_pembuat_pernyataan.photo,pegawai.nama "+
                    "FROM reg_periksa "+ 
                    "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "+
                    ...
                    "INNER JOIN pegawai ON surat_persetujuan_umum.nip = pegawai.nik "+
                     "where surat_persetujuan_umum.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),1).toString()+"'",param);
    ...
    */
    ...
    private void getData() {
         if(tbObat.getSelectedRow()!= -1){
            ...
            NamaPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString()); 
            UmurPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString().substring(0,2));  
            NoKTP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString()); 
            JKPJ.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString().replaceAll("L","Laki-laki").replaceAll("P","Perempuan")); 
            NoTelp.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString()); 
            BertindakAtas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString()); 
