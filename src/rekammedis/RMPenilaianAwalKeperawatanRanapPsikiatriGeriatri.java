 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Persepsi","Keterangan Persepsi","Isi Pikir","Waham","Keterangan Waham","Daya Tilik Diri","Keterangan Daya Tilik Diri",
            "Pola Komunikasi","Pola Asuh","Pola Asuh Lainnya","Pola Pengambilan Keputusan","Hubsos Pasien Orang Dekat","Hubsos Pasien Orang Dekat Lainnya","Peran Dalam Kelompok/Masyarakat","Hambatan Dalam Berhubungan","Gambaran Diri","Ideal Diri","Peran Diri","Identitas Diri","Identitas Diri Lainnya","Harga Diri","Nilai dan Keyakinan","Nilai dan Keyakinan Ada","Nilai dan Keyakinan Ya Lainnya","Kebutuhan Pelayanan","Kebutuhan Pelayanan Ya","Ekonomi atau Finansial",
        ...
        KetRPOPenggunaan.setDocument(new batasInput((int)500).getKata(KetRPOPenggunaan));
        KetRPOEfekSamping.setDocument(new batasInput((int)500).getKata(KetRPOEfekSamping));
        KetRPONapza.setDocument(new batasInput((int)500).getKata(KetRPONapza));
        ...
        KetLatarBelakangPemakaian.setDocument(new batasInput((int)500).getKata(KetLatarBelakangPemakaian));
        KetPenggunaanObatLainnya.setDocument(new batasInput((int)500).getKata(KetPenggunaanObatLainnya));
        KetAlergiObat.setDocument(new batasInput((int)1000).getKata(KetAlergiObat));
        ...
        KetKeluhanFisik.setDocument(new batasInput((int)1000).getKata(KetKeluhanFisik));
        ...
        RKDSakitSejak.setDocument(new batasInput((byte)20).getKata(RKDSakitSejak));
    ...
    private void initComponents() {
        ...
        pAyah = new javax.swing.JCheckBox();
        pOrangTua = new javax.swing.JCheckBox();
        pIbu = new javax.swing.JCheckBox();
        pNenek = new javax.swing.JCheckBox();
        jLabel168 = new widget.Label();
        pSaudara = new javax.swing.JCheckBox();
        jLabel169 = new widget.Label();
        pLainnya = new widget.TextBox();
        odBapak = new javax.swing.JCheckBox();
        odIbu = new javax.swing.JCheckBox();
        odAnak = new javax.swing.JCheckBox();
        odSaudara = new javax.swing.JCheckBox();
        odKawan = new javax.swing.JCheckBox();
        jLabel170 = new widget.Label();
        odLainnya = new widget.TextBox();
        jLabel171 = new widget.Label();
        jLabel172 = new widget.Label();
        PeranTidak = new javax.swing.JCheckBox();
        PeranMotivasi = new javax.swing.JCheckBox();
        PeranMandiri = new javax.swing.JCheckBox();
        jLabel173 = new widget.Label();
        Malas = new javax.swing.JCheckBox();
        TidakMampu = new javax.swing.JCheckBox();
        TakDilibatkan = new javax.swing.JCheckBox();
        Dikucilkan = new javax.swing.JCheckBox();
        BerhubunganSosial = new javax.swing.JCheckBox();
        jLabel174 = new widget.Label();
        jLabel175 = new widget.Label();
        GambaranDiri = new widget.ComboBox();
        jLabel176 = new widget.Label();
        IdealDiri = new widget.ComboBox();
        jLabel177 = new widget.Label();
        jLabel178 = new widget.Label();
        MampuBerperan = new javax.swing.JCheckBox();
        SenangKondisinya = new javax.swing.JCheckBox();
        jLabel179 = new widget.Label();
        idLainnya = new widget.TextBox();
        jLabel180 = new widget.Label();
        BicaraKesulitan = new javax.swing.JCheckBox();
        MengkritikDiri = new javax.swing.JCheckBox();
        KondisiMalu = new javax.swing.JCheckBox();
        Pasif = new javax.swing.JCheckBox();
        jLabel181 = new widget.Label();
        Pakaian = new javax.swing.JCheckBox();
        TidakPulang = new javax.swing.JCheckBox();
        MinumanMakanan = new javax.swing.JCheckBox();
        jLabel182 = new widget.Label();
        AdaLainnya = new widget.TextBox();
        jLabel183 = new widget.Label();
        TakMemilikiPenjamin = new javax.swing.JCheckBox();
        PasienTerlantar = new javax.swing.JCheckBox();
        PasienDinsos = new javax.swing.JCheckBox();
        TakMampuBayar = new javax.swing.JCheckBox();
        TakMampuAmbil = new javax.swing.JCheckBox();
        PasienSendiri = new javax.swing.JCheckBox();
        odTidak = new javax.swing.JCheckBox();
        KomunikasiSearah = new javax.swing.JRadioButton();
        Komunikasi2Arah = new javax.swing.JRadioButton();
        PasienTerlibat = new javax.swing.JRadioButton();
        PasienTakTerlibat = new javax.swing.JRadioButton();
        MauBekerja = new javax.swing.JRadioButton();
        TakMauBekerja = new javax.swing.JRadioButton();
        NilaiTidak = new javax.swing.JRadioButton();
        NilaiAda = new javax.swing.JRadioButton();
        jLabel184 = new widget.Label();
        KebutuhanTidak = new javax.swing.JRadioButton();
        KebutuhanYa = new javax.swing.JRadioButton();
        PasienKonseling = new javax.swing.JCheckBox();
        PasienBantuan = new javax.swing.JCheckBox();
        MampuBayar = new javax.swing.JCheckBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Keperawatan Rawat Inap Psikiatri Geriatri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 3100));
        ...
        KetKKPembelajaranLainnya.setBounds(570, 2750, 283, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-09-2023 10:02:36" }));
        ...
        jLabel56.setBounds(10, 2730, 230, 23);
        ...
        jLabel100.setText("I. RIWAYAT KESEHATAN PASIEN");
        ...
        RKDHasilPengobatan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Terkontrol", "Tidak Terkontrol" }));
        ...
        KKBahasaIsyarat.setBounds(770, 2780, 80, 23);
        ...
        jLabel139.setText("Pengasuh :");
        jLabel139.setName("jLabel139"); // NOI18N
        FormInput.add(jLabel139);
        jLabel139.setBounds(0, 1620, 120, 23);
        ...
        SKPersepsi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Halusinasi", "Pendengaran", "Penghidung", "Penglihatan", "Pengecapan", "Perabaan" }));
        ...
        SKIsiPikir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Sesuai", "Obsesi", "Fobia", "Hipokondria", "Depersonalisasi", "Pikiran Magis", "Ide Yang Terkait", "Waham" }));
        ...
        SKIsiPikir.setBounds(110, 1460, 130, 23);
        ...
        KKKebutuhanEdukasi.setBounds(370, 2810, 220, 23);
        ...
        SKMemori.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ganguan Daya Ingat Jangka Pendek", "Ganguan Daya Ingat Jangka Panjang", "Ganguan Daya Ingat Saat Ini", "Konfabulasi" }));
        ...
        jLabel151.setBounds(680, 2780, 90, 23);
        ...
        SKWaham.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Kebesaran", "Curiga", "Agama", "Nihilistik" }));
        ...
        jLabel153.setBounds(330, 2780, 55, 23);
        ...
        KetSKWaham.setBounds(410, 1460, 155, 23);
        ...
        KKPembelajaran.setBounds(250, 2750, 80, 23);

        jLabel158.setText("Dibutuhkan Penerjamah :");
        jLabel158.setName("jLabel158"); // NOI18N
        FormInput.add(jLabel158);
        jLabel158.setBounds(0, 2780, 247, 23);
        ...
        KKPenerjamah.setBounds(250, 2780, 80, 23);

        jLabel159.setText("Terdapat Hambatan Dalam Pembelajaran :");
        jLabel159.setName("jLabel159"); // NOI18N
        FormInput.add(jLabel159);
        jLabel159.setBounds(0, 2750, 247, 23);
        ...
        KetKKPembelajaran.setBounds(390, 2750, 120, 23);
        ...
        KetKKKebutuhanEdukasi.setBounds(650, 2810, 200, 23);

        jLabel160.setText("Lainnya :");
        jLabel160.setName("jLabel160"); // NOI18N
        FormInput.add(jLabel160);
        jLabel160.setBounds(590, 2810, 55, 23);
        ...
        jSeparator22.setBounds(0, 2730, 880, 1);
        ...
        jSeparator23.setBounds(0, 2840, 880, 1);
        ...
        KetKKPenerjamahLainnya.setBounds(390, 2780, 290, 23);

        jLabel161.setText("Jika, Ya :");
        jLabel161.setName("jLabel161"); // NOI18N
        FormInput.add(jLabel161);
        jLabel161.setBounds(330, 2750, 55, 23);
        ...
        Provokes.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Proses Penyakit", "Benturan", "Lain-lain" }));
        ...
        Quality.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Seperti Tertusuk", "Berdenyut", "Teriris", "Tertindih", "Tertiban", "Lain-lain" }));
        ...
        Scroll6.setBounds(10, 2850, 400, 143);
        ...
        TabRencanaKeperawatan.setBounds(430, 2850, 420, 143);
        ...
        BtnTambahRencana.setBounds(800, 3000, 28, 23);
        ...
        BtnAllRencana.setBounds(770, 3000, 28, 23);
        ...
        BtnCariRencana.setBounds(740, 3000, 28, 23);
        ...
        TCariRencana.setBounds(500, 3000, 235, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(440, 3000, 60, 23);
        ...
        BtnTambahMasalah.setBounds(360, 3000, 28, 23);
        ...
        BtnAllMasalah.setBounds(330, 3000, 28, 23);
        ...
        BtnCariMasalah.setBounds(300, 3000, 28, 23);
        ...
        TCariMasalah.setBounds(80, 3000, 215, 23);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(10, 3000, 60, 23);

        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("XII. PSIKOSOSIAL, EKONOMI, DAN SPIRITUAL (diisi perawat)");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(10, 1510, 300, 23);
        ...
        jSeparator24.setBounds(0, 1510, 880, 1);

        jLabel166.setText("Penampilan :");
        jLabel166.setName("jLabel166"); // NOI18N
        FormInput.add(jLabel166);
        jLabel166.setBounds(0, 1310, 103, 23);

        jLabel167.setText("Lainnya :");
        jLabel167.setName("jLabel167"); // NOI18N
        FormInput.add(jLabel167);
        jLabel167.setBounds(470, 1620, 80, 20);

        pAyah.setBackground(new java.awt.Color(255, 255, 255));
        pAyah.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        pAyah.setForeground(new java.awt.Color(51, 51, 51));
        pAyah.setText("Ayah");
        pAyah.setName("pAyah"); // NOI18N
        pAyah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pAyahActionPerformed(evt);
            }
        });
        FormInput.add(pAyah);
        pAyah.setBounds(210, 1620, 60, 19);

        pOrangTua.setBackground(new java.awt.Color(255, 255, 255));
        pOrangTua.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        pOrangTua.setForeground(new java.awt.Color(51, 51, 51));
        pOrangTua.setText("Orang Tua");
        pOrangTua.setName("pOrangTua"); // NOI18N
        pOrangTua.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pOrangTuaActionPerformed(evt);
            }
        });
        FormInput.add(pOrangTua);
        pOrangTua.setBounds(130, 1620, 80, 19);

        pIbu.setBackground(new java.awt.Color(255, 255, 255));
        pIbu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        pIbu.setForeground(new java.awt.Color(51, 51, 51));
        pIbu.setText("Ibu");
        pIbu.setName("pIbu"); // NOI18N
        pIbu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pIbuActionPerformed(evt);
            }
        });
        FormInput.add(pIbu);
        pIbu.setBounds(270, 1620, 50, 19);

        pNenek.setBackground(new java.awt.Color(255, 255, 255));
        pNenek.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        pNenek.setForeground(new java.awt.Color(51, 51, 51));
        pNenek.setText("Nenek");
        pNenek.setName("pNenek"); // NOI18N
        pNenek.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pNenekActionPerformed(evt);
            }
        });
        FormInput.add(pNenek);
        pNenek.setBounds(330, 1620, 70, 19);

        jLabel168.setText("1. Pola Komunikasi / Pola Asuh / Pola Pengambilan Keputusan :");
        jLabel168.setName("jLabel168"); // NOI18N
        FormInput.add(jLabel168);
        jLabel168.setBounds(0, 1530, 340, 23);

        pSaudara.setBackground(new java.awt.Color(255, 255, 255));
        pSaudara.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        pSaudara.setForeground(new java.awt.Color(51, 51, 51));
        pSaudara.setText("Saudara");
        pSaudara.setName("pSaudara"); // NOI18N
        pSaudara.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pSaudaraActionPerformed(evt);
            }
        });
        FormInput.add(pSaudara);
        pSaudara.setBounds(400, 1620, 70, 19);

        jLabel169.setText("a.Orang Dekat :");
        jLabel169.setName("jLabel169"); // NOI18N
        FormInput.add(jLabel169);
        jLabel169.setBounds(0, 1730, 130, 30);

        pLainnya.setFocusTraversalPolicyProvider(true);
        pLainnya.setName("pLainnya"); // NOI18N
        pLainnya.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                pLainnyaKeyPressed(evt);
            }
        });
        FormInput.add(pLainnya);
        pLainnya.setBounds(560, 1620, 155, 23);

        odBapak.setBackground(new java.awt.Color(255, 255, 255));
        odBapak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        odBapak.setForeground(new java.awt.Color(51, 51, 51));
        odBapak.setText("Bapak");
        odBapak.setName("odBapak"); // NOI18N
        odBapak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odBapakActionPerformed(evt);
            }
        });
        FormInput.add(odBapak);
        odBapak.setBounds(60, 1760, 80, 19);

        odIbu.setBackground(new java.awt.Color(255, 255, 255));
        odIbu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        odIbu.setForeground(new java.awt.Color(51, 51, 51));
        odIbu.setText("Ibu");
        odIbu.setName("odIbu"); // NOI18N
        odIbu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odIbuActionPerformed(evt);
            }
        });
        FormInput.add(odIbu);
        odIbu.setBounds(140, 1760, 60, 19);

        odAnak.setBackground(new java.awt.Color(255, 255, 255));
        odAnak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        odAnak.setForeground(new java.awt.Color(51, 51, 51));
        odAnak.setText("Anak");
        odAnak.setName("odAnak"); // NOI18N
        odAnak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odAnakActionPerformed(evt);
            }
        });
        FormInput.add(odAnak);
        odAnak.setBounds(200, 1760, 50, 19);

        odSaudara.setBackground(new java.awt.Color(255, 255, 255));
        odSaudara.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        odSaudara.setForeground(new java.awt.Color(51, 51, 51));
        odSaudara.setText("Saudara");
        odSaudara.setName("odSaudara"); // NOI18N
        odSaudara.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odSaudaraActionPerformed(evt);
            }
        });
        FormInput.add(odSaudara);
        odSaudara.setBounds(260, 1760, 70, 19);

        odKawan.setBackground(new java.awt.Color(255, 255, 255));
        odKawan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        odKawan.setForeground(new java.awt.Color(51, 51, 51));
        odKawan.setText("Kawan");
        odKawan.setName("odKawan"); // NOI18N
        odKawan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odKawanActionPerformed(evt);
            }
        });
        FormInput.add(odKawan);
        odKawan.setBounds(440, 1760, 70, 19);

        jLabel170.setText("Lainnya :");
        jLabel170.setName("jLabel170"); // NOI18N
        FormInput.add(jLabel170);
        jLabel170.setBounds(500, 1760, 80, 20);

        odLainnya.setFocusTraversalPolicyProvider(true);
        odLainnya.setName("odLainnya"); // NOI18N
        odLainnya.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                odLainnyaKeyPressed(evt);
            }
        });
        FormInput.add(odLainnya);
        odLainnya.setBounds(590, 1760, 155, 23);

        jLabel171.setText("2. Hubungan Sosial Pasien :");
        jLabel171.setName("jLabel171"); // NOI18N
        FormInput.add(jLabel171);
        jLabel171.setBounds(0, 1710, 170, 23);

        jLabel172.setText("b. Peran serta dalam kegiatan kelompok / masyarakat di rumah dan di RS :");
        jLabel172.setName("jLabel172"); // NOI18N
        FormInput.add(jLabel172);
        jLabel172.setBounds(0, 1780, 410, 30);

        PeranTidak.setBackground(new java.awt.Color(255, 255, 255));
        PeranTidak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PeranTidak.setForeground(new java.awt.Color(51, 51, 51));
        PeranTidak.setText("Tidak Ada");
        PeranTidak.setName("PeranTidak"); // NOI18N
        PeranTidak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PeranTidakActionPerformed(evt);
            }
        });
        FormInput.add(PeranTidak);
        PeranTidak.setBounds(60, 1810, 80, 19);

        PeranMotivasi.setBackground(new java.awt.Color(255, 255, 255));
        PeranMotivasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PeranMotivasi.setForeground(new java.awt.Color(51, 51, 51));
        PeranMotivasi.setText("Kegiatan Motivasi");
        PeranMotivasi.setName("PeranMotivasi"); // NOI18N
        PeranMotivasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PeranMotivasiActionPerformed(evt);
            }
        });
        FormInput.add(PeranMotivasi);
        PeranMotivasi.setBounds(140, 1810, 120, 19);

        PeranMandiri.setBackground(new java.awt.Color(255, 255, 255));
        PeranMandiri.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PeranMandiri.setForeground(new java.awt.Color(51, 51, 51));
        PeranMandiri.setText("Kegiatan Mandiri");
        PeranMandiri.setName("PeranMandiri"); // NOI18N
        PeranMandiri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PeranMandiriActionPerformed(evt);
            }
        });
        FormInput.add(PeranMandiri);
        PeranMandiri.setBounds(260, 1810, 120, 19);

        jLabel173.setText("c. Hambatan dalam berhubungan dengan orang lain :");
        jLabel173.setName("jLabel173"); // NOI18N
        FormInput.add(jLabel173);
        jLabel173.setBounds(0, 1830, 310, 30);

        Malas.setBackground(new java.awt.Color(255, 255, 255));
        Malas.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Malas.setForeground(new java.awt.Color(51, 51, 51));
        Malas.setText("Malas / Malu");
        Malas.setName("Malas"); // NOI18N
        Malas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MalasActionPerformed(evt);
            }
        });
        FormInput.add(Malas);
        Malas.setBounds(60, 1860, 90, 19);

        TidakMampu.setBackground(new java.awt.Color(255, 255, 255));
        TidakMampu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TidakMampu.setForeground(new java.awt.Color(51, 51, 51));
        TidakMampu.setText("Merasa Tidak Mampu");
        TidakMampu.setName("TidakMampu"); // NOI18N
        TidakMampu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TidakMampuActionPerformed(evt);
            }
        });
        FormInput.add(TidakMampu);
        TidakMampu.setBounds(150, 1860, 130, 19);

        TakDilibatkan.setBackground(new java.awt.Color(255, 255, 255));
        TakDilibatkan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TakDilibatkan.setForeground(new java.awt.Color(51, 51, 51));
        TakDilibatkan.setText("Tidak Dilibatkan");
        TakDilibatkan.setName("TakDilibatkan"); // NOI18N
        TakDilibatkan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TakDilibatkanActionPerformed(evt);
            }
        });
        FormInput.add(TakDilibatkan);
        TakDilibatkan.setBounds(290, 1860, 110, 19);

        Dikucilkan.setBackground(new java.awt.Color(255, 255, 255));
        Dikucilkan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Dikucilkan.setForeground(new java.awt.Color(51, 51, 51));
        Dikucilkan.setText("Dikucilkan");
        Dikucilkan.setName("Dikucilkan"); // NOI18N
        Dikucilkan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DikucilkanActionPerformed(evt);
            }
        });
        FormInput.add(Dikucilkan);
        Dikucilkan.setBounds(60, 1890, 90, 19);

        BerhubunganSosial.setBackground(new java.awt.Color(255, 255, 255));
        BerhubunganSosial.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BerhubunganSosial.setForeground(new java.awt.Color(51, 51, 51));
        BerhubunganSosial.setText("Mampu berhubungan sosial dengan baik");
        BerhubunganSosial.setName("BerhubunganSosial"); // NOI18N
        BerhubunganSosial.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BerhubunganSosialActionPerformed(evt);
            }
        });
        FormInput.add(BerhubunganSosial);
        BerhubunganSosial.setBounds(150, 1890, 220, 19);
        ...
        jLabel174.setBounds(10, 1930, 430, 20);

        jLabel175.setText("Gambaran diri :");
        jLabel175.setName("jLabel175"); // NOI18N
        FormInput.add(jLabel175);
        jLabel175.setBounds(0, 1950, 130, 30);

        GambaranDiri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Senang dengan kondisi tubuhnya", "Merasa kurang dengan tubuhnya", "Menutupi bagian tubuhnya", "Dapat menerima kondisi sekarang" }));
        GambaranDiri.setName("GambaranDiri"); // NOI18N
        GambaranDiri.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                GambaranDiriKeyPressed(evt);
            }
        });
        FormInput.add(GambaranDiri);
        GambaranDiri.setBounds(140, 1960, 200, 23);

        jLabel176.setText("Lainnya :");
        jLabel176.setName("jLabel176"); // NOI18N
        FormInput.add(jLabel176);
        jLabel176.setBounds(80, 2110, 110, 20);

        IdealDiri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ada keinginan untuk sembuh dari sakitnya", "Merasa tidak ada keinginan untuk sembuh dari penyakitnya", "Ada keinginan untuk melakukan aktifitas setelah sembuh dari sakitnya" }));
        IdealDiri.setName("IdealDiri"); // NOI18N
        IdealDiri.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IdealDiriKeyPressed(evt);
            }
        });
        FormInput.add(IdealDiri);
        IdealDiri.setBounds(140, 1990, 350, 23);

        jLabel177.setText("Ideal Diri :");
        jLabel177.setName("jLabel177"); // NOI18N
        FormInput.add(jLabel177);
        jLabel177.setBounds(0, 1980, 130, 30);

        jLabel178.setText("Peran Diri :");
        jLabel178.setName("jLabel178"); // NOI18N
        FormInput.add(jLabel178);
        jLabel178.setBounds(0, 2010, 130, 30);

        MampuBerperan.setBackground(new java.awt.Color(255, 255, 255));
        MampuBerperan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MampuBerperan.setForeground(new java.awt.Color(51, 51, 51));
        MampuBerperan.setText("Mampu berperan sesuai identitas dirinya");
        MampuBerperan.setName("MampuBerperan"); // NOI18N
        MampuBerperan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MampuBerperanActionPerformed(evt);
            }
        });
        FormInput.add(MampuBerperan);
        MampuBerperan.setBounds(140, 2080, 230, 19);

        SenangKondisinya.setBackground(new java.awt.Color(255, 255, 255));
        SenangKondisinya.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        SenangKondisinya.setForeground(new java.awt.Color(51, 51, 51));
        SenangKondisinya.setText("Senang dengan kondisi sebagai laki - laki / perempuan");
        SenangKondisinya.setName("SenangKondisinya"); // NOI18N
        SenangKondisinya.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SenangKondisinyaActionPerformed(evt);
            }
        });
        FormInput.add(SenangKondisinya);
        SenangKondisinya.setBounds(140, 2050, 290, 19);

        jLabel179.setText("Harga Diri :");
        jLabel179.setName("jLabel179"); // NOI18N
        FormInput.add(jLabel179);
        jLabel179.setBounds(0, 2130, 130, 30);

        idLainnya.setFocusTraversalPolicyProvider(true);
        ...
        idLainnya.setBounds(200, 2110, 155, 23);

        jLabel180.setText("Identitas Diri :");
        jLabel180.setName("jLabel180"); // NOI18N
        FormInput.add(jLabel180);
        jLabel180.setBounds(0, 2040, 130, 30);

        BicaraKesulitan.setBackground(new java.awt.Color(255, 255, 255));
        BicaraKesulitan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BicaraKesulitan.setForeground(new java.awt.Color(51, 51, 51));
        BicaraKesulitan.setText("Selalu bicara kesulitan yang dihadapi");
        BicaraKesulitan.setName("BicaraKesulitan"); // NOI18N
        BicaraKesulitan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BicaraKesulitanActionPerformed(evt);
            }
        });
        FormInput.add(BicaraKesulitan);
        BicaraKesulitan.setBounds(140, 2170, 210, 19);

        MengkritikDiri.setBackground(new java.awt.Color(255, 255, 255));
        MengkritikDiri.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MengkritikDiri.setForeground(new java.awt.Color(51, 51, 51));
        MengkritikDiri.setText("Mengkritik diri sendiri");
        MengkritikDiri.setName("MengkritikDiri"); // NOI18N
        MengkritikDiri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MengkritikDiriActionPerformed(evt);
            }
        });
        FormInput.add(MengkritikDiri);
        MengkritikDiri.setBounds(140, 2140, 150, 19);

        KondisiMalu.setBackground(new java.awt.Color(255, 255, 255));
        KondisiMalu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        KondisiMalu.setForeground(new java.awt.Color(51, 51, 51));
        KondisiMalu.setText("Malu, minder dengan kondisi sekarang");
        KondisiMalu.setName("KondisiMalu"); // NOI18N
        KondisiMalu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KondisiMaluActionPerformed(evt);
            }
        });
        FormInput.add(KondisiMalu);
        KondisiMalu.setBounds(360, 2140, 210, 19);

        Pasif.setBackground(new java.awt.Color(255, 255, 255));
        Pasif.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Pasif.setForeground(new java.awt.Color(51, 51, 51));
        Pasif.setText("Pasif dan hipoaktif");
        Pasif.setName("Pasif"); // NOI18N
        ...
        FormInput.add(Pasif);
        Pasif.setBounds(360, 2170, 220, 19);

        jLabel181.setText("5. Ekonomi atau Finansial :");
        jLabel181.setName("jLabel181"); // NOI18N
        FormInput.add(jLabel181);
        jLabel181.setBounds(0, 2510, 170, 20);

        Pakaian.setBackground(new java.awt.Color(255, 255, 255));
        Pakaian.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Pakaian.setForeground(new java.awt.Color(51, 51, 51));
        Pakaian.setText("Pakaian yang diyakini pasien selama dirawat");
        ...
        Pakaian.setBounds(130, 2320, 250, 19);

        TidakPulang.setBackground(new java.awt.Color(255, 255, 255));
        TidakPulang.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TidakPulang.setForeground(new java.awt.Color(51, 51, 51));
        TidakPulang.setText("Tidak Pulang di hari Sabtu / Selasa");
        TidakPulang.setName("TidakPulang"); // NOI18N
        TidakPulang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TidakPulangActionPerformed(evt);
            }
        });
        FormInput.add(TidakPulang);
        TidakPulang.setBounds(130, 2260, 200, 19);

        MinumanMakanan.setBackground(new java.awt.Color(255, 255, 255));
        MinumanMakanan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MinumanMakanan.setForeground(new java.awt.Color(51, 51, 51));
        MinumanMakanan.setText("Minuman / makanan tertentu yang diberikan ke pasien");
        MinumanMakanan.setName("MinumanMakanan"); // NOI18N
        MinumanMakanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MinumanMakananActionPerformed(evt);
            }
        });
        FormInput.add(MinumanMakanan);
        MinumanMakanan.setBounds(130, 2290, 300, 19);

        jLabel182.setText("Lainnya :");
        jLabel182.setName("jLabel182"); // NOI18N
        FormInput.add(jLabel182);
        jLabel182.setBounds(70, 2350, 110, 20);

        AdaLainnya.setFocusTraversalPolicyProvider(true);
        AdaLainnya.setName("AdaLainnya"); // NOI18N
        AdaLainnya.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AdaLainnyaKeyPressed(evt);
            }
        });
        FormInput.add(AdaLainnya);
        AdaLainnya.setBounds(190, 2350, 155, 23);

        jLabel183.setText("Kebutuhan pelayanan kerohanian");
        jLabel183.setName("jLabel183"); // NOI18N
        FormInput.add(jLabel183);
        jLabel183.setBounds(10, 2380, 200, 20);

        TakMemilikiPenjamin.setBackground(new java.awt.Color(255, 255, 255));
        TakMemilikiPenjamin.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TakMemilikiPenjamin.setForeground(new java.awt.Color(51, 51, 51));
        TakMemilikiPenjamin.setText("Tidak memiliki penjamin kesehatan");
        TakMemilikiPenjamin.setName("TakMemilikiPenjamin"); // NOI18N
        TakMemilikiPenjamin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TakMemilikiPenjaminActionPerformed(evt);
            }
        });
        FormInput.add(TakMemilikiPenjamin);
        TakMemilikiPenjamin.setBounds(60, 2540, 200, 19);

        PasienTerlantar.setBackground(new java.awt.Color(255, 255, 255));
        PasienTerlantar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienTerlantar.setForeground(new java.awt.Color(51, 51, 51));
        PasienTerlantar.setText("Pasien Terlantar");
        PasienTerlantar.setName("PasienTerlantar"); // NOI18N
        PasienTerlantar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PasienTerlantarActionPerformed(evt);
            }
        });
        FormInput.add(PasienTerlantar);
        PasienTerlantar.setBounds(60, 2570, 290, 19);

        PasienDinsos.setBackground(new java.awt.Color(255, 255, 255));
        PasienDinsos.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienDinsos.setForeground(new java.awt.Color(51, 51, 51));
        PasienDinsos.setText("Pasien dari Dinas Sosial");
        PasienDinsos.setName("PasienDinsos"); // NOI18N
        PasienDinsos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PasienDinsosActionPerformed(evt);
            }
        });
        FormInput.add(PasienDinsos);
        PasienDinsos.setBounds(60, 2600, 230, 19);

        TakMampuBayar.setBackground(new java.awt.Color(255, 255, 255));
        TakMampuBayar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TakMampuBayar.setForeground(new java.awt.Color(51, 51, 51));
        TakMampuBayar.setText("Tidak mampu bayar biaya perawatan");
        TakMampuBayar.setName("TakMampuBayar"); // NOI18N
        TakMampuBayar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TakMampuBayarActionPerformed(evt);
            }
        });
        FormInput.add(TakMampuBayar);
        TakMampuBayar.setBounds(350, 2540, 220, 19);

        TakMampuAmbil.setBackground(new java.awt.Color(255, 255, 255));
        TakMampuAmbil.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TakMampuAmbil.setForeground(new java.awt.Color(51, 51, 51));
        TakMampuAmbil.setText("Tidak mampu mengambil pasien dari RSJ");
        TakMampuAmbil.setName("TakMampuAmbil"); // NOI18N
        TakMampuAmbil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TakMampuAmbilActionPerformed(evt);
            }
        });
        FormInput.add(TakMampuAmbil);
        TakMampuAmbil.setBounds(350, 2570, 230, 19);

        PasienSendiri.setBackground(new java.awt.Color(255, 255, 255));
        PasienSendiri.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienSendiri.setForeground(new java.awt.Color(51, 51, 51));
        PasienSendiri.setText("Pasien tinggal sendiri");
        PasienSendiri.setName("PasienSendiri"); // NOI18N
        PasienSendiri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PasienSendiriActionPerformed(evt);
            }
        });
        FormInput.add(PasienSendiri);
        PasienSendiri.setBounds(60, 2630, 210, 19);

        odTidak.setBackground(new java.awt.Color(255, 255, 255));
        odTidak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        odTidak.setForeground(new java.awt.Color(51, 51, 51));
        odTidak.setText("Tidak Ada");
        odTidak.setName("odTidak"); // NOI18N
        odTidak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                odTidakActionPerformed(evt);
            }
        });
        FormInput.add(odTidak);
        odTidak.setBounds(340, 1760, 90, 19);

        KomunikasiSearah.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(KomunikasiSearah);
        KomunikasiSearah.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        KomunikasiSearah.setForeground(new java.awt.Color(51, 51, 51));
        KomunikasiSearah.setText("Komunikasi searah ( orang tua / salah satu anggota keluarga yang dominan )");
        KomunikasiSearah.setName("KomunikasiSearah"); // NOI18N
        FormInput.add(KomunikasiSearah);
        KomunikasiSearah.setBounds(60, 1560, 428, 20);

        Komunikasi2Arah.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup1.add(Komunikasi2Arah);
        Komunikasi2Arah.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Komunikasi2Arah.setForeground(new java.awt.Color(51, 51, 51));
        Komunikasi2Arah.setText("Komunikasi dua arah ( saling komunikasi dalam menyelesaikan masalah )");
        Komunikasi2Arah.setName("Komunikasi2Arah"); // NOI18N
        Komunikasi2Arah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Komunikasi2ArahActionPerformed(evt);
            }
        });
        FormInput.add(Komunikasi2Arah);
        Komunikasi2Arah.setBounds(60, 1590, 430, 20);

        PasienTerlibat.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(PasienTerlibat);
        PasienTerlibat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienTerlibat.setForeground(new java.awt.Color(51, 51, 51));
        PasienTerlibat.setText("Pasien dilibatkan dalam pengambilan keputusan dalam keluarga");
        PasienTerlibat.setName("PasienTerlibat"); // NOI18N
        PasienTerlibat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PasienTerlibatActionPerformed(evt);
            }
        });
        FormInput.add(PasienTerlibat);
        PasienTerlibat.setBounds(60, 1650, 360, 19);

        PasienTakTerlibat.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(PasienTakTerlibat);
        PasienTakTerlibat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienTakTerlibat.setForeground(new java.awt.Color(51, 51, 51));
        PasienTakTerlibat.setText("Pasien tidak terlibat dalam keputusan dalam keluarga");
        PasienTakTerlibat.setName("PasienTakTerlibat"); // NOI18N
        FormInput.add(PasienTakTerlibat);
        PasienTakTerlibat.setBounds(60, 1680, 360, 19);

        MauBekerja.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup3.add(MauBekerja);
        MauBekerja.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MauBekerja.setForeground(new java.awt.Color(51, 51, 51));
        MauBekerja.setText("Mau bekerja/sekolah lagi");
        MauBekerja.setName("MauBekerja"); // NOI18N
        FormInput.add(MauBekerja);
        MauBekerja.setBounds(140, 2020, 160, 19);

        TakMauBekerja.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup3.add(TakMauBekerja);
        TakMauBekerja.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        TakMauBekerja.setForeground(new java.awt.Color(51, 51, 51));
        TakMauBekerja.setText("Tidak mau bekerja/sekolah lagi");
        TakMauBekerja.setName("TakMauBekerja"); // NOI18N
        TakMauBekerja.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TakMauBekerjaActionPerformed(evt);
            }
        });
        FormInput.add(TakMauBekerja);
        TakMauBekerja.setBounds(320, 2020, 180, 19);

        NilaiTidak.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup4.add(NilaiTidak);
        NilaiTidak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        NilaiTidak.setForeground(new java.awt.Color(51, 51, 51));
        NilaiTidak.setText("Tidak Ada");
        NilaiTidak.setName("NilaiTidak"); // NOI18N
        FormInput.add(NilaiTidak);
        NilaiTidak.setBounds(50, 2230, 110, 19);

        NilaiAda.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup4.add(NilaiAda);
        NilaiAda.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        NilaiAda.setForeground(new java.awt.Color(51, 51, 51));
        NilaiAda.setText("Ada,");
        NilaiAda.setName("NilaiAda"); // NOI18N
        FormInput.add(NilaiAda);
        NilaiAda.setBounds(50, 2250, 50, 30);

        jLabel184.setText("4. Nilai dan Keyakinan ( persepsi tentang penyakit dan Kebutuhan Kerohanian ) :");
        jLabel184.setName("jLabel184"); // NOI18N
        FormInput.add(jLabel184);
        jLabel184.setBounds(0, 2200, 420, 20);

        KebutuhanTidak.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup5.add(KebutuhanTidak);
        KebutuhanTidak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        KebutuhanTidak.setForeground(new java.awt.Color(51, 51, 51));
        KebutuhanTidak.setText("Tidak");
        KebutuhanTidak.setName("KebutuhanTidak"); // NOI18N
        FormInput.add(KebutuhanTidak);
        KebutuhanTidak.setBounds(60, 2410, 70, 19);

        KebutuhanYa.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup5.add(KebutuhanYa);
        KebutuhanYa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        KebutuhanYa.setForeground(new java.awt.Color(51, 51, 51));
        KebutuhanYa.setText("Ya, ( jelaskan ) :");
        KebutuhanYa.setName("KebutuhanYa"); // NOI18N
        FormInput.add(KebutuhanYa);
        KebutuhanYa.setBounds(60, 2440, 120, 20);

        PasienKonseling.setBackground(new java.awt.Color(255, 255, 255));
        PasienKonseling.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienKonseling.setForeground(new java.awt.Color(51, 51, 51));
        PasienKonseling.setText("Pasien membutuhkan konseling spiritual / agama");
        PasienKonseling.setName("PasienKonseling"); // NOI18N
        PasienKonseling.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PasienKonselingActionPerformed(evt);
            }
        });
        FormInput.add(PasienKonseling);
        PasienKonseling.setBounds(180, 2440, 280, 19);

        PasienBantuan.setBackground(new java.awt.Color(255, 255, 255));
        PasienBantuan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        PasienBantuan.setForeground(new java.awt.Color(51, 51, 51));
        PasienBantuan.setText("Pasien membutuhkan bantuan saat menjalankan ibadah");
        PasienBantuan.setName("PasienBantuan"); // NOI18N
        PasienBantuan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PasienBantuanActionPerformed(evt);
            }
        });
        FormInput.add(PasienBantuan);
        PasienBantuan.setBounds(180, 2470, 300, 19);

        MampuBayar.setBackground(new java.awt.Color(255, 255, 255));
        MampuBayar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MampuBayar.setForeground(new java.awt.Color(51, 51, 51));
        MampuBayar.setText("Memiliki penjamin kesehatan / mampu bayar");
        MampuBayar.setName("MampuBayar"); // NOI18N
        MampuBayar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MampuBayarActionPerformed(evt);
            }
        });
        FormInput.add(MampuBayar);
        MampuBayar.setBounds(350, 2600, 260, 19);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        String identitas = "";
        String hargadiri = "";
        String nilaikeyakinan = "";
        String nilaikeyakinan_ya = "";
        String pelayanan = "";
        String pelayanan_ya = "";
        String ekonomi = ""; 
        
        if(KomunikasiSearah.isSelected()){
            komunikasi = "Komunikasi searah ( orang tua / salah satu anggota keluarga yang dominan )";
        } else if (Komunikasi2Arah.isSelected()){
            komunikasi = "Komunikasi dua arah ( saling komunikasi dalam menyelesaikan masalah )";
        } 
        
        
//        Pengasuh
        if (pOrangTua.isSelected()) {
            pengasuh += "Orang Tua, ";
        }
        if (pAyah.isSelected()) {
            pengasuh += "Ayah, ";
        ...
        if (pNenek.isSelected()) {
            pengasuh += "Nenek, ";
        }
        if (pSaudara.isSelected()) {
            pengasuh += "Saudara, ";
        }
        pengasuh = pengasuh.trim();
        if (pengasuh.endsWith(", ")) {
            pengasuh = pengasuh.substring(0, pengasuh.length() - 2);
        }
        
//        Pola Keterlibatan
        if (PasienTerlibat.isSelected()){
            polaketerlibatan = "Pasien dilibatkan dalam pengambilan keputusan dalam keluarga";
        } else if (PasienTakTerlibat.isSelected()){
            polaketerlibatan = "Pasien tidak terlibat dalam keputusan dalam keluarga";
        }
            
            
//        Hubsos Orang Dekat
        if (odBapak.isSelected()) {
            orangdekat += "Bapak, ";
        }
        if (odIbu.isSelected()) {
            orangdekat += "Ibu, ";
        }
        if (odAnak.isSelected()) {
            orangdekat += "Anak, ";
        }
        if (odSaudara.isSelected()) {
            orangdekat += "Saudara,";
        }
        if (odTidak.isSelected()) {
            orangdekat += "Tidak Ada, ";
        }
        if (odKawan.isSelected()) {
            orangdekat += "Kawan, ";
        }
        orangdekat = orangdekat.trim();
        if (orangdekat.endsWith(", ")) {
            orangdekat = orangdekat.substring(0, orangdekat.length() - 2);
        }
        
//        Hubsos Peran Serta
        if (PeranTidak.isSelected()) {
            peranserta += "Tidak Ada, ";
        }
        if (PeranMotivasi.isSelected()) {
            peranserta += "Kegiatan Motivasi, ";
        }
        if (PeranMandiri.isSelected()) {
            peranserta += "Kegiatan Mandiri, ";
        }
        peranserta = peranserta.trim();
        if (peranserta.endsWith(", ")) {
            peranserta = peranserta.substring(0, peranserta.length() - 2);
        }
...
//        Hubsos Hambatan
        ...
        if (TidakMampu.isSelected()) {
            hambatan += "Merasa Tidak Mampu, ";
        }
        if (TakDilibatkan.isSelected()) {
            hambatan += "Tidak Dilibatkan, ";
        }
        if (Dikucilkan.isSelected()) {
            hambatan += "Dikucilkan, ";
        }
        if (BerhubunganSosial.isSelected()) {
            hambatan += "Mampu berhubungan sosial dengan baik, ";
        }
        hambatan = hambatan.trim();
        if (hambatan.endsWith(", ")) {
            hambatan = hambatan.substring(0, hambatan.length() - 2);
        }
        
//        Peran Diri
        if(MauBekerja.isSelected()){
            perandiri = "Mau bekerja/sekolah lagi";
        } else if (TakMauBekerja.isSelected()){
            perandiri = "Tidak mau bekerja/sekolah lagi";
        } 
        
//        Identitas Diri
        if (SenangKondisinya.isSelected()) {
            identitas += "Senang dengan kondisi sebagai laki - laki / perempuan, ";
        }
        if (MampuBerperan.isSelected()) {
            identitas += "Mampu berperan sesuai identitas dirinya, ";
        }
        identitas = identitas.trim();
        if (identitas.endsWith(", ")) {
            identitas = identitas.substring(0, identitas.length() - 2);
        }
        
//        Harga Diri
        if (MengkritikDiri.isSelected()) {
            hargadiri += "Mengkritik diri sendiri, ";
        }
        if (BicaraKesulitan.isSelected()) {
            hargadiri += "Selalu bicara kesulitan yang dihadapi, ";
        }
        if (KondisiMalu.isSelected()) {
            hargadiri += "Malu/minder dengan kondisi sekarang, ";
        }
        if (Pasif.isSelected()) {
            hargadiri += "Pasif dan hipoaktif, ";
        }
        hargadiri = hargadiri.trim();
        if (hargadiri.endsWith(", ")) {
            hargadiri = hargadiri.substring(0, hargadiri.length() - 2);
        }
        
//        Nilai Keyakinan
        if (NilaiTidak.isSelected()) {
            nilaikeyakinan = "Tidak";
        } else if (NilaiAda.isSelected()) {
            nilaikeyakinan = "Ada";
        }
        
//        Nilai Keyakinan Ya
        if (TidakPulang.isSelected()) {
            nilaikeyakinan_ya += "Tidak Pulang di hari Sabtu / Selasa, ";
        } if (MinumanMakanan.isSelected()) {
            nilaikeyakinan_ya += "Minuman / makanan tertentu yang diberikan ke pasien, ";
        } if (Pakaian.isSelected()) {
            nilaikeyakinan_ya += "Pakaian yang diyakini pasien selama dirawat, ";
        }
        nilaikeyakinan = nilaikeyakinan.trim();
        if (nilaikeyakinan_ya.endsWith(", ")) {
            nilaikeyakinan_ya = nilaikeyakinan_ya.substring(0, nilaikeyakinan_ya.length() - 2);
        }
        
        //        Nilai Keyakinan
        if (KebutuhanTidak.isSelected()) {
            pelayanan = "Tidak";
        } else if (KebutuhanYa.isSelected()) {
            pelayanan = "Ya";
        }
        
        if (PasienKonseling.isSelected()) {
            pelayanan_ya += "Pasien membutuhkan konseling spiritual / agama, ";
        }
        if (PasienBantuan.isSelected()) {
            pelayanan_ya += "Pasien membutuhkan bantuan saat menjalankan ibadah, ";
        }
        pelayanan_ya = pelayanan_ya.trim();  
        if (pelayanan_ya.endsWith(", ")) {
            pelayanan_ya = pelayanan_ya.substring(0, pelayanan_ya.length() - 2);
        }
        
//        Ekonomi Finansial
        if (TakMemilikiPenjamin.isSelected()) {
            ekonomi += "Tidak memiliki penjamin kesehatan, ";
        }
        if (PasienTerlantar.isSelected()) {
            ekonomi += "Pasien Terlantar, ";
        }
        if (PasienDinsos.isSelected()) {
            ekonomi += "Pasien dari Dinas Sosial, ";
        }
        if (PasienSendiri.isSelected()) {
            ekonomi += "Pasien tinggal sendiri, ";
        }
        if (TakMampuBayar.isSelected()) {
            ekonomi += "Tidak mampu bayar biaya perawatan, ";
        }
        if (TakMampuAmbil.isSelected()) {
            ekonomi += "Tidak mampu mengambil pasien dari RSJ, ";
        }
        if (MampuBayar.isSelected()) {
            ekonomi += "Memiliki penjamin kesehatan / mampu bayar, ";
        }
        // Menghapus koma dari inputan terakhir jika ada
        if (ekonomi.endsWith(", ")) {
            ekonomi = ekonomi.substring(0, ekonomi.length() - 2);
        }
        ...
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ranap_psikiatri_geriatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",143,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),Informasi.getSelectedItem().toString(),
//                    RiwayatKesehatanPasien
                    KeluhanUtama.getText(),RKDSakitSejak.getText(),RKDKeluhan.getText(),RKDBerobat.getSelectedItem().toString(),RKDHasilPengobatan.getSelectedItem().toString(),
//                    FaktorPresifitas
                    FPPutusObat.getSelectedItem().toString(),KetPutusObat.getText(),FPEkonomi.getSelectedItem().toString(),KetMasalahEkonomi.getText(),FPMasalahFisik.getSelectedItem().toString(),KetMasalahFisik.getText(),FPMasalahPsikososial.getSelectedItem().toString(),KetMasalahPsikososial.getText(),
//                    FaktorResiko
                    RHKeluarga.getSelectedItem().toString(),KetRHKeluarga.getText(),ResikoBunuhDiri.getSelectedItem().toString(),RBDIde.getSelectedItem().toString(),KetRBDIde.getText(),RBDRencana.getSelectedItem().toString(),KetRBDRencana.getText(),RBDAlat.getSelectedItem().toString(),KetRBDAlat.getText(),RBDPercobaan.getSelectedItem().toString(),KetRBDPercobaan.getText(),RBDKeinginan.getSelectedItem().toString(),KetRBDKeinginan.getText(),
//                    RiwayatPengguaan
                    RPOPenggunaan.getSelectedItem().toString(),KetRPOPenggunaan.getText(),RPOEfekSamping.getSelectedItem().toString(),KetRPOEfekSamping.getText(),RPONapza.getSelectedItem().toString(),KetRPONapza.getText(),KetLamaPemakaian.getText(),KetCaraPemakaian.getText(),KetLatarBelakangPemakaian.getText(),RPOPenggunaanObatLainnya.getSelectedItem().toString(),KetPenggunaanObatLainnya.getText(),KetAlasanPenggunaan.getText(),RPOAlergiObat.getSelectedItem().toString(),KetAlergiObat.getText(),RPOMerokok.getSelectedItem().toString(),KetMerokok.getText(),RPOMinumKopi.getSelectedItem().toString(),KetMinumKopi.getText(),
//                    PemeriksaanFisik
                    TD.getText(),Nadi.getText(),GCS.getText(),RR.getText(),Suhu.getText(),PFKeluhanFisik.getSelectedItem().toString(),KetKeluhanFisik.getText(),
//                    PenilaianTingkatNyeri
                    SkalaNyeri.getSelectedItem().toString(),Durasi.getText(),Nyeri.getSelectedItem().toString(),Provokes.getSelectedItem().toString(),KetProvokes.getText(),Quality.getSelectedItem().toString(),KetQuality.getText(),Lokasi.getText(),Menyebar.getSelectedItem().toString(),PadaDokter.getSelectedItem().toString(),KetDokter.getText(),NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),
//                    StatusNutrisi
                    BB.getText(),TB.getText(),BMI.getText(),LaporStatusNutrisi.getSelectedItem().toString(),KetLaporStatusNutrisi.getText(),
//                    SkriningGizi
                    SG1.getSelectedItem().toString(),Nilai1.getSelectedItem().toString(),SG2.getSelectedItem().toString(),Nilai2.getSelectedItem().toString(),TotalHasil.getText(),
//                    PenilaianResikoJatuh
                    ResikoJatuh.getSelectedItem().toString(),BJM.getSelectedItem().toString(),MSA.getSelectedItem().toString(),HasilResikoJatuh.getSelectedItem().toString(),LaporResikoJatuh.getSelectedItem().toString(),KetLaporResikoJatuh.getText(),
//                    StatusFungsional
...
//                    StatusKesehatanSaatIni
                    SKPenampilan.getSelectedItem().toString(),SKAlamPerasaan.getSelectedItem().toString(),SKPembicaraan.getSelectedItem().toString(),SKAfek.getSelectedItem().toString(),SKAktifitasMotorik.getSelectedItem().toString(),SKGangguanRingan.getSelectedItem().toString(),SKProsesPikir.getSelectedItem().toString(),SKOrientasi.getSelectedItem().toString(),SKTingkatKesadaranOrientasi.getSelectedItem().toString(),SKMemori.getSelectedItem().toString(),SKInteraksi.getSelectedItem().toString(),SKKonsentrasi.getSelectedItem().toString(),SKPersepsi.getSelectedItem().toString(),KetSKPersepsi.getText(),SKIsiPikir.getSelectedItem().toString(),SKWaham.getSelectedItem().toString(),KetSKWaham.getText(),SKDayaTilikDiri.getSelectedItem().toString(),KetSKDayaTilikDiri.getText(),
//                    PsikososialEkonomiSpiritual
                     komunikasi, pengasuh, pLainnya.getText(), polaketerlibatan, orangdekat, odLainnya.getText(), peranserta, hambatan, GambaranDiri.getSelectedItem().toString(), IdealDiri.getSelectedItem().toString(), perandiri, identitas, idLainnya.getText(), hargadiri, nilaikeyakinan, nilaikeyakinan_ya, AdaLainnya.getText(), pelayanan, pelayanan_ya, ekonomi,
//                    KebutuhanKomunikasi
                    ...
                    for (i = 0; i < tbMasalahKeperawatan.getRowCount(); i++) {
                        if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_masalah_psikiatri","?,?",2,new String[]{TNoRw.getText(),tbMasalahKeperawatan.getValueAt(i,1).toString()});
                        }
                    }
                    ...
                    for (i = 0; i < tbRencanaEtiologi.getRowCount(); i++) {
                        if(tbRencanaEtiologi.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_etiologi_psikiatri_geri","?,?",2,new String[]{TNoRw.getText(),tbRencanaEtiologi.getValueAt(i,1).toString()});
                        }
                    }
                    for (i = 0; i < tbRencanaLuaran.getRowCount(); i++) {
                        if(tbRencanaLuaran.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_luaran_psikiatri_geri","?,?",2,new String[]{TNoRw.getText(),tbRencanaLuaran.getValueAt(i,1).toString()});
                        }
                    }
                    emptTeks();
            }
            ...
            try{
                if(TCari.getText().equals("")){
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.informasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.keluhan_utama,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_sakit_sejak,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_keluhan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_berobat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_hasil_pengobatan,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_masalah_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_masalah_fisik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_masalah_fisik,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_masalah_psikososial,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_masalah_psikososial,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.resiko_bunuh_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_ide,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_ide,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_alat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_alat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_percobaan,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_percobaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_efek_samping,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rpo_efek_samping,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_napza,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rpo_napza,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_lama_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_cara_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_latar_belakang_pemakaian,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_alasan_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_alergi_obat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_alergi_obat,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_merokok,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_merokok,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.td,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nadi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.gcs,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rr,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.suhu,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pf_keluhan_fisik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_keluhan_fisik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.skala_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.durasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nyeri,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.provokes,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_provokes,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.quality,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_quality,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.lokasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.menyebar,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pada_dokter,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_dokter,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nyeri_hilang,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.bb,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tb,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.bmi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.lapor_status_nutrisi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_lapor_status_nutrisi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sg1,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilai1,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sg2,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilai2,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.total_hasil,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.resikojatuh,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.bjm,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.msa,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hasil,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.lapor,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_lapor,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_mandi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_berpakaian,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_makan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_bak,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_bab,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_sosialisasi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_adl_sosialisasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_penampilan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_alam_perasaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_pembicaraan,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_afek,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_aktifitas_motorik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_gangguan_ringan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_proses_pikir,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_orientasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_tingkat_kesadaran_orientasi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_memori,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_interaksi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_konsentrasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_isi_pikir,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_daya_tilik_diri," + 
                            
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.komunikasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pengasuh,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pengasuh_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.polaketerlibatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_orangdekat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_orangdekat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_peranserta,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_hambatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.gambaran_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ideal_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.peran_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.identitas,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.identitas_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hargadiri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilaikeyakinan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilaikeyakinan_ya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilai_ya_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ekonomi,"+
                                    
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_pembelajaran,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_pembelajaran,"+       
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_pembelajaran_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_penerjamah,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_penerjamah_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_bahasa_isyarat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_kebutuhan_edukasi,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rencana,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nip,petugas.nama "+
                            "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join penilaian_awal_keperawatan_ranap_psikiatri_geriatri on reg_periksa.no_rawat=penilaian_awal_keperawatan_ranap_psikiatri_geriatri.no_rawat "+
                            "inner join petugas on penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nip=petugas.nip "+
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal between ? and ? order by penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal,"+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.informasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.keluhan_utama,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_sakit_sejak,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_keluhan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_berobat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_hasil_pengobatan,"+
                            ...
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal between ? and ? and "+
                            "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nip like ? or petugas.nama like ?) "+
                            "order by penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal");
                }
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Pola Komunikasi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Pola Asuh</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Pengasuh Lainnya</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Pola Pengambilan Keputusan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Hubsos Pasien Orang Dekat</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Hubsos Pasien Orang Dekat Lainnya</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Peran Serta Kelompok</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Hambatan Dalam Berhubungan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Gambaran Diri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Ideal Diri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Peran Diri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Identitas Diri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Identitas Diri Lainnya</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Harga Diri</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Nilai dan Keyakinan</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Nilai dan Keyakinan (Ya)</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Nilai dan Keyakinan (Ya) Lainnya</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Ekonomi dan Finansial</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("komunikasi")+"</td>"+
                               "<td valign='top'>"+rs.getString("pengasuh")+"</td>"+
                               "<td valign='top'>"+rs.getString("pengasuh_lainnya")+"</td>"+
                               "<td valign='top'>"+rs.getString("polaketerlibatan")+"</td>"+        
                               "<td valign='top'>"+rs.getString("hubsos_orangdekat")+"</td>"+ 
                               "<td valign='top'>"+rs.getString("hubsos_orangdekat_lainnya")+"</td>"+ 
                               "<td valign='top'>"+rs.getString("hubsos_peranserta")+"</td>"+    
                               "<td valign='top'>"+rs.getString("hubsos_hambatan")+"</td>"+            
                               "<td valign='top'>"+rs.getString("gambaran_diri")+"</td>"+            
                               "<td valign='top'>"+rs.getString("ideal_diri")+"</td>"+            
                               "<td valign='top'>"+rs.getString("peran_diri")+"</td>"+    
                               "<td valign='top'>"+rs.getString("identitas")+"</td>"+ 
                               "<td valign='top'>"+rs.getString("identitas_lainnya")+"</td>"+ 
                               "<td valign='top'>"+rs.getString("hargadiri")+"</td>"+            
                               "<td valign='top'>"+rs.getString("nilaikeyakinan")+"</td>"+  
                               "<td valign='top'>"+rs.getString("nilaikeyakinan_ya")+"</td>"+  
                               "<td valign='top'>"+rs.getString("nilai_ya_lainnya")+"</td>"+  
                               "<td valign='top'>"+rs.getString("ekonomi")+"</td>"+ 
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
       if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalKeperawatanRalanPsikiatri.jasper","report","::[ Laporan Penilaian Awal Keperawatan Ralan Psikiatri ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tanggal,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.informasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.keluhan_utama,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_sakit_sejak,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_keluhan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_berobat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_jenis_berobat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rkd_hasil_pengobatan,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_putus_obat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_masalah_ekonomi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_masalah_fisik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_masalah_fisik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.fp_masalah_psikososial,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_masalah_psikososial,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rh_keluarga,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.resiko_bunuh_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_ide,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_ide,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_rencana,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_alat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_alat,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_percobaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_percobaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rbd_keinginan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rpo_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_efek_samping,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rpo_efek_samping,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_napza,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_rpo_napza,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_lama_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_cara_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_latar_belakang_pemakaian,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_penggunaan_obat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_alasan_penggunaan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_alergi_obat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_alergi_obat,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_merokok,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_merokok,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rpo_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_minum_kopi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.td,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nadi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.gcs,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rr,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.suhu,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pf_keluhan_fisik,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_keluhan_fisik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.skala_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.durasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nyeri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.provokes,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_provokes,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.quality,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_quality,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.lokasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.menyebar,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pada_dokter,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_dokter,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nyeri_hilang,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_nyeri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.bb,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.tb,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.bmi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.lapor_status_nutrisi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_lapor_status_nutrisi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sg1,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilai1,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sg2,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilai2,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.total_hasil,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.resikojatuh,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.bjm,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.msa,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hasil,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.lapor,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_lapor,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_mandi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_berpakaian,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_makan,"+       
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_bak,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_bab,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_adl_hobi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_sosialisasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_adl_sosialisasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_adl_kegiatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_penampilan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_alam_perasaan,"+      
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_pembicaraan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_afek,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_aktifitas_motorik,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_gangguan_ringan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_proses_pikir,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_orientasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_tingkat_kesadaran_orientasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_memori,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_interaksi,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_konsentrasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_isi_pikir,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_pembelajaran,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_pembelajaran,"+       
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_pembelajaran_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_penerjamah,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_penerjamah_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_bahasa_isyarat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rencana,"+                  
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nip,petugas.nama "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_awal_keperawatan_ranap_psikiatri_geriatri on reg_periksa.no_rawat=penilaian_awal_keperawatan_ranap_psikiatri_geriatri.no_rawat "+
                        "inner join petugas on penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nip=petugas.nip "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
    ...
    private void pAyahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pAyahActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pAyahActionPerformed

    private void pOrangTuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pOrangTuaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pOrangTuaActionPerformed

    private void pIbuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pIbuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pIbuActionPerformed

    private void pNenekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pNenekActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pNenekActionPerformed

    private void pSaudaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pSaudaraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pSaudaraActionPerformed

    private void pLainnyaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pLainnyaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_pLainnyaKeyPressed

    private void odBapakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odBapakActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_odBapakActionPerformed

    private void odIbuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odIbuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_odIbuActionPerformed

    private void odAnakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odAnakActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_odAnakActionPerformed

    private void odSaudaraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odSaudaraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_odSaudaraActionPerformed

    private void odKawanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odKawanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_odKawanActionPerformed

    private void odLainnyaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_odLainnyaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_odLainnyaKeyPressed

    private void PeranTidakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeranTidakActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PeranTidakActionPerformed

    private void PeranMotivasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeranMotivasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PeranMotivasiActionPerformed

    private void PeranMandiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PeranMandiriActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PeranMandiriActionPerformed

    private void MalasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MalasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MalasActionPerformed

    private void TidakMampuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TidakMampuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TidakMampuActionPerformed

    private void TakDilibatkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TakDilibatkanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TakDilibatkanActionPerformed

    private void DikucilkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DikucilkanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DikucilkanActionPerformed

    private void BerhubunganSosialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BerhubunganSosialActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BerhubunganSosialActionPerformed

    private void GambaranDiriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GambaranDiriKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_GambaranDiriKeyPressed

    private void IdealDiriKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IdealDiriKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_IdealDiriKeyPressed

    private void MampuBerperanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MampuBerperanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MampuBerperanActionPerformed

    private void SenangKondisinyaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SenangKondisinyaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SenangKondisinyaActionPerformed
    ...
    private void BicaraKesulitanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BicaraKesulitanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BicaraKesulitanActionPerformed

    private void MengkritikDiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MengkritikDiriActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MengkritikDiriActionPerformed

    private void KondisiMaluActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KondisiMaluActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KondisiMaluActionPerformed
    ...
    private void TidakPulangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TidakPulangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TidakPulangActionPerformed

    private void MinumanMakananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MinumanMakananActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MinumanMakananActionPerformed

    private void AdaLainnyaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AdaLainnyaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_AdaLainnyaKeyPressed

    private void TakMemilikiPenjaminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TakMemilikiPenjaminActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TakMemilikiPenjaminActionPerformed

    private void PasienTerlantarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasienTerlantarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PasienTerlantarActionPerformed

    private void PasienDinsosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasienDinsosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PasienDinsosActionPerformed

    private void TakMampuBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TakMampuBayarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TakMampuBayarActionPerformed

    private void TakMampuAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TakMampuAmbilActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TakMampuAmbilActionPerformed

    private void PasienSendiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasienSendiriActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PasienSendiriActionPerformed

    private void odTidakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_odTidakActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_odTidakActionPerformed
    ...
    private void Komunikasi2ArahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Komunikasi2ArahActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Komunikasi2ArahActionPerformed

    private void PasienTerlibatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasienTerlibatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PasienTerlibatActionPerformed

    private void TakMauBekerjaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TakMauBekerjaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TakMauBekerjaActionPerformed

    private void PasienKonselingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasienKonselingActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PasienKonselingActionPerformed

    private void PasienBantuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasienBantuanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PasienBantuanActionPerformed

    private void MampuBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MampuBayarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MampuBayarActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri dialog = new RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox AdaLainnya;
    private widget.TextBox BB;
    private widget.ComboBox BJM;
    private widget.TextBox BMI;
    private javax.swing.JCheckBox BerhubunganSosial;
    private javax.swing.JCheckBox BicaraKesulitan;
    ...
    private javax.swing.JCheckBox Dikucilkan;
    ...
    private widget.ComboBox GambaranDiri;
    private widget.ComboBox HasilResikoJatuh;
    private widget.ComboBox IdealDiri;
    ...
    private javax.swing.JRadioButton KebutuhanTidak;
    private javax.swing.JRadioButton KebutuhanYa;
    ...
    private javax.swing.JRadioButton Komunikasi2Arah;
    private javax.swing.JRadioButton KomunikasiSearah;
    private javax.swing.JCheckBox KondisiMalu;
    ...
    private javax.swing.JCheckBox Malas;
    private javax.swing.JCheckBox MampuBayar;
    private javax.swing.JCheckBox MampuBerperan;
    private javax.swing.JRadioButton MauBekerja;
    private javax.swing.JCheckBox MengkritikDiri;
    private widget.ComboBox Menyebar;
    private javax.swing.JCheckBox MinumanMakanan;
    private widget.TextBox Nadi;
    private widget.ComboBox Nilai1;
    private widget.ComboBox Nilai2;
    private javax.swing.JRadioButton NilaiAda;
    private javax.swing.JRadioButton NilaiTidak;
    private widget.TextBox NmPetugas;
    private widget.ComboBox Nyeri;
    private widget.ComboBox NyeriHilang;
    private widget.ComboBox PFKeluhanFisik;
    private widget.ComboBox PadaDokter;
    private javax.swing.JCheckBox Pakaian;
    private widget.PanelBiasa PanelAccor;
    private usu.widget.glass.PanelGlass PanelWall;
    private javax.swing.JCheckBox PasienBantuan;
    private javax.swing.JCheckBox PasienDinsos;
    private javax.swing.JCheckBox PasienKonseling;
    private javax.swing.JCheckBox PasienSendiri;
    private javax.swing.JRadioButton PasienTakTerlibat;
    private javax.swing.JCheckBox PasienTerlantar;
    private javax.swing.JRadioButton PasienTerlibat;
    private javax.swing.JCheckBox Pasif;
    private javax.swing.JCheckBox PeranMandiri;
    private javax.swing.JCheckBox PeranMotivasi;
    private javax.swing.JCheckBox PeranTidak;
    ...
    private javax.swing.JCheckBox SenangKondisinya;
    ...
    private javax.swing.JCheckBox TakDilibatkan;
    private javax.swing.JCheckBox TakMampuAmbil;
    private javax.swing.JCheckBox TakMampuBayar;
    private javax.swing.JRadioButton TakMauBekerja;
    private javax.swing.JCheckBox TakMemilikiPenjamin;
    private widget.Tanggal TglAsuhan;
    private widget.TextBox TglLahir;
    private javax.swing.JCheckBox TidakMampu;
    private javax.swing.JCheckBox TidakPulang;
    ...
    private widget.TextBox idLainnya;
    ...
    private javax.swing.JCheckBox odAnak;
    private javax.swing.JCheckBox odBapak;
    private javax.swing.JCheckBox odIbu;
    private javax.swing.JCheckBox odKawan;
    private widget.TextBox odLainnya;
    private javax.swing.JCheckBox odSaudara;
    private javax.swing.JCheckBox odTidak;
    private javax.swing.JCheckBox pAyah;
    private javax.swing.JCheckBox pIbu;
    private widget.TextBox pLainnya;
    private javax.swing.JCheckBox pNenek;
    private javax.swing.JCheckBox pOrangTua;
    private javax.swing.JCheckBox pSaudara;
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_memori,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_interaksi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_konsentrasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_persepsi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_isi_pikir,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_waham,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.sk_daya_tilik_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_sk_daya_tilik_diri,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.komunikasi, penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pengasuh, penilaian_awal_keperawatan_ranap_psikiatri_geriatri.pengasuh_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.polaketerlibatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_orangdekat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_orangdekat_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_peranserta,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hubsos_hambatan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.gambaran_diri,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ideal_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.peran_diri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.identitas,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.identitas_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.hargadiri,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilaikeyakinan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilaikeyakinan_ya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nilai_ya_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kebutuhan_pelayanan,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kebutuhan_pelayanan_ya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ekonomi," +      
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_pembelajaran,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_pembelajaran,"+       
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_pembelajaran_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_penerjamah,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_penerjamah_lainnya,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_bahasa_isyarat,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.kk_kebutuhan_edukasi,"+
                        "penilaian_awal_keperawatan_ranap_psikiatri_geriatri.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.rencana,penilaian_awal_keperawatan_ranap_psikiatri_geriatri.nip,petugas.nama "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("sk_daya_tilik_diri"),rs.getString("ket_sk_daya_tilik_diri"),
                        rs.getString("komunikasi"),rs.getString("pengasuh"),rs.getString("pengasuh_lainnya"),rs.getString("polaketerlibatan"),rs.getString("hubsos_orangdekat"),rs.getString("hubsos_orangdekat_lainnya"),rs.getString("hubsos_peranserta"),rs.getString("hubsos_hambatan"),rs.getString("gambaran_diri"),rs.getString("ideal_diri"),rs.getString("peran_diri"),rs.getString("identitas"),rs.getString("identitas_lainnya"),rs.getString("hargadiri"),rs.getString("nilaikeyakinan"),rs.getString("nilaikeyakinan_ya"),rs.getString("nilai_ya_lainnya"),rs.getString("kebutuhan_pelayanan"),rs.getString("kebutuhan_pelayanan_ya"),rs.getString("ekonomi"),
                        rs.getString("kk_pembelajaran"),rs.getString("ket_kk_pembelajaran"),rs.getString("ket_kk_pembelajaran_lainnya"),
    ...
    public void emptTeks() {
        ...
        pOrangTua.setSelected(false);
        pAyah.setSelected(false);
        pIbu.setSelected(false);
        ...
        odSaudara.setSelected(false);
        odTidak.setSelected(false);
        odKawan.setSelected(false);
        odLainnya.setText("");
        PeranTidak.setSelected(false);
        PeranMotivasi.setSelected(false);
        PeranMandiri.setSelected(false);
        Malas.setSelected(false);
        TidakMampu.setSelected(false);
        TakDilibatkan.setSelected(false);
        Dikucilkan.setSelected(false);
        BerhubunganSosial.setSelected(false);
        GambaranDiri.setSelectedIndex(0);
        IdealDiri.setSelectedIndex(0);
        buttonGroup3.clearSelection();
        SenangKondisinya.setSelected(false);
        MampuBerperan.setSelected(false);
        idLainnya.setText("");
        MengkritikDiri.setSelected(false);
        BicaraKesulitan.setSelected(false);
        KondisiMalu.setSelected(false);
        Pasif.setSelected(false);
        buttonGroup4.clearSelection();
        TidakPulang.setSelected(false);
        MinumanMakanan.setSelected(false);
        Pakaian.setSelected(false);
        AdaLainnya.setText("");
        TakMemilikiPenjamin.setSelected(false);
        PasienTerlantar.setSelected(false);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            String komunikasiValue = tbObat.getValueAt(tbObat.getSelectedRow(), 120).toString();
            if ("Komunikasi searah ( orang tua / salah satu anggota keluarga yang dominan )".equals(komunikasiValue)) {
                KomunikasiSearah.setSelected(true);
            } else if ("Komunikasi dua arah ( saling komunikasi dalam menyelesaikan masalah )".equals(komunikasiValue)) {
                Komunikasi2Arah.setSelected(true);
            }
            
            String pengasuhValue = tbObat.getValueAt(tbObat.getSelectedRow(), 121).toString();
            if (pengasuhValue.contains("Orang Tua")) {
                pOrangTua.setSelected(true);
            } if (pengasuhValue.contains("Ayah")) {
                pAyah.setSelected(true);
            } if (pengasuhValue.contains("Ibu")) {
                pIbu.setSelected(true);
            } if (pengasuhValue.contains("Nenek")) {
                pNenek.setSelected(true);
            } if (pengasuhValue.contains("Saudara")) {
                pSaudara.setSelected(true);
            }
            
            pLainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),122).toString());
            
            String keterlibatanValue = tbObat.getValueAt(tbObat.getSelectedRow(), 123).toString();
            if ("Pasien dilibatkan dalam pengambilan keputusan dalam keluarga".equals(keterlibatanValue)) {
                PasienTerlibat.setSelected(true);
            } else if ("Pasien tidak terlibat dalam keputusan dalam keluarga".equals(keterlibatanValue)) {
                PasienTakTerlibat.setSelected(true);
            }
            
            String orangdekat = tbObat.getValueAt(tbObat.getSelectedRow(), 124).toString();
            if (orangdekat.contains("Bapak")) {
                odBapak.setSelected(true);
            } if (orangdekat.contains("Ibu")) {
                odIbu.setSelected(true);
            } if (orangdekat.contains("Anak")) {
                odAnak.setSelected(true);
            } if (orangdekat.contains("Saudara")) {
                odSaudara.setSelected(true);
            } if (orangdekat.contains("Tidak Ada")) {
                odTidak.setSelected(true);
            } if (orangdekat.contains("Kawan")) {
                odKawan.setSelected(true);
            }
            
            odLainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),125).toString());
            
            String peran = tbObat.getValueAt(tbObat.getSelectedRow(), 126).toString();
            if (peran.contains("Tidak Ada")) {
                PeranTidak.setSelected(true);
            } if (peran.contains("Kegiatan Motivasi")) {
                PeranMotivasi.setSelected(true);
            } if (peran.contains("Kegiatan Mandiri")) {
                PeranMandiri.setSelected(true);
            }
            
            String hambatan = tbObat.getValueAt(tbObat.getSelectedRow(), 127).toString();
            if (hambatan.contains("Malas / Malu")) {
                Malas.setSelected(true);
            } if (hambatan.contains("Merasa Tidak Mampu")) {
                TidakMampu.setSelected(true);
            } if (hambatan.contains("Tidak Dilibatkan")) {
                TakDilibatkan.setSelected(true);
            } if (hambatan.contains("Dikucilkan")) {
                Dikucilkan.setSelected(true);
            } if (hambatan.contains("Mampu berhubungan sosial dengan baik")) {
                BerhubunganSosial.setSelected(true);
            }
            
            
            GambaranDiri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),128).toString());
            IdealDiri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),129).toString());
            
            String perandiri = tbObat.getValueAt(tbObat.getSelectedRow(), 130).toString();
            if ("Mau bekerja/sekolah lagi".equals(perandiri)) {
                MauBekerja.setSelected(true);
            } else if ("Tidak mau bekerja/sekolah lagi".equals(perandiri)) {
                TakMauBekerja.setSelected(true);
            }
            
            String identitas = tbObat.getValueAt(tbObat.getSelectedRow(), 131).toString();
            if (identitas.contains("Senang dengan kondisi sebagai laki - laki / perempuan")) {
                SenangKondisinya.setSelected(true);
            } if (identitas.contains("Mampu berperan sesuai identitas dirinya")) {
                MampuBerperan.setSelected(true);
            }
            
            idLainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),132).toString());
            
            String hargadiri = tbObat.getValueAt(tbObat.getSelectedRow(), 133).toString();
            if (hargadiri.contains("Mengkritik diri sendiri")) {
                MengkritikDiri.setSelected(true);
            } if (hargadiri.contains("Malu/minder dengan kondisi sekarang")) {
                KondisiMalu.setSelected(true);
            } if (hargadiri.contains("Selalu bicara kesulitan yang dihadapi")) {
                BicaraKesulitan.setSelected(true);
            } if (hargadiri.contains("Pasif dan hipoaktif")) {
                Pasif.setSelected(true);
            }
            
            String nilai = tbObat.getValueAt(tbObat.getSelectedRow(), 134).toString();
            if ("Tidak Ada".equals(nilai)) {
                NilaiTidak.setSelected(true);
            } else if ("Ada".equals(nilai)) {
                NilaiAda.setSelected(true);
            }
            
            String nilai_ya = tbObat.getValueAt(tbObat.getSelectedRow(), 135).toString();
            if (nilai_ya.contains("Tidak Pulang di hari Sabtu / Selasa")) {
                TidakPulang.setSelected(true);
            } if (nilai_ya.contains("Minuman / makanan tertentu yang diberikan ke pasien")) {
                MinumanMakanan.setSelected(true);
            } if (nilai_ya.contains("Pakaian yang diyakini pasien selama dirawat")) {
                Pakaian.setSelected(true);
            }
            
            AdaLainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 136).toString());
            
            String pelayanan = tbObat.getValueAt(tbObat.getSelectedRow(), 137).toString();
            if ("Tidak".equals(pelayanan)) {
                KebutuhanTidak.setSelected(true);
            } else if ("Ya".equals(pelayanan)) {
                KebutuhanYa.setSelected(true);
            }
            
            String pelayanan_ya = tbObat.getValueAt(tbObat.getSelectedRow(), 138).toString();
            if (pelayanan_ya.contains("Pasien membutuhkan konseling spiritual / agama")) {
                PasienKonseling.setSelected(true);
            } if (pelayanan_ya.contains("Pasien membutuhkan bantuan saat menjalankan ibadah")) {
                PasienBantuan.setSelected(true);
            }
            
            String ekonomi = tbObat.getValueAt(tbObat.getSelectedRow(), 139).toString();
            if (ekonomi.contains("Tidak memiliki penjamin kesehatan")) {
                TakMemilikiPenjamin.setSelected(true);
            } if (ekonomi.contains("Pasien Terlantar")) {
                PasienTerlantar.setSelected(true);
            } if (ekonomi.contains("Pasien dari Dinas Sosial")) {
                PasienDinsos.setSelected(true);
            } if (ekonomi.contains("Pasien tinggal sendiri")) {
                PasienSendiri.setSelected(true);
            } if (ekonomi.contains("Tidak mampu bayar biaya perawatan")) {
                TakMampuBayar.setSelected(true);
            } if (ekonomi.contains("Tidak mampu mengambil pasien dari RSJ")) {
                TakMampuAmbil.setSelected(true);
            }
            
            KKPembelajaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),140).toString());
            KetKKPembelajaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),141).toString());
            KetKKPembelajaranLainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),142).toString());
            KKPenerjamah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),143).toString());
            KetKKPenerjamahLainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),144).toString());
            KKBahasaIsyarat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),145).toString());
            KKKebutuhanEdukasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),146).toString());
            KetKKKebutuhanEdukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),147).toString());
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),148).toString());
            KdPetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),149).toString());
            NmPetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),150).toString());
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_masalah_psikiatri on penilaian_awal_keperawatan_ranap_masalah_psikiatri.kode_masalah=master_masalah_keperawatan_psikiatri.kode_masalah "+
                        "where penilaian_awal_keperawatan_ranap_masalah_psikiatri.no_rawat=? order by penilaian_awal_keperawatan_ranap_masalah_psikiatri.kode_masalah");
                try {
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_rencana_psikiatri on penilaian_awal_keperawatan_ranap_rencana_psikiatri.kode_rencana=master_rencana_keperawatan_psikiatri.kode_rencana "+
                        "where penilaian_awal_keperawatan_ranap_rencana_psikiatri.no_rawat=? order by penilaian_awal_keperawatan_ranap_rencana_psikiatri.kode_rencana");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_etiologi_psikiatri_geri on penilaian_awal_keperawatan_ranap_etiologi_psikiatri_geri.kode_etiologi=master_etiologi_keperawatan.kode_etiologi "+
                        "where penilaian_awal_keperawatan_ranap_etiologi_psikiatri_geri.no_rawat=? order by penilaian_awal_keperawatan_ranap_etiologi_psikiatri_geri.kode_etiologi");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
                        tabModeEtiologi.addRow(new Object[]{true,rs.getString(1),rs.getString(2)});
                    }
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                } finally{
            ...
            try {
                Valid.tabelKosong(tabModeLuaran);
                ps=koneksi.prepareStatement(
                        "select master_luaran_keperawatan.kode_luaran,master_luaran_keperawatan.etiologi from master_luaran_keperawatan "+
                        "inner join penilaian_awal_keperawatan_ranap_luaran_psikiatri_geri on penilaian_awal_keperawatan_ranap_luaran_psikiatri_geri.kode_luaran=master_luaran_keperawatan.kode_luaran "+
                        "where penilaian_awal_keperawatan_ranap_luaran_psikiatri_geri.no_rawat=? order by penilaian_awal_keperawatan_ranap_luaran_psikiatri_geri.kode_luaran");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
                        tabModeLuaran.addRow(new Object[]{true,rs.getString(1),rs.getString(2)});
                    }
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
                } finally{
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_geriatri());
        BtnHapus.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_kep_ranap_psikiatri_geriatri());
    ...
    private void tampilEtiologi() {
        try{
            file=new File("./cache/rencanaetiologipsiko.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ...
            fileWriter.write("{\"rencanaetiologipsiko\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilEtiologi2() {
        try{
            ...
            myObj = new FileReader("./cache/rencanaetiologipsiko.iyem");
            root = mapper.readTree(myObj);
            response = root.path("rencanaetiologipsiko");
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
     ...
     private void tampilLuaran() {
        try{
            file=new File("./cache/rencanaluaranpsiko.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ...
            fileWriter.write("{\"rencanaluaranpsiko\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilLuaran2() {
        try{
            ...
            myObj = new FileReader("./cache/rencanaluaranpsiko.iyem");
            root = mapper.readTree(myObj);
            response = root.path("rencanaluaranpsiko");
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
    ...
    private void getMasalah() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            DetailRencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),148).toString());
            try {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_keperawatan_ranap_psikiatri_geriatri where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
            TNoRM1.setText("");
            TPasien1.setText("");
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_masalah_psikiatri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_rencana_psikiatri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_etiologi_psikiatri_geri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_luaran_psikiatri_geri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Valid.tabelKosong(tabModeDetailMasalah);
            Valid.tabelKosong(tabModeDetailRencana);
...
//        Ekonomi Finansial
        ...
        if(Sequel.mengedittf("penilaian_awal_keperawatan_ranap_psikiatri_geriatri","no_rawat=?","no_rawat=?,tanggal=?,informasi=?,keluhan_utama=?,rkd_sakit_sejak=?,rkd_keluhan=?,rkd_berobat=?,rkd_hasil_pengobatan=?,fp_putus_obat=?,ket_putus_obat=?,fp_ekonomi=?,ket_masalah_ekonomi=?,fp_masalah_fisik=?,ket_masalah_fisik=?,fp_masalah_psikososial=?,ket_masalah_psikososial=?,"+
                ...
                "sk_daya_tilik_diri=?,ket_sk_daya_tilik_diri=?,"+
                "komunikasi=?," +
                "pengasuh=?,pengasuh_lainnya=?,polaketerlibatan=?,hubsos_orangdekat=?,hubsos_orangdekat_lainnya=?,hubsos_peranserta=?,hubsos_hambatan=?,gambaran_diri=?,ideal_diri=?,peran_diri=?,identitas=?,identitas_lainnya=?,hargadiri=?,nilaikeyakinan=?,nilaikeyakinan_ya=?,nilai_ya_lainnya=?,kebutuhan_pelayanan=?,kebutuhan_pelayanan_ya=?,ekonomi=?,"+
                "kk_pembelajaran=?,ket_kk_pembelajaran=?,ket_kk_pembelajaran_lainnya=?,kk_Penerjamah=?,ket_kk_penerjamah_Lainnya=?,kk_bahasa_isyarat=?,kk_kebutuhan_edukasi=?,ket_kk_kebutuhan_edukasi=?,rencana=?,nip=?",144,new String[]{
