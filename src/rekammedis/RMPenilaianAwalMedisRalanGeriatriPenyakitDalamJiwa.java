 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRalanGeriatriPenyakitDalamJiwa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRalanGeriatriPenyakitDalamJiwa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Jalan Geriatri Jiwa Penyakit Dalam ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-07-2023 08:43:19" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ralan_geriatri_pd_jiwa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",44,new String[]{
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanGeriatri.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Penyakit Dalam ]::",
                ...
                "penilaian_medis_ralan_geriatri_pd_jiwa.td,penilaian_medis_ralan_geriatri_pd_jiwa.nadi,penilaian_medis_ralan_geriatri_pd_jiwa.suhu,penilaian_medis_ralan_geriatri_pd_jiwa.rr,penilaian_medis_ralan_geriatri_pd_jiwa.kondisi_umum,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.status_psikologis_gds,penilaian_medis_ralan_geriatri_pd_jiwa.kondisi_sosial,penilaian_medis_ralan_geriatri_pd_jiwa.status_kognitif_mmse,penilaian_medis_ralan_geriatri_pd_jiwa.kepala,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.keterangan_kepala,penilaian_medis_ralan_geriatri_pd_jiwa.thoraks,penilaian_medis_ralan_geriatri_pd_jiwa.keterangan_thoraks,penilaian_medis_ralan_geriatri_pd_jiwa.abdomen,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.keterangan_abdomen,penilaian_medis_ralan_geriatri_pd_jiwa.ekstremitas,penilaian_medis_ralan_geriatri_pd_jiwa.keterangan_ekstremitas,penilaian_medis_ralan_geriatri_pd_jiwa.Integument_kebersihan,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.Integument_warna,penilaian_medis_ralan_geriatri_pd_jiwa.Integument_kelembaban,penilaian_medis_ralan_geriatri_pd_jiwa.Integument_gangguan_kulit,penilaian_medis_ralan_geriatri_pd_jiwa.status_fungsional,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.skrining_jatuh,penilaian_medis_ralan_geriatri_pd_jiwa.status_nutrisi,penilaian_medis_ralan_geriatri_pd_jiwa.lainnya,penilaian_medis_ralan_geriatri_pd_jiwa.lab,penilaian_medis_ralan_geriatri_pd_jiwa.rad,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.pemeriksaan,penilaian_medis_ralan_geriatri_pd_jiwa.diagnosis,penilaian_medis_ralan_geriatri_pd_jiwa.diagnosis2,penilaian_medis_ralan_geriatri_pd_jiwa.permasalahan,penilaian_medis_ralan_geriatri_pd_jiwa.terapi,"+
                "penilaian_medis_ralan_geriatri_pd_jiwa.tindakan,penilaian_medis_ralan_geriatri_pd_jiwa.edukasi "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ralan_geriatri_pd_jiwa on reg_periksa.no_rawat=penilaian_medis_ralan_geriatri_pd_jiwa.no_rawat "+
                "inner join dokter on penilaian_medis_ralan_geriatri_pd_jiwa.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_geriatri_pd_jiwa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanGeriatriPenyakitDalamJiwa dialog = new RMPenilaianAwalMedisRalanGeriatriPenyakitDalamJiwa(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ralan_geriatri_pd_jiwa on reg_periksa.no_rawat=penilaian_medis_ralan_geriatri_pd_jiwa.no_rawat "+
                        "inner join dokter on penilaian_medis_ralan_geriatri_pd_jiwa.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ralan_geriatri_pd_jiwa.tanggal between ? and ? order by penilaian_medis_ralan_geriatri_pd_jiwa.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ralan_geriatri_pd_jiwa.tanggal,"+
                        "penilaian_medis_ralan_geriatri_pd_jiwa.kd_dokter,dokter.nm_dokter,penilaian_medis_ralan_geriatri_pd_jiwa.anamnesis,penilaian_medis_ralan_geriatri_pd_jiwa.hubungan,penilaian_medis_ralan_geriatri_pd_jiwa.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ralan_geriatri_pd_jiwa on reg_periksa.no_rawat=penilaian_medis_ralan_geriatri_pd_jiwa.no_rawat "+
                        "inner join dokter on penilaian_medis_ralan_geriatri_pd_jiwa.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ralan_geriatri_pd_jiwa.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ralan_geriatri_pd_jiwa.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ralan_geriatri_pd_jiwa.tanggal");
            }
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_geriatri_pd_jiwa where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_geriatri_pd_jiwa","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,tulang_belakang=?,td=?,nadi=?,suhu=?,rr=?,kondisi_umum=?,"+
