...
public class DlgDemografiSukuUmurKunjungan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDemografiSukuUmurKunjungan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Demografi Suku Umur Kunjungan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label22.setBounds(450, 10, 87, 20);
                        ...
                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi2'>"+
                                "<td valign='top' align='center'>"+
                                    ...
                                    "<font size='2' face='Tahoma'>DATA DEMOGRAFI SUKU KUNJUNGAN<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                "</td>"+
                           "</tr>"+
                        "</table>")
            );
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDemografiSukuUmurKunjungan dialog = new DlgDemografiSukuUmurKunjungan(new javax.swing.JFrame(), true);
...
//            querytambahan=querydokter+querypoli+querycarabayar+querylokasi;
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center' width='15%' rowspan='3'>Suku</td>"+
                ...
                ps=koneksi.prepareStatement("SELECT suku_bangsa.nama_suku_bangsa as nama FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN suku_bangsa ON pasien.suku_bangsa = suku_bangsa.id " +
                          "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                          "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' GROUP BY suku_bangsa.nama_suku_bangsa");
                try {
                    rs=ps.executeQuery();
                    i=1;
                    ttlhr07l=0;ttlhr07p=0;ttlthk1l=0;ttlthk1p=0;ttlth14l=0;ttlth14p=0;ttlth59l=0;ttlth59p=0;ttlth1014l=0;ttlth1014p=0;
                    ...
                    while(rs.next()){
                        ...
                        hr07l=Sequel.cariInteger(
                             "select count(suku_bangsa.nama_suku_bangsa)as jumlah FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN suku_bangsa ON pasien.suku_bangsa = suku_bangsa.id "+
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Hr' and umurdaftar between '0' and '7' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        hr07p=Sequel.cariInteger(
                             ...
                             "and sttsumur='Hr' and umurdaftar between '0' and '7' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='P' group by suku_bangsa.nama_suku_bangsa");
                        hr830l=Sequel.cariInteger(
                             "select count(suku_bangsa.nama_suku_bangsa)as jumlah FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN suku_bangsa ON pasien.suku_bangsa = suku_bangsa.id "+
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Hr' and umurdaftar between '8' and '31' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        thk1l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Bl' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th14l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '1' and '4' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th59l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '5' and '9' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th1014l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '10' and '14' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th1519l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '15' and '19' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th2044l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '20' and '44' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th4554l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '45' and '54' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th5559l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '55' and '59' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        th6069l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar between '60' and '69' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        thl70l=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and sttsumur='Th' and umurdaftar >='70' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+
                             "and pasien.jk='L' group by suku_bangsa.nama_suku_bangsa");
                        ...
                        registrasibaru=Sequel.cariInteger(
                             ...
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.stts_daftar='Baru' group by suku_bangsa.nama_suku_bangsa");
                        registrasilama=Sequel.cariInteger(
                             "select count(suku_bangsa.nama_suku_bangsa)as jumlah FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN suku_bangsa ON pasien.suku_bangsa = suku_bangsa.id "+
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.stts_daftar='Lama' group by suku_bangsa.nama_suku_bangsa");
                        polibaru=Sequel.cariInteger(
                             "select count(suku_bangsa.nama_suku_bangsa)as jumlah FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN suku_bangsa ON pasien.suku_bangsa = suku_bangsa.id "+
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.status_poli='Baru' group by suku_bangsa.nama_suku_bangsa");
                        polilama=Sequel.cariInteger(
                             "select count(suku_bangsa.nama_suku_bangsa)as jumlah FROM reg_periksa INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN suku_bangsa ON pasien.suku_bangsa = suku_bangsa.id "+
                             "where reg_periksa.tgl_registrasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' "+
                             "and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' "+
                             "and suku_bangsa.nama_suku_bangsa='"+rs.getString("nama")+"' "+querylokasi+" "+querydokter+" "+querypoli+" "+querycarabayar+" "+
                             "and reg_periksa.status_poli='Lama' group by suku_bangsa.nama_suku_bangsa");
