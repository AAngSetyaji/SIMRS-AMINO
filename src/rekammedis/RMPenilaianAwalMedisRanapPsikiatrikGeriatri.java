 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapPsikiatrikGeriatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapPsikiatrikGeriatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Psikiatri Geriatri ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2023 10:59:22" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_psikiatrik_geriatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",86,new String[]{
                ...
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                           "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_psikiatrik_geriatri.tanggal,"+
                             "penilaian_medis_ranap_psikiatrik_geriatri.kd_dokter,penilaian_medis_ranap_psikiatrik_geriatri.anamnesis,penilaian_medis_ranap_psikiatrik_geriatri.hubungan,penilaian_medis_ranap_psikiatrik_geriatri.keluhan_utama,"+
                            "penilaian_medis_ranap_psikiatrik_geriatri.rps,penilaian_medis_ranap_psikiatrik_geriatri.rpd,penilaian_medis_ranap_psikiatrik_geriatri.rpk,penilaian_medis_ranap_psikiatrik_geriatri.rpo,penilaian_medis_ranap_psikiatrik_geriatri.alergi,"+

                            "penilaian_medis_ranap_psikiatrik_geriatri.penampilan,penilaian_medis_ranap_psikiatrik_geriatri.kesadaran_jiwa,penilaian_medis_ranap_psikiatrik_geriatri.sikap,penilaian_medis_ranap_psikiatrik_geriatri.tingkah_laku,"+
                            ...
                            "inner join dokter on penilaian_medis_ranap_psikiatrik_geriatri.kd_dokter=dokter.kd_dokter where "+
                            "penilaian_medis_ranap_psikiatrik_geriatri.tanggal between ? and ? order by penilaian_medis_ranap_psikiatrik_geriatri.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                           "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_psikiatrik_geriatri.tanggal,"+
                             "penilaian_medis_ranap_psikiatrik_geriatri.kd_dokter,penilaian_medis_ranap_psikiatrik_geriatri.anamnesis,penilaian_medis_ranap_psikiatrik_geriatri.hubungan,penilaian_medis_ranap_psikiatrik_geriatri.keluhan_utama,"+
                            ...
                            "inner join penilaian_medis_ranap_psikiatrik_geriatri on reg_periksa.no_rawat=penilaian_medis_ranap_psikiatrik_geriatri.no_rawat "+
                            "inner join dokter on penilaian_medis_ranap_psikiatrik_geriatri.kd_dokter=dokter.kd_dokter where "+
                            "penilaian_medis_ranap_psikiatrik_geriatri.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "penilaian_medis_ranap_psikiatrik_geriatri.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_psikiatrik_geriatri.tanggal");
                }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapPsikiatrikGeriatri dialog = new RMPenilaianAwalMedisRanapPsikiatrikGeriatri(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_medis_ranap_psikiatri_geriatri());
        BtnHapus.setEnabled(akses.getpenilaian_medis_ranap_psikiatri_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_medis_ranap_psikiatri_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_medis_ranap_psikiatri_geriatri());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_psikiatrik_geriatri where no_rawat=?",1,new String[]{
