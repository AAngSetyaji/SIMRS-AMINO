 ...
 * @author dosen
 */
public final class DlgCariDaftarECT extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariDaftarECT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Daftar Tindakan ECT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        DlgJnsPerawatanECT bangsal=new DlgJnsPerawatanECT(null,false);
        bangsal.emptTeks();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariDaftarECT dialog = new DlgCariDaftarECT(new javax.swing.JFrame(), true);
    ...
    private void tampil() {  
        try{
            file=new File("./cache/paketect.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            pstindakan=koneksi.prepareStatement(
                   "select paket_ect.kode_paket,paket_ect.nm_perawatan,paket_ect.kategori,paket_ect.kd_pj,paket_ect.kelas,"+
                   "paket_ect.operator1,paket_ect.operator2,paket_ect.operator3,paket_ect.asisten_operator1,paket_ect.asisten_operator2,"+
                   "paket_ect.asisten_operator3,paket_ect.instrumen,paket_ect.dokter_anak,paket_ect.perawaat_resusitas,"+
                   "paket_ect.dokter_anestesi,paket_ect.asisten_anestesi,paket_ect.asisten_anestesi2,paket_ect.bidan,paket_ect.bidan2,"+
                   "paket_ect.bidan3,paket_ect.perawat_luar,paket_ect.alat,paket_ect.sewa_ok,paket_ect.akomodasi,paket_ect.bagian_rs,"+
                   "paket_ect.omloop,paket_ect.omloop2,paket_ect.omloop3,paket_ect.omloop4,paket_ect.omloop5,paket_ect.sarpras,"+
                   "paket_ect.dokter_pjanak,paket_ect.dokter_umum from paket_ect where paket_ect.status='1' order by paket_ect.nm_perawatan ");
            try {
            ...
            fileWriter.write("{\"paketect\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampil2() {  
        try{
            myObj = new FileReader("./cache/paketect.iyem");
            root = mapper.readTree(myObj);
            Valid.tabelKosong(tabMode);
            response = root.path("paketect");
    ...
    public void setBayar(String penjab,String kelasoperasi){
        ...
        try {
            if(Valid.daysOld("./cache/paketect.iyem")<8){
                tampil2();
            }
        } catch (Exception e) {
        }
