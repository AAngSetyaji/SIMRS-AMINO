...
public class DlgCariTagihanECT extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariTagihanECT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{
                "Tgl.ECT","No.Rawat","Pasien","Jns.Ans","","","","","","","","","","","","","","","","","","","","","","","","","","",
        ...
        member.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgCariTagihanECT")){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Tagihan ECT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
*/
    ...
    private void BtnCari5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari5ActionPerformed
        akses.setform("DlgCariTagihanECT");
        member.emptTeks();
        member.isCek();
        ...
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
            if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString())>0){
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    ...
                    status=Sequel.cariIsi("select status from ect where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1) +"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0)+"'");
                    ttljmdokter=Sequel.cariIsiAngka("select sum(biayaoperator1+biayaoperator2+biayaoperator3+biayadokter_anak+"+
                            "biayadokter_anestesi+biaya_dokter_pjanak+biaya_dokter_umum) from ect where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1) +"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0)+"'");
                    ttljmpetugas=Sequel.cariIsiAngka("select sum(biayaasisten_operator1+biayaasisten_operator2+biayaasisten_operator3+"+
                            ...
                            "from ect where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1) +"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0)+"'");
                    ttlpendapatan=Sequel.cariIsiAngka("select sum(ect.biayaoperator1+ect.biayaoperator2+"+
                            ...
                            "ect.biaya_dokter_umum) from ect where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1) +"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0)+"'");
                    ...
                    if(Sequel.queryutf("delete from ect where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1)+"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0) +"'")==true){
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
                ...
                if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString())>0){
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                "select ect.operator1, ect.operator2, ect.operator3, ect.asisten_operator1,"+
                                "ect.asisten_operator2,ect.asisten_operator3, ect.instrumen, ect.dokter_anak, ect.perawaat_resusitas, "+
                                "ect.dokter_anestesi, ect.asisten_anestesi,ect.asisten_anestesi2, ect.bidan, ect.bidan2, ect.bidan3, ect.perawat_luar, "+
                                "ect.omloop,ect.omloop2,ect.omloop3,ect.omloop4,ect.omloop5,ect.dokter_pjanak,ect.dokter_umum "+
                                "from ect where ect.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+"' and ect.tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"'").executeQuery();
                        no=1;
                        while(rs2.next()){
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        ...
        if(kdoperator1.getText().trim().equals("")||nmoperator1.getText().trim().equals("")){
            ...
            if(Sequel.mengedittf("ect","no_rawat=? and tgl_operasi=?","operator1=?,operator2=?,operator3=?, "+
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                ...
                kodeoperator=Sequel.cariIsi("select ect.operator1 from ect where operasi.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariTagihanECT dialog = new DlgCariTagihanECT(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        tanggal="  ect.tgl_operasi between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+" 00:00:00' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+" 23:59:59' ";
        mem="";      
        ...
        if(!NoRawat.getText().equals("")){
            norawat=" and ect.no_rawat='"+NoRawat.getText()+"' ";
        }
        
        if(TCari.getText().trim().equals("")&&kdmem.getText().trim().equals("")&&NoRawat.getText().trim().equals("")){
            sql="select ect.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,ect.jenis_anasthesi,"+
                "ect.tgl_operasi from ect inner join reg_periksa on ect.no_rawat=reg_periksa.no_rawat "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                " where "+tanggal+" group by ect.no_rawat,ect.tgl_operasi order by ect.tgl_operasi,ect.no_rawat ";
        }else{
            sql="select ect.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,ect.jenis_anasthesi,"+
                "ect.tgl_operasi from ect inner join reg_periksa on ect.no_rawat=reg_periksa.no_rawat "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                " where "+tanggal+mem+norawat+" and ect.no_rawat like '%"+TCari.getText()+"%' or "+
                ...
                tanggal+mem+norawat+" and ect.tgl_operasi like '%"+TCari.getText()+"%' or "+
                tanggal+mem+norawat+" and ect.jenis_anasthesi like '%"+TCari.getText()+"%'  "+                   
                " group by ect.no_rawat,ect.tgl_operasi order by ect.tgl_operasi,ect.no_rawat ";
        }
        ...
        try{
            ...
            while(rs.next()){
                ...
                rs2=koneksi.prepareStatement(
                        ...
                        "ect.dokter_anestesi, ect.asisten_anestesi,ect.asisten_anestesi2, ect.bidan, ect.bidan2, ect.bidan3, ect.perawat_luar, "+
                        "ect.omloop,ect.omloop2,ect.omloop3,ect.omloop4,ect.omloop5,ect.dokter_pjanak,ect.dokter_umum,"+
                        "ect.kode_paket,paket_ect.nm_perawatan, ect.biayaoperator1, ect.biayaoperator2, ect.biayaoperator3, "+
                        "ect.biayaasisten_operator1, ect.biayaasisten_operator2,ect.biayaasisten_operator3, ect.biayainstrumen, "+
                        "ect.biayadokter_anak, ect.biayaperawaat_resusitas, ect.biayadokter_anestesi, "+
                        "ect.biayaasisten_anestesi,ect.biayaasisten_anestesi2, ect.biayabidan,ect.biayabidan2,ect.biayabidan3, ect.biayaperawat_luar, ect.biayaalat,"+
                        "ect.biayasewaok,ect.akomodasi,ect.bagian_rs,ect.biaya_omloop,ect.biaya_omloop2,"+
                        "ect.biaya_omloop3,ect.biaya_omloop4,ect.biaya_omloop5,ect.biayasarpras,ect.biaya_dokter_pjanak,ect.biaya_dokter_umum,"+
                        "(ect.biayaoperator1+ect.biayaoperator2+ect.biayaoperator3+"+
                        "ect.biayaasisten_operator1+ect.biayaasisten_operator2+ect.biayaasisten_operator3+ect.biayainstrumen+"+
                        "ect.biayadokter_anak+ect.biayaperawaat_resusitas+ect.biayadokter_anestesi+"+
                        "ect.biayaasisten_anestesi+ect.biayaasisten_anestesi2+ect.biayabidan+ect.biayabidan2+ect.biayabidan3+"+
                        "ect.biayaperawat_luar+ect.biayaalat+ect.biaya_dokter_pjanak+ect.biaya_dokter_umum+"+
                        "ect.biayasewaok+ect.akomodasi+ect.bagian_rs+ect.biaya_omloop+ect.biaya_omloop2+ect.biaya_omloop3+ect.biaya_omloop4+ect.biaya_omloop5+ect.biayasarpras) as total from ect inner join paket_ect "+
                        "on ect.kode_paket=paket_ect.kode_paket where ect.no_rawat='"+rs.getString("no_rawat")+"' and ect.tgl_operasi='"+rs.getString("tgl_operasi")+"'").executeQuery();
                no=1;
                while(rs2.next()){
