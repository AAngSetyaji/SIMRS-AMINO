        ...
        if(tabMode.getRowCount()!=0){
            if(tbDokter.getSelectedRow()>-1){
                try {
                    ...
                    ps=koneksi.prepareStatement(
                            "select template_pemeriksaan_dokter_tindakan.kd_jenis_prw,jns_perawatan.nm_perawatan,kategori_perawatan.nm_kategori,jns_perawatan.total_byrdrpr,jns_perawatan.bhp,jns_perawatan.material,"+
                    ...
                    try {
                        ...
                        while(rs.next()){
                            TabModeTindakan.addRow(new Object[]{
                                rs.getString("kd_jenis_prw"),rs.getString("nm_perawatan"),rs.getString("nm_kategori"),rs.getDouble("total_byrdrpr"),
                    ...
                    if(TabModeTindakan.getRowCount()>0){
                        ...
                        for(i=0;i<tbTindakan.getRowCount();i++){ 
                            if(Sequel.menyimpantf2("rawat_jl_drpr","?,?,?,?,?,?,?,?,?,?,?,?,?,?","Tindakan/Pemeriksaan "+tbTindakan.getValueAt(i,1).toString(),14,new String[]{
                                    ...
                                    tbTindakan.getValueAt(i,5).toString(),tbTindakan.getValueAt(i,6).toString(),"0",tbTindakan.getValueAt(i,7).toString(), 
