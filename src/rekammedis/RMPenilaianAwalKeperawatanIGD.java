...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-09-2023 09:13:00" }));
        ...
        if(TNoRM.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(akses.getkode().equals("Admin Utama")){
                    ...
                    if(KdPetugas.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),87).toString())){
                        ganti();
                    }else{
