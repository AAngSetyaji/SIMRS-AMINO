 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalKeperawatanRalanPsikiatriDewasa extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalKeperawatanRalanPsikiatriDewasa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        KetAlergiObat.setDocument(new batasInput((int)100).getKata(KetAlergiObat));
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-09-2023 10:03:41" }));
...
//        Ekonomi Finansial
        ...
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_ralan_psikiatri_dewasa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",143,new String[]{
...
//                    KebutuhanKomunikasi
                    ...
                    for (i = 0; i < tbRencanaEtiologi.getRowCount(); i++) {
                        if(tbRencanaEtiologi.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ralan_etiologi_psikiatri","?,?",2,new String[]{TNoRw.getText(),tbRencanaEtiologi.getValueAt(i,1).toString()});
                        }
                    }
                    for (i = 0; i < tbRencanaLuaran.getRowCount(); i++) {
                        if(tbRencanaLuaran.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ralan_luaran_psikiatri","?,?",2,new String[]{TNoRw.getText(),tbRencanaLuaran.getValueAt(i,1).toString()});
                        }
                    }
                    emptTeks();
            }
            ...
            try{
                if(TCari.getText().equals("")){
                    ps=koneksi.prepareStatement(
                            ...
                            "penilaian_awal_keperawatan_ralan_psikiatri_dewasa.ket_kk_kebutuhan_edukasi,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.rencana,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.nip,petugas.nama "+
                            ...
                            "penilaian_awal_keperawatan_ralan_psikiatri_dewasa.tanggal between ? and ? order by penilaian_awal_keperawatan_ralan_psikiatri_dewasa.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.tanggal,"+
                            "penilaian_awal_keperawatan_ralan_psikiatri_dewasa.informasi,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.keluhan_utama,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.rkd_sakit_sejak,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.rkd_keluhan,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.rkd_berobat,penilaian_awal_keperawatan_ralan_psikiatri_dewasa.rkd_hasil_pengobatan,"+
                            ...
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_ralan_psikiatri_dewasa.tanggal between ? and ? and "+
                            "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "penilaian_awal_keperawatan_ralan_psikiatri_dewasa.nip like ? or petugas.nama like ?) "+
                            "order by penilaian_awal_keperawatan_ralan_psikiatri_dewasa.tanggal");
                }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanRalanPsikiatriDewasa dialog = new RMPenilaianAwalKeperawatanRalanPsikiatriDewasa(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_kep_ralan_psikiatri_dewasa());
        BtnHapus.setEnabled(akses.getpenilaian_kep_ralan_psikiatri_dewasa());
        BtnEdit.setEnabled(akses.getpenilaian_kep_ralan_psikiatri_dewasa());
        BtnEdit.setEnabled(akses.getpenilaian_kep_ralan_psikiatri_dewasa());
    ...
    private void tampilEtiologi() {
        try{
            file=new File("./cache/rencanaetiologipsikiatridewasa.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ...
            fileWriter.write("{\"rencanaetiologipsikiatridewasa\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilEtiologi2() {
        try{
            ...
            myObj = new FileReader("./cache/rencanaetiologipsikiatridewasa.iyem");
            root = mapper.readTree(myObj);
            response = root.path("rencanaetiologipsikiatridewasa");
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
     ...
     private void tampilLuaran() {
        try{
            file=new File("./cache/rencanaluaranpsikiatridewasa.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ...
            fileWriter.write("{\"rencanaluaranpsikiatridewasa\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilLuaran2() {
        try{
            ...
            myObj = new FileReader("./cache/rencanaluaranpsikiatridewasa.iyem");
            root = mapper.readTree(myObj);
            response = root.path("rencanaluaranpsikiatridewasa");
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_keperawatan_ralan_psikiatri_dewasa where no_rawat=?",1,new String[]{
            ...
            Sequel.meghapus("penilaian_awal_keperawatan_ralan_etiologi_psikiatri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ralan_luaran_psikiatri","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
            Valid.tabelKosong(tabModeDetailMasalah);
            Valid.tabelKosong(tabModeDetailRencana);
