    ...
    private void tampil2() {
        ...
        try{
            ...
            ps=koneksi.prepareStatement("select resep_obat_pulang.no_resep,resep_obat_pulang.tgl_peresepan,resep_obat_pulang.jam_peresepan,"+
                    ...
                    " resep_obat_pulang.status,resep_obat_pulang.tgl_perawatan,resep_obat_pulang.jam "+
                    ...
                    " resep_obat_pulang.tgl_peresepan<>'0000-00-00' and resep_obat_pulang.tgl_perawatan<>'0000-00-00' and resep_obat_pulang.tgl_peresepan between ? and ? "+
                    (TCari.getText().trim().equals("")?"":"and (resep_obat_pulang.no_resep like ? or resep_obat_pulang.no_rawat like ? or "+
                    "pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or resep_obat_pulang.kd_dokter like ? or dokter.nm_dokter like ? or "+
                    "resep_obat_pulang.status like ?) ")+"order by resep_obat_pulang.tgl_perawatan,resep_obat_pulang.jam desc");
            try {
                ps.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
