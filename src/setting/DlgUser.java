...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[J]ICD 10","[J]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[M]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                ...
                "[M]Check List Kriteria Keluar ICU","[A]Akses Ke Dokter Lain Rawat Jalan","[M]Follow Up DBD", "[M]Penilaian Awal Medis Rajal Psikiatri Anak / Remaja", "[M]Penilaian Awal Keperawatan Rajal Psikiatri Anak / Remaja",
                "[M]Penilaian Awal Keperawatan Rajal Psikiatri Dewasa","[M]Penilaian Awal Keperawatan Rajal Psikiatri Geriatri","[M]Penilaian PANSS-EC", "[M]Penilaian Awal Medis Ranap Psikiatri Anak / Remaja",
                "[M]Penilaian Awal Keperawatan Ranap Psikiatri Anak / Remaja","[M]Penilaian Awal Keperawatan Ranap Psikiatri Dewasa","[M]Penilaian Awal Keperawatan Ranap Psikiatri Geriatri","[M]Penilaian Awal Medis Ralan Psikiatri Geriatri",
                "[M]Penilaian Awal Medis Ranap Psikiatri Geriatri",
                ...
                "[M]Penilaian Lanjutan Risiko Jatuh Geriatri","[M]Penilaian Lanjutan Risiko Jatuh Psikiatri","[M]Penilaian Risiko Jatuh Neonatus","[A]Permintaan ECT","[A]Tindakan ECT",
                "[M]Pemeriksaan Psikologi Dewasa","[M]Peemeriksaan Psikolog Anak","[M]Penilaian Aktivitas Kelompok","[M]Persetujuan Terapi Rehab","[M]Penilaian Awal Psikologi Rawat Inap","[M]Formulir Memperoleh Pelayanan Kerohanian","[M]Pemantauan EWS Neonatus","[T]Transaksi Non Pasien",
                "[L]Satu Klik Klaim","[J]READMISION","[T]Batal Pindah"
        };
        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "penilaian_medis_ralan_psikiatri_anak='"+tbUser.getValueAt(i,963).toString()+"',"+ 
                    "penilaian_kep_ralan_psikiatri_anak='"+tbUser.getValueAt(i,964).toString()+"',"+ 
                    "penilaian_kep_ralan_psikiatri_dewasa='"+tbUser.getValueAt(i,965).toString()+"',"+ 
                    "penilaian_kep_ralan_psikiatri_geriatri='"+tbUser.getValueAt(i,966).toString()+"',"+
                    "panss_ec='"+tbUser.getValueAt(i,967).toString()+"',"+
                    "penilaian_medis_ranap_psikiatri_anak='"+tbUser.getValueAt(i,968).toString()+"',"+
                    "penilaian_kep_ranap_psikiatri_anak='"+tbUser.getValueAt(i,969).toString()+"',"+
                    ...
                    "penilaian_risiko_jatuh_neonatus='"+tbUser.getValueAt(i,981).toString()+"',"+
                    "permintaan_ect='"+tbUser.getValueAt(i,982).toString()+"',"+
                    "tindakan_ect='"+tbUser.getValueAt(i,983).toString()+"',"+
                    "psikolog_dewasa='"+tbUser.getValueAt(i,984).toString()+"',"+
                    "psikolog_anak='"+tbUser.getValueAt(i,985).toString()+"',"+
                    "penilaian_aktivitas_kelompok='"+tbUser.getValueAt(i,986).toString()+"',"+
                    "persetujuan_terapi_rehab='"+tbUser.getValueAt(i,987).toString()+"',"+
                    "penilaian_awal_psikologi_rawat_inap='"+tbUser.getValueAt(i,988).toString()+"',"+
                    "formulir_memperoleh_pelayanan_kerohanian='"+tbUser.getValueAt(i,989).toString()+"',"+
                    "pemantauan_ews_neonatus='"+tbUser.getValueAt(i,990).toString()+"',"+
                    "satu_klik_klaim='"+tbUser.getValueAt(i,992).toString()+"',"+
                    "batal_pindah='"+tbUser.getValueAt(i,994).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "penilaian_medis_ralan_psikiatri_anak='"+tbUser.getValueAt(barisdicopy,963).toString()+"',"+
                                        "penilaian_kep_ralan_psikiatri_anak='"+tbUser.getValueAt(barisdicopy,964).toString()+"',"+
                                        "penilaian_kep_ralan_psikiatri_dewasa='"+tbUser.getValueAt(barisdicopy,965).toString()+"',"+
                                        "penilaian_kep_ralan_psikiatri_geriatri='"+tbUser.getValueAt(barisdicopy,966).toString()+"',"+
                                        "panss_ec='"+tbUser.getValueAt(barisdicopy,967).toString()+"',"+
                                        "penilaian_medis_ranap_psikiatri_anak='"+tbUser.getValueAt(barisdicopy,968).toString()+"',"+
                                        "penilaian_kep_ranap_psikiatri_anak='"+tbUser.getValueAt(barisdicopy,969).toString()+"',"+
                                        ...
                                        "permintaan_ect='"+tbUser.getValueAt(barisdicopy,982).toString()+"',"+
                                        "tindakan_ect='"+tbUser.getValueAt(barisdicopy,983).toString()+"',"+
                                        "psikolog_dewasa='"+tbUser.getValueAt(barisdicopy,984).toString()+"',"+
                                        "psikolog_anak='"+tbUser.getValueAt(barisdicopy,985).toString()+"',"+
                                        "penilaian_aktivitas_kelompok='"+tbUser.getValueAt(barisdicopy,986).toString()+"',"+
                                        "persetujuan_terapi_rehab='"+tbUser.getValueAt(barisdicopy,987).toString()+"',"+
                                        "penilaian_awal_psikologi_rawat_inap='"+tbUser.getValueAt(barisdicopy,988).toString()+"',"+
                                        "formulir_memperoleh_pelayanan_kerohanian='"+tbUser.getValueAt(barisdicopy,989).toString()+"',"+
                                        "pemantauan_ews_neonatus='"+tbUser.getValueAt(barisdicopy,990).toString()+"',"+
                                        "satu_klik_klaim='"+tbUser.getValueAt(barisdicopy,992).toString()+"',"+
                                        "batal_pindah='"+tbUser.getValueAt(barisdicopy,992).toString()+"'");
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
    ...
    private void tampil() {        
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.penilaian_aktivitas_kelompok,user.persetujuan_terapi_rehab,user.penilaian_awal_psikologi_rawat_inap,user.formulir_memperoleh_pelayanan_kerohanian,user.psikolog_anak,user.pemantauan_ews_neonatus,user.trans_non_pas,user.satu_klik_klaim,user.readmision_ranap,user.batal_pindah "+        
                    ...
                    try {
                        if(rs.getString(1).toLowerCase().contains(TCari.getText().toLowerCase())||
                            ...
                            tabMode.addRow(new Object[]{rs.getString(1),
                               ...
                               rs.getBoolean("penilaian_medis_ralan_psikiatri_anak"),
                               rs.getBoolean("penilaian_kep_ralan_psikiatri_anak"),
                               rs.getBoolean("penilaian_kep_ralan_psikiatri_dewasa"),
                               rs.getBoolean("penilaian_kep_ralan_psikiatri_geriatri"),
                               rs.getBoolean("panss_ec"),
                               rs.getBoolean("penilaian_medis_ranap_psikiatri_anak"),
                               rs.getBoolean("penilaian_kep_ranap_psikiatri_anak"),
                               rs.getBoolean("penilaian_kep_ranap_psikiatri_dewasa"),
                               rs.getBoolean("penilaian_kep_ranap_psikiatri_geriatri"),
                               rs.getBoolean("penilaian_medis_ralan_psikiatri_geriatri"),
                               rs.getBoolean("penilaian_medis_ranap_psikiatri_geriatri"),
                               rs.getBoolean("penilaian_medis_ralan_psikiatri_dewasa"),
                               ...
                               rs.getBoolean("permintaan_ect"),
                               rs.getBoolean("tindakan_ect"),
                               rs.getBoolean("psikolog_dewasa"),
                               rs.getBoolean("psikolog_anak"),
                               rs.getBoolean("penilaian_aktivitas_kelompok"),
                               ...
                               rs.getBoolean("satu_klik_klaim"),
                               rs.getBoolean("readmision_ranap"),
                               rs.getBoolean("batal_pindah")
                            });
                        }   
                    } catch (Exception e) {
                        tabMode.addRow(new Object[]{rs.getString(1),
