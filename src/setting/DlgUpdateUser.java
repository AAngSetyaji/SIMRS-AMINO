...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,tindakan_ralan=false,kamar_inap=false,
            ...
            checklist_kriteria_masuk_icu=false,checklist_kriteria_keluar_icu=false,akses_dokter_lain_rawat_jalan=false,follow_up_dbd=false,penilaian_medis_ralan_psikiatri_anak=false,penilaian_kep_ralan_psikiatri_anak=false,
    ...
    */
    ...
    private void tampil(String user) {  
        ...
        penilaian_awal_keperawatan_ralan_geriatri=false;master_masalah_keperawatan_geriatri=false;master_rencana_keperawatan_geriatri=false;checklist_kriteria_masuk_hcu=false;checklist_kriteria_keluar_hcu=false;
        penilaian_risiko_dekubitus=false;master_menolak_anjuran_medis=false;penolakan_anjuran_medis=false;laporan_tahunan_penolakan_anjuran_medis=false;template_laporan_operasi=false;hasil_tindakan_eswl=false;
        checklist_kriteria_masuk_icu=false;checklist_kriteria_keluar_icu=false;akses_dokter_lain_rawat_jalan=false;follow_up_dbd=false;penilaian_medis_ralan_psikiatri_anak=false;penilaian_kep_ralan_psikiatri_anak=false;penilaian_kep_ralan_psikiatri_dewasa=false;
        ...
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                + "user.psikolog_anak,user.penilaian_aktivitas_kelompok,user.persetujuan_terapi_rehab,user.penilaian_awal_psikologi_rawat_inap,user.formulir_memperoleh_pelayanan_kerohanian,user.pemantauan_ews_neonatus,user.trans_non_pas,user.satu_klik_klaim "+
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    penilaian_aktivitas_kelompok=rs.getBoolean("penilaian_aktivitas_kelompok");
                    persetujuan_terapi_rehab=rs.getBoolean("persetujuan_terapi_rehab");
                    ...
                    trans_non_pas=rs.getBoolean("trans_non_pas");satu_klik_klaim=rs.getBoolean("satu_klik_klaim");
                    setTampil();
                }       
    ...
    private void setTampil(){
        ...
        if("[A]Permintaan ECT".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Permintaan ECT",permintaan_ect});
        }
        
        if("[A]Tindakan ECT".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[A]Tindakan ECT",tindakan_ect});
        }
        ...
        if("[M]Penilaian Awal Medis Ralan Psikiatri Anak / Remaja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Psikiatri Anak / Remaja",penilaian_medis_ralan_psikiatri_anak});
        }
        
        if("[M]Penilaian Awal Kep. Ralan Psikiatri Anak / Remaja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Kep. Ralan Psikiatri Anak / Remaja",penilaian_kep_ralan_psikiatri_anak});
        }
        
        if("[M]Penilaian Awal Kep. Ralan Psikiatri Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Kep. Ralan Psikiatri Dewasa",penilaian_kep_ralan_psikiatri_dewasa});
        }
        
        if("[M]Penilaian Awal Kep. Ralan Psikiatri Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Kep. Ralan Psikiatri Geriatri",penilaian_kep_ralan_psikiatri_geriatri});
        }
        
        if("[M]Penilaian PANSS-EC".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian PANSS-EC",panss_ec});
        }
        
        if("[M]Penilaian Awal Medis Ranap Psikiatri Anak / Remaja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ranap Psikiatri Anak / Remaja",penilaian_medis_ranap_psikiatri_anak});
        }
        
        if("[M]Penilaian Awal Kep. Ranap Psikiatri Anak / Remaja".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Kep. Ranap Psikiatri Anak / Remaja",penilaian_kep_ranap_psikiatri_anak});
        }
        ...
        if("[M]Penilaian Awal Medis Ralan Psikiatri Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Psikiatri Geriatri",penilaian_medis_ralan_psikiatri_geriatri});
        }
        
        if("[M]Penilaian Awal Medis Ranap Psikiatri Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())){
        ...
        if("[M]Penilaian Awal Medis Ranap Psikiatri Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ranap Psikiatri Dewasa",penilaian_medis_ranap_psikiatri_dewasa});
        }
        
        if("[M]Penilaian Awal Medis Ralan Psikiatri Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Medis Ralan Psikiatri Dewasa",penilaian_medis_ralan_psikiatri_dewasa});
        }
        
        if("[M]Penilaian ADL Barthel Index".toLowerCase().contains(TCari.getText().toLowerCase())){
        ...
        if("[M]Pemeriksaan Psikologi Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())){
        ...
        if("[M]Penilaian Aktivitas Kelompok".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Aktivitas Kelompok",penilaian_aktivitas_kelompok});
        }
        if("[M]Persetujuan Terapi Rehab".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Persetujuan Terapi Rehab",persetujuan_terapi_rehab});
        }
        if("[M]Penilaian Awal Psikologi Rawat Inap".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Penilaian Awal Psikologi Rawat Inap",penilaian_awal_psikologi_rawat_inap});
        }
        if("[M]Formulir Memperoleh Pelayanan Kerohanian".toLowerCase().contains(TCari.getText().toLowerCase())){
            tabMode.addRow(new Object[]{false,"[M]Formulir Memperoleh Pelayanan Kerohanian",formulir_memperoleh_pelayanan_kerohanian});
        }
    ...
    private void Simpan() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[A]Permintaan ECT".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","permintaan_ect='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[A]Tindakan ECT".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","tindakan_ect='"+tbUser.getValueAt(i,2).toString()+"'");
            }
    ...
    private void Simpan2() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[M]Penilaian Awal Medis Ralan Psikiatri Anak / Remaja".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_medis_ralan_psikiatri_anak='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Kep. Ralan Psikiatri Anak / Remaja".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_kep_ralan_psikiatri_anak='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Kep. Ralan Psikiatri Dewasa".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_kep_ralan_psikiatri_dewasa='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Kep. Ralan Psikiatri Geriatri".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_kep_ralan_psikiatri_geriatri='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            ...
            if("[M]Penilaian Awal Medis Ranap Psikiatri Anak / Remaja".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_medis_ranap_psikiatri_anak='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Kep. Ranap Psikiatri Anak / Remaja".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_kep_ranap_psikiatri_anak='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Kep. Ranap Psikiatri Dewasa".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_kep_ranap_psikiatri_dewasa='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            if("[M]Penilaian Awal Medis Ranap Psikiatri Dewasa".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_medis_ranap_psikiatri_dewasa='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Kep. Ranap Psikiatri Geriatri".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_kep_ranap_psikiatri_geriatri='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Medis Ralan Psikiatri Geriatri".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_medis_ralan_psikiatri_geriatri='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian Awal Medis Ranap Psikiatri Geriatri".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_medis_ranap_psikiatri_geriatri='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            ...
            if("[M]Penilaian Awal Medis Ralan Psikiatri Dewasa".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_medis_ralan_psikiatri_dewasa='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Penilaian ADL Barthel Index".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","penilaian_barthel_index='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            ...
            if("[M]Pemeriksaan Psikologi Dewasa".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","psikolog_dewasa='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            ...
            if("[M]Formulir Memperoleh Pelayanan Kerohanian".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","formulir_memperoleh_pelayanan_kerohanian='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            
            if("[M]Pemantauan EWS Neonatus".equals(tbUser.getValueAt(i,1).toString())){
