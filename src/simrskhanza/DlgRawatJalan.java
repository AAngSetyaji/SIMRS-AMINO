...
import rekammedis.RMPenilaianAwalKeperawatanRalanPsikiatriDewasa;
import rekammedis.RMPenilaianAwalKeperawatanRalanPsikiatriAnakRemajaJiwa;
...
import rekammedis.RMPenilaianAwalMedisRalanPsikiatrikAnakRemajaJiwa;
...
import simrskhanza.DlgResJatuh;
...
import rekammedis.RMPenilaianAwalKeperawatanRalanPsikiatriGeriatri;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private double ttljmdokter=0,ttljmperawat=0,ttlkso=0,ttljasasarana=0,ttlbhp=0,ttlmenejemen=0,ttlpendapatan=0,hsl1=0,hsl2=0;
...
//        TabRawat.setSelectedComponent(internalFrame5);
    ...
    private void initComponents() {
        ...
        BtnAwalKeperawatanPsikiatriAnakRemaja = new widget.Button();
        BtnAwalKeperawatanPsikiatriDewasa = new widget.Button();
        BtnAwalKeperawatanPsikiatriGeriatri = new widget.Button();
        ...
        BtnAwalMedisPsikiatriAnakRemaja = new widget.Button();
        BtnAwalMedisPsikiatriDewasa = new widget.Button();
        BtnAwalMedisPsikiatriGeriatri = new widget.Button();
        ...
        BtnAwalMedisGeriatriUmum = new widget.Button();
        ...
        TabRawat.setPreferredSize(new java.awt.Dimension(800, 708));
        ...
        TPerawat2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TPerawat2ActionPerformed(evt);
            }
        });
        ...
        jLabel28.setBounds(470, 40, 70, 23);
        ...
        Btn5Soap.setBounds(410, 40, 20, 23);
        ...
        Btn5Soap1.setBounds(440, 40, 20, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-12-2023" }));
        ...
        BtnAwalKeperawatanPsikiatriAnakRemaja.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriAnakRemaja.setText("Awal Kep. Psikiatri Anak/Remaja");
        BtnAwalKeperawatanPsikiatriAnakRemaja.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriAnakRemaja.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriAnakRemaja.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriAnakRemaja.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriAnakRemaja.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriAnakRemaja.setName("BtnAwalKeperawatanPsikiatriAnakRemaja"); // NOI18N
        BtnAwalKeperawatanPsikiatriAnakRemaja.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriAnakRemaja.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriAnakRemaja.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriAnakRemajaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriAnakRemaja);

        BtnAwalKeperawatanPsikiatriDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasa.setText("Awal Kep. Psikiatri Dewasa");
        BtnAwalKeperawatanPsikiatriDewasa.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriDewasa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasa.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriDewasa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriDewasa.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriDewasa.setName("BtnAwalKeperawatanPsikiatriDewasa"); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasa.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriDewasa.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriDewasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriDewasaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriDewasa);

        BtnAwalKeperawatanPsikiatriGeriatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriGeriatri.setText("Awal Kep. Psikiatri Geriatri");
        BtnAwalKeperawatanPsikiatriGeriatri.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriGeriatri.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriGeriatri.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriGeriatri.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriGeriatri.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriGeriatri.setName("BtnAwalKeperawatanPsikiatriGeriatri"); // NOI18N
        BtnAwalKeperawatanPsikiatriGeriatri.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriGeriatri.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriGeriatri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriGeriatriActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriGeriatri);

        BtnAwalKeperawatanGeriatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanGeriatri.setText("Awal Keperawatan Geriatri Umum");
        ...
        BtnAwalMedisPsikiatriAnakRemaja.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisPsikiatriAnakRemaja.setText("Awal Medis Psikiatri Anak/Remaja");
        BtnAwalMedisPsikiatriAnakRemaja.setFocusPainted(false);
        BtnAwalMedisPsikiatriAnakRemaja.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisPsikiatriAnakRemaja.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisPsikiatriAnakRemaja.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisPsikiatriAnakRemaja.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisPsikiatriAnakRemaja.setName("BtnAwalMedisPsikiatriAnakRemaja"); // NOI18N
        BtnAwalMedisPsikiatriAnakRemaja.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisPsikiatriAnakRemaja.setRoundRect(false);
        BtnAwalMedisPsikiatriAnakRemaja.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisPsikiatriAnakRemajaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisPsikiatriAnakRemaja);

        BtnAwalMedisPsikiatriDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisPsikiatriDewasa.setText("Awal Medis Psikiatri Dewasa");
        BtnAwalMedisPsikiatriDewasa.setFocusPainted(false);
        BtnAwalMedisPsikiatriDewasa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisPsikiatriDewasa.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisPsikiatriDewasa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisPsikiatriDewasa.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisPsikiatriDewasa.setName("BtnAwalMedisPsikiatriDewasa"); // NOI18N
        BtnAwalMedisPsikiatriDewasa.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisPsikiatriDewasa.setRoundRect(false);
        BtnAwalMedisPsikiatriDewasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisPsikiatriDewasaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisPsikiatriDewasa);

        BtnAwalMedisPsikiatriGeriatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisPsikiatriGeriatri.setText("Awal Medis Psikiatri Geriatri");
        BtnAwalMedisPsikiatriGeriatri.setFocusPainted(false);
        BtnAwalMedisPsikiatriGeriatri.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisPsikiatriGeriatri.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisPsikiatriGeriatri.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisPsikiatriGeriatri.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisPsikiatriGeriatri.setName("BtnAwalMedisPsikiatriGeriatri"); // NOI18N
        BtnAwalMedisPsikiatriGeriatri.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisPsikiatriGeriatri.setRoundRect(false);
        BtnAwalMedisPsikiatriGeriatri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisPsikiatriGeriatriActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisPsikiatriGeriatri);
        ...
        BtnAwalMedisPenyakitDalam.setPreferredSize(new java.awt.Dimension(192, 23));
        ...
        BtnAwalMedisGeriatriUmum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisGeriatriUmum.setText("Awal Medis Geriatri Umum");
        BtnAwalMedisGeriatriUmum.setFocusPainted(false);
        BtnAwalMedisGeriatriUmum.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisGeriatriUmum.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisGeriatriUmum.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisGeriatriUmum.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisGeriatriUmum.setName("BtnAwalMedisGeriatriUmum"); // NOI18N
        BtnAwalMedisGeriatriUmum.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisGeriatriUmum.setRoundRect(false);
        BtnAwalMedisGeriatriUmum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisGeriatriUmumActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisGeriatriUmum);
        ...
        ScrollMenu.getAccessibleContext().setAccessibleName("");
        ScrollMenu.getAccessibleContext().setAccessibleDescription("");
...
//                }   break;
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        ...
        pasien.dispose();
        try {
            i=JOptionPane.showConfirmDialog(null, "Pasien selesai diperiksa ?? Silahkan klik Yes kirim Status BPJS","Konfirmasi",JOptionPane.YES_NO_OPTION);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnAwalMedisPsikiatriDewasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisPsikiatriDewasaActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnAwalMedisPsikiatriDewasaActionPerformed
    ...
    private void BtnAwalMedisPenyakitDalamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisPenyakitDalamActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRalanGeriatriPenyakitDalamJiwa form=new RMPenilaianAwalMedisRalanGeriatriPenyakitDalamJiwa(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void BtnAwalKeperawatanPsikiatriDewasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriDewasaActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanRalanPsikiatriDewasa form=new RMPenilaianAwalKeperawatanRalanPsikiatriDewasa(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriDewasaActionPerformed
    ...
    private void BtnAwalMedisGeriatriUmumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisGeriatriUmumActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnAwalMedisGeriatriUmumActionPerformed
    ...
    private void BtnAwalKeperawatanPsikiatriAnakRemajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriAnakRemajaActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanRalanPsikiatriAnakRemajaJiwa form=new RMPenilaianAwalKeperawatanRalanPsikiatriAnakRemajaJiwa(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriAnakRemajaActionPerformed

    private void BtnAwalMedisPsikiatriAnakRemajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisPsikiatriAnakRemajaActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRalanPsikiatrikAnakRemajaJiwa form=new RMPenilaianAwalMedisRalanPsikiatrikAnakRemajaJiwa(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalMedisPsikiatriAnakRemajaActionPerformed

    private void BtnAwalKeperawatanPsikiatriGeriatriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriGeriatriActionPerformed
       if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanRalanPsikiatriGeriatri form=new RMPenilaianAwalKeperawatanRalanPsikiatriGeriatri(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriGeriatriActionPerformed

    private void BtnAwalMedisPsikiatriGeriatriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisPsikiatriGeriatriActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRalanPsikiatrikGeriatri form=new RMPenilaianAwalMedisRalanPsikiatrikGeriatri(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalMedisPsikiatriGeriatriActionPerformed

    private void TPerawat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TPerawat2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TPerawat2ActionPerformed
    ...
    private void BtnOksigenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOksigenActionPerformed
        if (TabRawat.getSelectedIndex() != 0) {
            ...
            if (selectedRow >= 0) {
                if (tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("SW0011") || tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("SW0012") || tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("SW0050") || tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("SW0051") || tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("SW0049")) {
                    ...
                    String cekbiaya = tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString();
                    Sequel.cariIsi("select jns_perawatan_inap.total_byrdrpr from jns_perawatan_inap where jns_perawatan_inap.kd_jenis_prw=? ",biaya,cekbiaya);
//                    biaya.setText(tbRawatDrPr.getValueAt(selectedRow, 11).toString());
                    Tambah.setLocationRelativeTo(internalFrame1);
                    Tambah.setVisible(true);
                } 
//                else if ( tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGI138") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGI139") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGI238") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGI239") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGIV38") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGIV39") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGT038") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TGT039") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TM0040") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TN1012") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TN1652") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TN194") ||
//                         tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TNV112") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TPV112") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TS1012") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TTG038") ||  tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("TTG039") || tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString().contains("IGD008")){
//                    label5.setText("jahitan");
//                    norawat.setText(tbRawatDrPr.getValueAt(selectedRow, 1).toString());
//                    norm.setText(tbRawatDrPr.getValueAt(selectedRow, 2).toString());
//                    namapasien.setText(tbRawatDrPr.getValueAt(selectedRow, 3).toString());
//                    namaperawatan.setText(tbRawatDrPr.getValueAt(selectedRow, 4).toString());
//                    Sequel.cariIsi("select jns_perawatan_inap.total_byrdrpr from jns_perawatan_inap where jns_perawatan_inap.kd_jenis_prw=? ",biaya, tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),12).toString());
////                    biaya.setText(tbRawatDrPr.getValueAt(selectedRow, 11).toString());
//                    Tambah.setLocationRelativeTo(internalFrame1);
//                    Tambah.setVisible(true);
//                }
    ...
    private void buttonBig2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBig2ActionPerformed
        int selectedRow = tbRawatDrPr.getSelectedRow();
        if (tbRawatDrPr.getValueAt(selectedRow, 12).toString().contains("SW0011") || tbRawatDrPr.getValueAt(selectedRow, 12).toString().contains("SW0012") || tbRawatDrPr.getValueAt(selectedRow, 12).toString().contains("SW0049") || tbRawatDrPr.getValueAt(selectedRow, 12).toString().contains("SW0050") || tbRawatDrPr.getValueAt(selectedRow, 12).toString().contains("SW0051")) {
            if(Sequel.mengedittf("rawat_jl_drpr","no_rawat=? and kd_jenis_prw=? and tgl_perawatan=? and jam_rawat=?","no_rawat=?,biaya_rawat=?,material=?,tarif_tindakandr=?",8,new String[]{
                norawat.getText(),hasil.getText(),Double.toString(hsl2),Double.toString(hsl1),
                tbRawatDrPr.getValueAt(selectedRow,1).toString(),
                tbRawatDrPr.getValueAt(selectedRow, 12).toString(),
                tbRawatDrPr.getValueAt(selectedRow,9).toString(),
                tbRawatDrPr.getValueAt(selectedRow,10).toString(),
            })==true){
    ...
    */
    ...
    private widget.Button BtnAwalKeperawatanPsikiatriAnakRemaja;
    private widget.Button BtnAwalKeperawatanPsikiatriDewasa;
    private widget.Button BtnAwalKeperawatanPsikiatriGeriatri;
    ...
    private widget.Button BtnAwalMedisGeriatriUmum;
    ...
    private widget.Button BtnAwalMedisPsikiatriAnakRemaja;
    private widget.Button BtnAwalMedisPsikiatriDewasa;
    private widget.Button BtnAwalMedisPsikiatriGeriatri;
    ...
    public void isCek(){
        ...
        BtnAwalKeperawatanPsikiatriDewasa.setVisible(akses.getpenilaian_awal_keperawatan_psikiatri());
        ...
        BtnAwalMedisPsikiatriDewasa.setVisible(akses.getpenilaian_awal_medis_ralan_psikiatri()); 
        ...
        BtnAwalMedisGeriatriUmum.setVisible(akses.getpenilaian_awal_medis_ralan_geriatri());
