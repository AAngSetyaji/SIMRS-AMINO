 ...
 * @author perpustakaan
 */
public final class DlgResikoJatuhEdmonson extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgResikoJatuhEdmonson(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-03-2023 07:06:58" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgResikoJatuhEdmonson dialog = new DlgResikoJatuhEdmonson(new javax.swing.JFrame(), true);
