 ...
 * @author perpustakaan
 */
public final class RMPenilaianPreOperasiECT extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianPreOperasiECT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-10-2023 09:13:28" }));
        ...
        jLabel112.setText("IV. Diagnosa Pre ECT :");
        ...
        jLabel113.setText("V. Rencana ECT :");
        ...
        jLabel115.setText("VII. Terapi Pre ECT :");
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Penilaian Pre Operasi ECT ]::");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_pre_op_ect","?,?,?,?,?,?,?,?,?,?","No.Rawat, Tanggal & Jam",10,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianPreOperasiECT dialog = new RMPenilaianPreOperasiECT(new javax.swing.JFrame(), true);
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_pre_op_ect","no_rawat=? and tgl=?","no_rawat=?,tgl=?,kd_dokter=?,r_klinik=?,p_fisik=?,p_diagnostik=?,diag_pre_op=?,rencana=?,hal=?,terapi=?",12,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                RingkasanKlinik.getText(),PemeriksaanFisik.getText(),PemeriksaanDiagnostik.getText(),DiagnosaPreOperasi.getText(),RencanaTindakanBedah.getText(), 
