 ...
 * @author dosen
 */
public final class DlgCariBHPLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariBHPLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariBHPLab dialog = new DlgCariBHPLab(new javax.swing.JFrame(), true);
