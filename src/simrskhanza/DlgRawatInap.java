...
import rekammedis.RMPenilaianAwalKeperawatanGigiRanap;
import rekammedis.RMPenilaianAwalKeperawatanBayiAnakRanap;
import rekammedis.RMPenilaianAwalKeperawatanPsikiatriDewasaRanap;
...
import rekammedis.RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri;
import rekammedis.RMPenilaianAwalKeperawatanRanapPsikiatriDewasa;
import rekammedis.RMPenilaianAwalKeperawatanRanapPsikiatriAnakRemaja;
...
import rekammedis.RMPenilaianAwalMedisRanapPsikiatrikAnakRemajaJiwa;
import rekammedis.RMPenilaianPanssEC;
import rekammedis.RMPenilaianPanssRemisi;
        ...
        petugas1.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(petugas1.getTable().getSelectedRow()!= -1){ 
                    kdptg2.setText(petugas1.getTable().getValueAt(petugas1.getTable().getSelectedRow(),0).toString());
                    TPerawat2.setText(petugas1.getTable().getValueAt(petugas1.getTable().getSelectedRow(),1).toString());   
                    kdptg2.requestFocus();
                }              
            }
            @Override
...
//                            TKdPrwPetugas.requestFocus(); 
    ...
    private void initComponents() {
        ...
        BtnAwalKeperawatanPsikiatriDewasaUmum = new widget.Button();
        BtnAwalKeperawatanGigi = new widget.Button();
        BtnAwalKeperawatanKandungan = new widget.Button();
        BtnAwalKeperawatanBayi = new widget.Button();
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap = new widget.Button();
        BtnAwalKeperawatanPsikiatriDewasaRanap = new widget.Button();
        BtnAwalKeperawatanPsikiatriGeriatriRanap = new widget.Button();
        BtnAwalFisioterapi = new widget.Button();
        BtnAwalMedis = new widget.Button();
        BtnAwalMedisGeriatriRanap = new widget.Button();
        BtnAwalMedisRanapPsikiatriDewasa = new widget.Button();
        BtnAwalMedisBedahMulutRanap = new widget.Button();
        BtnAwalMedisKandungan = new widget.Button();
        BtnAwalMedisBayiAnak = new widget.Button();
        BtnAwalMedisKandungan1 = new widget.Button();
        BtnAwalMedisPsikiatrikGeriatri = new widget.Button();
        BtnPenilaianESRS = new widget.Button();
        ...
        BtnPenilaianAwalBarthelIndex = new widget.Button();
        ...
        BtnAwalKeperawatanKandungan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanKandungan1.setText("Awal Keperawatan Kandungan");
        BtnAwalKeperawatanKandungan1.setFocusPainted(false);
        BtnAwalKeperawatanKandungan1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanKandungan1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanKandungan1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanKandungan1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanKandungan1.setName("BtnAwalKeperawatanKandungan1"); // NOI18N
        BtnAwalKeperawatanKandungan1.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanKandungan1.setRoundRect(false);
        BtnAwalKeperawatanKandungan1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanKandungan1ActionPerformed(evt);
            }
        });
        ...
        panelBiasa1.setPreferredSize(new java.awt.Dimension(520, 350));
        ...
        buttonBig1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.lightGray, java.awt.Color.white, java.awt.Color.darkGray, java.awt.Color.darkGray));
        buttonBig1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/101.png"))); // NOI18N
        buttonBig1.setText("Keluar");
        buttonBig1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        buttonBig1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        buttonBig1.setIconTextGap(8);
        buttonBig1.setName("buttonBig1"); // NOI18N
        buttonBig1.setVerticalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        namaperawatan.setEditable(false);
        namaperawatan.setName("namaperawatan"); // NOI18N

        biaya.setEditable(false);
        biaya.setName("biaya"); // NOI18N

        label1.setText("Nama Perawatan :");
        label1.setName("label1"); // NOI18N

        label2.setText("Biaya :");
        label2.setName("label2"); // NOI18N

        label3.setText("Masukkan Jumlah :");
        ...
        label4.setText("Tekan Enter Setelah Mengisi Quantity");
        label4.setFont(new java.awt.Font("Tahoma", 3, 10)); // NOI18N
        label4.setName("label4"); // NOI18N

        buttonBig2.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.lightGray, java.awt.Color.white, java.awt.Color.darkGray, java.awt.Color.darkGray));
        buttonBig2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/save-16x16.png"))); // NOI18N
        buttonBig2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        buttonBig2.setIconTextGap(8);
        buttonBig2.setName("buttonBig2"); // NOI18N
        buttonBig2.setVerticalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        panelBiasa1Layout.setHorizontalGroup(
            panelBiasa1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
            .addGroup(panelBiasa1Layout.createSequentialGroup()
                .addGroup(panelBiasa1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelBiasa1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addGroup(panelBiasa1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelBiasa1Layout.createSequentialGroup()
                                .addComponent(label1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(namaperawatan, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBiasa1Layout.createSequentialGroup()
                                .addComponent(norawat, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(norm, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBiasa1Layout.createSequentialGroup()
                                ...
                                .addGap(16, 16, 16)
                                .addComponent(label4, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(13, 13, 13))))
                    .addGroup(panelBiasa1Layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(hasil, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelBiasa1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(panelBiasa1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(panelBiasa1Layout.createSequentialGroup()
                                .addComponent(buttonBig1, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(buttonBig2, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(biaya, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(23, 23, 23))
        );
        panelBiasa1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBiasa1Layout.createSequentialGroup()
                ...
                .addGroup(panelBiasa1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(norawat, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addGroup(panelBiasa1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(namaperawatan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Tambah.getContentPane().add(panelBiasa1, java.awt.BorderLayout.CENTER);
        ...
        BtnAll1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        BtnAll1.setMnemonic('M');
        BtnAll1.setText("Oksigen");
        BtnAll1.setToolTipText("Alt+M");
        BtnAll1.setIconTextGap(5);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-12-2023" }));
        ...
        PanelAccor.setPreferredSize(new java.awt.Dimension(300, 43));
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(200, 2800));
        ...
        BtnAwalKeperawatanPsikiatriDewasaUmum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasaUmum.setText("Awal Keperawatan Psikiatri/Umum");
        BtnAwalKeperawatanPsikiatriDewasaUmum.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriDewasaUmum.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasaUmum.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriDewasaUmum.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriDewasaUmum.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriDewasaUmum.setName("BtnAwalKeperawatanPsikiatriDewasaUmum"); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasaUmum.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriDewasaUmum.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriDewasaUmum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriDewasaUmumActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriDewasaUmum);
        ...
        BtnAwalKeperawatanBayi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanBayi.setText("Awal Keperawatan Bayi/Anak");
        BtnAwalKeperawatanBayi.setFocusPainted(false);
        BtnAwalKeperawatanBayi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanBayi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanBayi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanBayi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanBayi.setName("BtnAwalKeperawatanBayiRanap"); // NOI18N
        BtnAwalKeperawatanBayi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanBayi.setRoundRect(false);
        BtnAwalKeperawatanBayi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanBayiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanBayi);

        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setText("Awal Kep. Psikiatri Anak/Remaja");
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setName("BtnAwalKeperawatanPsikiatriAnakRemajaRanap"); // NOI18N
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriAnakRemajaRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriAnakRemajaRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriAnakRemajaRanap);

        BtnAwalKeperawatanPsikiatriDewasaRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasaRanap.setText("Awal Kep. Psikiatri Dewasa");
        BtnAwalKeperawatanPsikiatriDewasaRanap.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriDewasaRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasaRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriDewasaRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriDewasaRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriDewasaRanap.setName("BtnAwalKeperawatanPsikiatriDewasaRanap"); // NOI18N
        BtnAwalKeperawatanPsikiatriDewasaRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriDewasaRanap.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriDewasaRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriDewasaRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriDewasaRanap);

        BtnAwalKeperawatanPsikiatriGeriatriRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setText("Awal Kep. Psikiatri Geriatri");
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setFocusPainted(false);
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setName("BtnAwalKeperawatanPsikiatriGeriatriRanap"); // NOI18N
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalKeperawatanPsikiatriGeriatriRanap.setRoundRect(false);
        BtnAwalKeperawatanPsikiatriGeriatriRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanPsikiatriGeriatriRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanPsikiatriGeriatriRanap);
        ...
        BtnAwalMedisGeriatriRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisGeriatriRanap.setText("Awal Medis Geriatri");
        BtnAwalMedisGeriatriRanap.setFocusPainted(false);
        BtnAwalMedisGeriatriRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisGeriatriRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisGeriatriRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisGeriatriRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisGeriatriRanap.setName("BtnAwalMedisGeriatriRanap"); // NOI18N
        BtnAwalMedisGeriatriRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisGeriatriRanap.setRoundRect(false);
        BtnAwalMedisGeriatriRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisGeriatriRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisGeriatriRanap);

        BtnAwalMedisRanapPsikiatriDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisRanapPsikiatriDewasa.setText("Awal Medis Psikiatri Dewasa");
        BtnAwalMedisRanapPsikiatriDewasa.setFocusPainted(false);
        BtnAwalMedisRanapPsikiatriDewasa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisRanapPsikiatriDewasa.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisRanapPsikiatriDewasa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisRanapPsikiatriDewasa.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisRanapPsikiatriDewasa.setName("BtnAwalMedisRanapPsikiatriDewasa"); // NOI18N
        BtnAwalMedisRanapPsikiatriDewasa.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisRanapPsikiatriDewasa.setRoundRect(false);
        BtnAwalMedisRanapPsikiatriDewasa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisRanapPsikiatriDewasaActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisRanapPsikiatriDewasa);

        BtnAwalMedisBedahMulutRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisBedahMulutRanap.setText("Awal Medis Bedah Mulut");
        BtnAwalMedisBedahMulutRanap.setFocusPainted(false);
        BtnAwalMedisBedahMulutRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisBedahMulutRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisBedahMulutRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisBedahMulutRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisBedahMulutRanap.setName("BtnAwalMedisBedahMulutRanap"); // NOI18N
        BtnAwalMedisBedahMulutRanap.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisBedahMulutRanap.setRoundRect(false);
        BtnAwalMedisBedahMulutRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisBedahMulutRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisBedahMulutRanap);
        ...
        BtnAwalMedisBayiAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisBayiAnak.setText("Awal Medis Bayi/Anak");
        BtnAwalMedisBayiAnak.setFocusPainted(false);
        BtnAwalMedisBayiAnak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisBayiAnak.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisBayiAnak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisBayiAnak.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisBayiAnak.setName("BtnAwalMedisBayiAnak"); // NOI18N
        BtnAwalMedisBayiAnak.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisBayiAnak.setRoundRect(false);
        BtnAwalMedisBayiAnak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisBayiAnakActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisBayiAnak);

        BtnAwalMedisKandungan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisKandungan1.setText("Awal Medis Psikiatri Anak/Remaja");
        BtnAwalMedisKandungan1.setFocusPainted(false);
        BtnAwalMedisKandungan1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisKandungan1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisKandungan1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisKandungan1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisKandungan1.setName("BtnAwalMedisKandungan1"); // NOI18N
        BtnAwalMedisKandungan1.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisKandungan1.setRoundRect(false);
        BtnAwalMedisKandungan1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisKandungan1ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisKandungan1);

        BtnAwalMedisPsikiatrikGeriatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisPsikiatrikGeriatri.setText("Awal Medis Psikiatri Geritari");
        BtnAwalMedisPsikiatrikGeriatri.setFocusPainted(false);
        BtnAwalMedisPsikiatrikGeriatri.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisPsikiatrikGeriatri.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisPsikiatrikGeriatri.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisPsikiatrikGeriatri.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisPsikiatrikGeriatri.setName("BtnAwalMedisPsikiatrikGeriatri"); // NOI18N
        BtnAwalMedisPsikiatrikGeriatri.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisPsikiatrikGeriatri.setRoundRect(false);
        BtnAwalMedisPsikiatrikGeriatri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisPsikiatrikGeriatriActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisPsikiatrikGeriatri);

        BtnPenilaianESRS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPenilaianESRS.setText("Peniliaian Gejala Ekstrapiramidal");
        BtnPenilaianESRS.setFocusPainted(false);
        BtnPenilaianESRS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianESRS.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPenilaianESRS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianESRS.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPenilaianESRS.setName("BtnPenilaianESRS"); // NOI18N
        BtnPenilaianESRS.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPenilaianESRS.setRoundRect(false);
        BtnPenilaianESRS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianESRSActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPenilaianESRS);
        ...
        BtnPenilaianAwalBarthelIndex.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPenilaianAwalBarthelIndex.setText("Assesmen Fungsional ADL Barthel Index");
        BtnPenilaianAwalBarthelIndex.setFocusPainted(false);
        BtnPenilaianAwalBarthelIndex.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianAwalBarthelIndex.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPenilaianAwalBarthelIndex.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianAwalBarthelIndex.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPenilaianAwalBarthelIndex.setName("BtnPenilaianAwalBarthelIndex"); // NOI18N
        BtnPenilaianAwalBarthelIndex.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPenilaianAwalBarthelIndex.setRoundRect(false);
        BtnPenilaianAwalBarthelIndex.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianAwalBarthelIndexActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPenilaianAwalBarthelIndex);
        ...
        BtnPenilaianPANSSEC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPenilaianPANSSEC.setText("Penilaian PANSS-EC");
        BtnPenilaianPANSSEC.setFocusPainted(false);
        BtnPenilaianPANSSEC.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianPANSSEC.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPenilaianPANSSEC.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianPANSSEC.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPenilaianPANSSEC.setName("BtnPenilaianPANSSEC"); // NOI18N
        BtnPenilaianPANSSEC.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPenilaianPANSSEC.setRoundRect(false);
        BtnPenilaianPANSSEC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianPANSSECActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPenilaianPANSSEC);

        BtnPenilaianPanssRemisi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPenilaianPanssRemisi.setText("Penilaian PANSS-REMISI");
        BtnPenilaianPanssRemisi.setFocusPainted(false);
        BtnPenilaianPanssRemisi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenilaianPanssRemisi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPenilaianPanssRemisi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPenilaianPanssRemisi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPenilaianPanssRemisi.setName("BtnPenilaianPanssRemisi"); // NOI18N
        BtnPenilaianPanssRemisi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnPenilaianPanssRemisi.setRoundRect(false);
        BtnPenilaianPanssRemisi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPenilaianPanssRemisiActionPerformed(evt);
            }
        });
...
//        perawatan.dokter.setVisible(true);
    ...
    private void BtnAwalMedisGeriatriRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisGeriatriRanapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnAwalMedisGeriatriRanapActionPerformed

    private void BtnAwalMedisBedahMulutRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisBedahMulutRanapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnAwalMedisBedahMulutRanapActionPerformed

    private void BtnAwalKeperawatanKandungan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanKandungan1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnAwalKeperawatanKandungan1ActionPerformed

    private void BtnAwalKeperawatanPsikiatriGeriatriRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriGeriatriRanapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri form=new RMPenilaianAwalKeperawatanRanapPsikiatriGeriatri(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriGeriatriRanapActionPerformed

    private void BtnAwalKeperawatanPsikiatriAnakRemajaRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriAnakRemajaRanapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanRanapPsikiatriAnakRemaja form=new RMPenilaianAwalKeperawatanRanapPsikiatriAnakRemaja(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriAnakRemajaRanapActionPerformed
    ...
    private void BtnAwalKeperawatanGigiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanGigiActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanGigiRanap form=new RMPenilaianAwalKeperawatanGigiRanap(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void BtnAwalKeperawatanBayiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanBayiActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanBayiAnakRanap form=new RMPenilaianAwalKeperawatanBayiAnakRanap(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
...
// TODO add your handling code here:
    }//GEN-LAST:event_BtnAwalKeperawatanBayiActionPerformed

    private void BtnAwalKeperawatanPsikiatriDewasaUmumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriDewasaUmumActionPerformed
if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanPsikiatriDewasaRanap form=new RMPenilaianAwalKeperawatanPsikiatriDewasaRanap(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
...
// TODO add your handling code here:
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriDewasaUmumActionPerformed

    private void BtnAwalMedisKandungan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisKandungan1ActionPerformed
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapPsikiatrikAnakRemajaJiwa form=new RMPenilaianAwalMedisRanapPsikiatrikAnakRemajaJiwa(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalMedisKandungan1ActionPerformed

    private void BtnAwalKeperawatanPsikiatriDewasaRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanPsikiatriDewasaRanapActionPerformed
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalKeperawatanRanapPsikiatriDewasa form=new RMPenilaianAwalKeperawatanRanapPsikiatriDewasa(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanPsikiatriDewasaRanapActionPerformed

    private void BtnPenilaianPANSSECActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenilaianPANSSECActionPerformed
        // TODO add your handling code here:
         if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianPanssEC form=new RMPenilaianPanssEC(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnPenilaianPANSSECActionPerformed

    private void BtnPenilaianPanssRemisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenilaianPanssRemisiActionPerformed
        // TODO add your handling code here:
         if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianPanssRemisi form=new RMPenilaianPanssRemisi(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnPenilaianPanssRemisiActionPerformed

    private void BtnAwalMedisRanapPsikiatriDewasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisRanapPsikiatriDewasaActionPerformed
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    }//GEN-LAST:event_BtnAwalMedisRanapPsikiatriDewasaActionPerformed

    private void BtnAwalMedisPsikiatrikGeriatriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisPsikiatrikGeriatriActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapPsikiatrikGeriatri form=new RMPenilaianAwalMedisRanapPsikiatrikGeriatri(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnAwalMedisPsikiatrikGeriatriActionPerformed

    private void BtnPenilaianESRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenilaianESRSActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianGejalaEkstrapiramidal form=new RMPenilaianGejalaEkstrapiramidal(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnPenilaianESRSActionPerformed

    private void BtnPenilaianAwalBarthelIndexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenilaianAwalBarthelIndexActionPerformed
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianADLBerthelIndex form=new RMPenilaianADLBerthelIndex(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnPenilaianAwalBarthelIndexActionPerformed
...
if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
    ...
    private void BtnAwalMedisBayiAnakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisBayiAnakActionPerformed
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    private void BtnAll1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAll1ActionPerformed
        ...
        if(tbRawatDrPr.getRowCount()==0){
            ...
            norawat.setText(tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),1).toString());
            norm.setText(tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),2).toString());
            namapasien.setText(tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),3).toString());
            namaperawatan.setText(tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),4).toString());
            biaya.setText(tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),11).toString());
    ...
    private void jumlahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jumlahActionPerformed
        // TODO add your handling code here:
        double  p4 = Double.parseDouble(biaya.getText());
        int p7 = Integer.parseInt(jumlah.getText());
        
        double totalskor = p4 * p7;
        double dr = totalskor * 0.65;
        double material = totalskor * 0.35;
        
        String skor = Double.toString(totalskor);
        hsl1 = dr ;
        hsl2 = material ;
//        hasil.setText(Double.toString(totalskor));
        hasil.setText(String.format("%.2f", totalskor));
    ...
    private void buttonBig2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBig2ActionPerformed
        if (namaperawatan.getText().contains("SW0011") || namaperawatan.getText().contains("SW0049") || namaperawatan.getText().contains("SW0050") || namaperawatan.getText().contains("SW0051") || namaperawatan.getText().contains("TN951")) {
            if(Sequel.mengedittf("rawat_inap_drpr","no_rawat=? and kd_jenis_prw=? and tgl_perawatan=? and jam_rawat=?","no_rawat=?,biaya_rawat=?,material=?,tarif_tindakandr=?",8,new String[]{
                ...
                tbRawatDrPr.getValueAt(tbRawatDrPr.getSelectedRow(),10).toString(),
            })==true){
    ...
    */
    ...
    private widget.Button BtnAwalKeperawatanBayi;
    private widget.Button BtnAwalKeperawatanGigi;
    private widget.Button BtnAwalKeperawatanKandungan;
    private widget.Button BtnAwalKeperawatanKandungan1;
    private widget.Button BtnAwalKeperawatanPsikiatriAnakRemajaRanap;
    private widget.Button BtnAwalKeperawatanPsikiatriDewasaRanap;
    private widget.Button BtnAwalKeperawatanPsikiatriDewasaUmum;
    private widget.Button BtnAwalKeperawatanPsikiatriGeriatriRanap;
    private widget.Button BtnAwalKeperawatanUmum;
    private widget.Button BtnAwalMedis;
    private widget.Button BtnAwalMedisBayiAnak;
    private widget.Button BtnAwalMedisBedahMulutRanap;
    private widget.Button BtnAwalMedisGeriatriRanap;
    private widget.Button BtnAwalMedisKandungan;
    private widget.Button BtnAwalMedisKandungan1;
    private widget.Button BtnAwalMedisPsikiatrikGeriatri;
    private widget.Button BtnAwalMedisRanapPsikiatriDewasa;
    ...
    private widget.Button BtnPenilaianAwalBarthelIndex;
    private widget.Button BtnPenilaianESRS;
    ...
    private widget.TextBox namaperawatan;
