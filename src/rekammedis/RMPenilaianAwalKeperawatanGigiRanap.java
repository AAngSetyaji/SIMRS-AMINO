 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalKeperawatanGigiRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalKeperawatanGigiRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Keperawatan Gigi & Mulut Ranap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-09-2023 07:15:24" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_gigi_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",57,new String[]{
                    ...
                    for (i = 0; i < tbMasalahKeperawatan.getRowCount(); i++) {
                        if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_gigi_ranap_masalah","?,?",2,new String[]{TNoRw.getText(),tbMasalahKeperawatan.getValueAt(i,1).toString()});
                        }
                    }
                    
                    for (i = 0; i < tbRencanaKeperawatan.getRowCount(); i++) {
                        if(tbRencanaKeperawatan.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_rencana_gigi","?,?",2,new String[]{TNoRw.getText(),tbRencanaKeperawatan.getValueAt(i,1).toString()});
                        }
                    }
                    for (i = 0; i < tbRencanaEtiologi.getRowCount(); i++) {
                        if(tbRencanaEtiologi.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_etiologi_gigi","?,?",2,new String[]{TNoRw.getText(),tbRencanaEtiologi.getValueAt(i,1).toString()});
                        }
                    }
                    for (i = 0; i < tbRencanaLuaran.getRowCount(); i++) {
                        if(tbRencanaLuaran.getValueAt(i,0).toString().equals("true")){
                            Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_luaran_gigi","?,?",2,new String[]{TNoRw.getText(),tbRencanaLuaran.getValueAt(i,1).toString()});
                        }
                    }
                    emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from penilaian_awal_keperawatan_gigi_ranap where no_rawat=?",1,new String[]{
            ...
            try{
                if(TCari.getText().equals("")){
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_gigi_ranap.tanggal,"+
                            "penilaian_awal_keperawatan_gigi_ranap.informasi,penilaian_awal_keperawatan_gigi_ranap.td,penilaian_awal_keperawatan_gigi_ranap.nadi,penilaian_awal_keperawatan_gigi_ranap.rr,penilaian_awal_keperawatan_gigi_ranap.suhu,penilaian_awal_keperawatan_gigi_ranap.bb,"+
                            "penilaian_awal_keperawatan_gigi_ranap.tb,penilaian_awal_keperawatan_gigi_ranap.bmi,penilaian_awal_keperawatan_gigi_ranap.keluhan_utama,penilaian_awal_keperawatan_gigi_ranap.riwayat_penyakit,penilaian_awal_keperawatan_gigi_ranap.ket_riwayat_penyakit,"+
                            "penilaian_awal_keperawatan_gigi_ranap.alergi,penilaian_awal_keperawatan_gigi_ranap.riwayat_perawatan_gigi,penilaian_awal_keperawatan_gigi_ranap.ket_riwayat_perawatan_gigi,penilaian_awal_keperawatan_gigi_ranap.kebiasaan_sikat_gigi,"+
                            "penilaian_awal_keperawatan_gigi_ranap.kebiasaan_lain,penilaian_awal_keperawatan_gigi_ranap.ket_kebiasaan_lain,penilaian_awal_keperawatan_gigi_ranap.obat_yang_diminum_saatini,penilaian_awal_keperawatan_gigi_ranap.alat_bantu,"+
                            "penilaian_awal_keperawatan_gigi_ranap.ket_alat_bantu,penilaian_awal_keperawatan_gigi_ranap.prothesa,penilaian_awal_keperawatan_gigi_ranap.ket_pro,penilaian_awal_keperawatan_gigi_ranap.status_psiko,penilaian_awal_keperawatan_gigi_ranap.ket_psiko,"+
                            "penilaian_awal_keperawatan_gigi_ranap.hub_keluarga,penilaian_awal_keperawatan_gigi_ranap.tinggal_dengan,penilaian_awal_keperawatan_gigi_ranap.ket_tinggal,penilaian_awal_keperawatan_gigi_ranap.ekonomi,penilaian_awal_keperawatan_gigi_ranap.budaya,"+
                            "penilaian_awal_keperawatan_gigi_ranap.ket_budaya,penilaian_awal_keperawatan_gigi_ranap.edukasi,penilaian_awal_keperawatan_gigi_ranap.ket_edukasi,penilaian_awal_keperawatan_gigi_ranap.berjalan_a,penilaian_awal_keperawatan_gigi_ranap.berjalan_b,"+
                            "penilaian_awal_keperawatan_gigi_ranap.berjalan_c,penilaian_awal_keperawatan_gigi_ranap.hasil,penilaian_awal_keperawatan_gigi_ranap.lapor,penilaian_awal_keperawatan_gigi_ranap.ket_lapor,penilaian_awal_keperawatan_gigi_ranap.nyeri,"+
                            "penilaian_awal_keperawatan_gigi_ranap.lokasi,penilaian_awal_keperawatan_gigi_ranap.skala_nyeri,penilaian_awal_keperawatan_gigi_ranap.durasi,penilaian_awal_keperawatan_gigi_ranap.frekuensi,penilaian_awal_keperawatan_gigi_ranap.nyeri_hilang,"+
                            "penilaian_awal_keperawatan_gigi_ranap.ket_nyeri,penilaian_awal_keperawatan_gigi_ranap.pada_dokter,penilaian_awal_keperawatan_gigi_ranap.ket_dokter,penilaian_awal_keperawatan_gigi_ranap.kebersihan_mulut,penilaian_awal_keperawatan_gigi_ranap.mukosa_mulut,"+
                            "penilaian_awal_keperawatan_gigi_ranap.karies,penilaian_awal_keperawatan_gigi_ranap.karang_gigi,penilaian_awal_keperawatan_gigi_ranap.gingiva,penilaian_awal_keperawatan_gigi_ranap.palatum,penilaian_awal_keperawatan_gigi_ranap.rencana,"+
                            "penilaian_awal_keperawatan_gigi_ranap.nip,petugas.nama "+
                            "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join penilaian_awal_keperawatan_gigi_ranap on reg_periksa.no_rawat=penilaian_awal_keperawatan_gigi_ranap.no_rawat "+
                            "inner join petugas on penilaian_awal_keperawatan_gigi_ranap.nip=petugas.nip "+
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? order by penilaian_awal_keperawatan_gigi_ranap.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_gigi_ranap.tanggal,"+
                            "penilaian_awal_keperawatan_gigi_ranap.informasi,penilaian_awal_keperawatan_gigi_ranap.td,penilaian_awal_keperawatan_gigi_ranap.nadi,penilaian_awal_keperawatan_gigi_ranap.rr,penilaian_awal_keperawatan_gigi_ranap.suhu,penilaian_awal_keperawatan_gigi_ranap.bb,"+
                            ...
                            "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                            "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                            "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? and reg_periksa.no_rawat like ? or "+
                            "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? and pasien.no_rkm_medis like ? or "+
                            "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? and pasien.nm_pasien like ? or "+
                            "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? and penilaian_awal_keperawatan_gigi_ranap.nip like ? or "+
                            "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? and petugas.nama like ? order by penilaian_awal_keperawatan_gigi_ranap.tanggal");
                }
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        ps2=koneksi.prepareStatement(
                            ...
                            "inner join penilaian_awal_keperawatan_gigi_ranap_masalah on penilaian_awal_keperawatan_gigi_ranap_masalah.kode_masalah=master_masalah_keperawatan_gigi.kode_masalah "+
                            "where penilaian_awal_keperawatan_gigi_ranap_masalah.no_rawat=? order by penilaian_awal_keperawatan_gigi_ranap_masalah.kode_masalah");
                        try {
       ...
       if(tbObat.getSelectedRow()>-1){
            ...
            try {
                ...
                ps2=koneksi.prepareStatement(
                    "select master_masalah_keperawatan_gigi.kode_masalah,master_masalah_keperawatan_gigi.nama_masalah from master_masalah_keperawatan_gigi "+
                    "inner join penilaian_awal_keperawatan_gigi_ranap_masalah on penilaian_awal_keperawatan_gigi_ranap_masalah.kode_masalah=master_masalah_keperawatan_gigi.kode_masalah "+
                    "where penilaian_awal_keperawatan_gigi_ranap_masalah.no_rawat=? order by kode_masalah");
                try {
            ...
            try {
                ...
                ps2=koneksi.prepareStatement(
                    ...
                    "inner join penilaian_awal_keperawatan_ranap_rencana_gigi on penilaian_awal_keperawatan_ranap_rencana_gigi.kode_rencana=master_rencana_keperawatan_gigi.kode_rencana "+
                    "where penilaian_awal_keperawatan_ranap_rencana_gigi.no_rawat=? order by penilaian_awal_keperawatan_ranap_rencana_gigi.kode_rencana");
                try {
                    ps2.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs2=ps2.executeQuery();
                    while(rs2.next()){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanGigiRanap dialog = new RMPenilaianAwalKeperawatanGigiRanap(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "penilaian_awal_keperawatan_gigi_ranap.tanggal between ? and ? and "+
                        "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_awal_keperawatan_gigi_ranap.nip like ? or petugas.nama like ?) "+
                        "order by penilaian_awal_keperawatan_gigi_ranap.tanggal");
            }
...
//    jbn lupa
    ...
    private void tampilEtiologi() {
        try{
            file=new File("./cache/rencanaetiologigigi.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ...
            fileWriter.write("{\"rencanaetiologigigi\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilEtiologi2() {
        try{
            ...
            myObj = new FileReader("./cache/rencanaetiologigigi.iyem");
            root = mapper.readTree(myObj);
            response = root.path("rencanaetiologigigi");
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
     ...
     private void tampilLuaran() {
        try{
            file=new File("./cache/rencanaluarangigi.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ...
            fileWriter.write("{\"rencanaluarangigi\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilLuaran2() {
        try{
            ...
            myObj = new FileReader("./cache/rencanaluarangigi.iyem");
            root = mapper.readTree(myObj);
            response = root.path("rencanaluarangigi");
            if(response.isArray()){
                for(i=0;i<tbMasalahKeperawatan.getRowCount();i++){
                    if(tbMasalahKeperawatan.getValueAt(i,0).toString().equals("true")){
                        for(JsonNode list:response){
        ...
        if(tbObat.getSelectedRow()!= -1){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_etiologi_gigi on penilaian_awal_keperawatan_ranap_etiologi_gigi.kode_etiologi=master_etiologi_keperawatan.kode_etiologi "+
                        "where penilaian_awal_keperawatan_ranap_etiologi_gigi.no_rawat=? order by penilaian_awal_keperawatan_ranap_etiologi_gigi.kode_etiologi");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "inner join penilaian_awal_keperawatan_ranap_luaran_gigi on penilaian_awal_keperawatan_ranap_luaran_gigi.kode_luaran=master_luaran_keperawatan.kode_luaran "+
                        "where penilaian_awal_keperawatan_ranap_luaran_gigi.no_rawat=? order by penilaian_awal_keperawatan_ranap_luaran_gigi.kode_luaran");
                try {
                    ps.setString(1,tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
    ...
    private void hapus() {
        TNoRM1.setText("");
        TPasien1.setText("");
        Sequel.meghapus("penilaian_awal_keperawatan_gigi_ranap_masalah","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
        Sequel.meghapus("penilaian_awal_keperawatan_ranap_rencana_gigi","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
        Valid.tabelKosong(tabModeDetailMasalah);
        Valid.tabelKosong(tabModeDetailRencana);
        ChkAccor.setSelected(false);
        isMenu();
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_awal_keperawatan_gigi_ranap","no_rawat=?","no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,bb=?,tb=?,bmi=?,keluhan_utama=?,riwayat_penyakit=?,ket_riwayat_penyakit=?,alergi=?,riwayat_perawatan_gigi=?,ket_riwayat_perawatan_gigi=?,kebiasaan_sikat_gigi=?,kebiasaan_lain=?,ket_kebiasaan_lain=?,obat_yang_diminum_saatini=?,alat_bantu=?,ket_alat_bantu=?,prothesa=?,ket_pro=?,status_psiko=?,ket_psiko=?,hub_keluarga=?,tinggal_dengan=?,ket_tinggal=?,ekonomi=?,budaya=?,ket_budaya=?,edukasi=?,ket_edukasi=?,berjalan_a=?,berjalan_b=?,berjalan_c=?,hasil=?,lapor=?,ket_lapor=?,nyeri=?,lokasi=?,skala_nyeri=?,durasi=?,frekuensi=?,nyeri_hilang=?,ket_nyeri=?,pada_dokter=?,ket_dokter=?,kebersihan_mulut=?,mukosa_mulut=?,karies=?,karang_gigi=?,gingiva=?,palatum=?,rencana=?,nip=?",58,new String[]{
                ...
                Sequel.meghapus("penilaian_awal_keperawatan_ranap_etiologi_gigi","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                for (i = 0; i < tbRencanaEtiologi.getRowCount(); i++) {
                    if(tbRencanaEtiologi.getValueAt(i,0).toString().equals("true")){
                        Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_etiologi_gigi","?,?",2,new String[]{TNoRw.getText(),tbRencanaEtiologi.getValueAt(i,1).toString()});
                    }
                }
                Sequel.meghapus("penilaian_awal_keperawatan_ranap_luaran_gigi","no_rawat",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                for (i = 0; i < tbRencanaLuaran.getRowCount(); i++) {
                    if(tbRencanaLuaran.getValueAt(i,0).toString().equals("true")){
                        Sequel.menyimpan2("penilaian_awal_keperawatan_ranap_luaran_gigi","?,?",2,new String[]{TNoRw.getText(),tbRencanaLuaran.getValueAt(i,1).toString()});
                    }
