    ...
    private void tampilTindakan() {         
        try{
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "on jns_perawatan.kd_kategori=kategori_perawatan.kd_kategori where jns_perawatan.status='1' and jns_perawatan.total_byrdrpr>0 order by jns_perawatan.kd_jenis_prw");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
